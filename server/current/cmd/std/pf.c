...
int main(object me, string arg)
{
	...
	int busy, pf, x, y, which, count, vaotu, vaotuluc;
	...
	////vao tu
	//if (get_z(me) == 704) {
	//	vaotu = me->get_save("vaotu");
	//	vaotuluc = me->get_save("vaotuluc");
	//	if (time() - vaotuluc > vaotu) {
	//		me->delete_save("vaotu");
	//		me->set_save("gietnguoi", 0);
	//	}
	//}
	//else {
	//	if (me->get_save("vaotu") > 0) {
	//		set_invisible(me, 1);
	...
	*/
	...
	me->set_time("pf", time());    // 由 pf 成功后Thiết lập 
