...
int main(object me, string arg)
{
	...
	tell_user(me, "%s(%d) Vi Tri: %d (%d, %d) %O", who->get_name(), who->get_number(), z, x, y, get_map_object(z));
	...
	/*if (flag)
	{
		...
		tell_user(me, "Ket qua [%2d]：%s", size, result);
		...
		tell_user(me, "Phương pháp mảng [%2d]：%s", size, result);
