...
int main( object me, string arg )
{
		...
		if (arg=="vmc2")
	{
		...
		if (arg == "troc")
		{
			...
			me->set_hair(gender1 + 100);
			me->add_save_2("doitoc.score", 1);
			write_user(me, ECHO "Bạn đã xuống tóc !");
			me->add_to_scene(get_z(me), get_x(me), get_y(me), get_d(me));
	...
	if ( arg == "5")
	{
		...
		me->add_cash(-1500000);
		me->set_hair_color(0x00DDA0DD);//0x3000
		me->add_to_scene(get_z(me), get_x(me), get_y(me), get_d(me));
    return 1;
	}
	if ( arg == "6")
	...
	if ( arg == "9")
	{
		...
		me->add_cash(-1500000);
		me->set_hair_color(0x00FAFAFF);//0x3180
		me->add_to_scene(get_z(me), get_x(me), get_y(me), get_d(me));
    return 1;
	}
	if ( arg == "10")
	...
	if ( arg == "13")
	{
		...
		me->add_cash(-1500000);
		me->set_hair_color(0x0000A5FF);//0x4100
		me->add_to_scene(get_z(me), get_x(me), get_y(me), get_d(me));
    return 1;
	}
	if ( arg == "14")
