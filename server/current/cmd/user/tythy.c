...
int main(object me, string arg) 
{
	...
	mixTime = localtime(iTime);	
		...
		if ( arg2=="!" )
		{
			...
			write_user(me,ECHO"Tỷ tỷ đã bắt đầu !");write_user(me,ECHO"Tỷ tỷ đã bắt đầu !");write_user(me,ECHO"Tỷ tỷ đã bắt đầu !");
			write_user(who,ECHO"Tỷ tỷ đã bắt đầu !");write_user(who,ECHO"Tỷ tỷ đã bắt đầu !");write_user(who,ECHO"Tỷ tỷ đã bắt đầu !");
			return 1;
		}	
	return 1;
} 