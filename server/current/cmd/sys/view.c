...
int main( object me, string arg )
{
        ...
        size = memory_info();
        tell_user( me, "Ram: %d.%03d M    物体: %d", 
                size / 1048576, size % 1048576 * 1000 / 1048576, sizeof( objects() ) );
        tell_user( me, "Load/random: %s  -- %d", get_load_average(), MAIN_D->get_absolute_random_number() );
        ...
        tell_user( me, "Nhịp tim: char %d ＝ charNPC(%d) npc2(%d) ＋ Người chơi(%d)", sizeof(char), sizeof(npc), sizeof(npc2), sizeof(user) );
