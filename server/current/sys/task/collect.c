...
// 变量：随机对话
string *TalkTable = ({ 
        "昨天隔壁小丫头采了好多" HIY "花" NOR "，说是有Hoa Tượng、Cây lan、Măng tây、Cây cúc、Hoa hồng什么的，可香了.",
        "昨天隔壁小丫头采了好多" HIY "花" NOR "，说是有Hoa nhài、Cây mẫu đơn、Hoa đào、Hoa trà、Hoa mẫu đơn什么的，可香了.",
        "昨天隔壁小丫头采了好多" HIY "花" NOR "，说是有Hoa bìm bìm、Hoa dâm bụt、Hoa thủy tiên、Thu hải đường、Hoa huệ、Tử đinh hương什么的，可香了.",
        "想变漂亮点吗?把十朵相同的花插在柳条环上就有" HIY "花环" NOR "戴了哦.",

        "通常茶叶铺里都会有Trà Đen、Trà Xanh、Trà Jasmine、Trà Pu'er卖，这些都是比较大众化的" HIY "茶" NOR ".",
        "茶叶铺里的Trà Quan Vũ、Longjing trà、trà Mist、Lá Trà Quan Vũ、Trà mây都是属于比较上等的" HIY "茶" NOR ".",

        "城东的老李头喜欢喝Rượu gạo、Hoàng Tửu、Lão Tửu，这些" HIY "酒" NOR "不容易醉人.",
        "城西的老马头喜欢喝Hỏa Đao Tửu、Đầm Lầy、Rượu Dukang、Rượu vang đỏ，这些可都是烈" HIY "酒" NOR "哦.",
        ...
        "集市上的" HIY "小吃" NOR "可好吃了，象bánh quy、bánh kếp、Bánh đậu đỏ、Bánh đậu什么的.",
        "集市上的" HIY "小吃" NOR "可好吃了，象thịt bò khô、thịt nướng kebab、Khoai Lang Nướng、Đậu phụ khô什么的.",
        "集市上的" HIY "小吃" NOR "可好吃了，象Đậu phụ thối、Hạt dưa chiên、Đậu phộng chiên、Kẹo Hồ Lô什么的.",
        ...
        "听说右街的黄乐师把琵琶、Đàn nhị这几样" HIY "乐器" NOR "玩得挺拿手的.",
        ...
        "如果您受了伤，可以用些" HIY "补血补法药" NOR "，象行军散、活络丸、Tạo Hoá Đơn就是.",
        "如果您受了伤，可以用些" HIY "补血补法药" NOR "，象正气散、安神丸、Bổ Tâm Đan就是.",
...
mapping mpExchange = ([
	0015	: ([	1:(["give":(["稻草":2]),"object":"Trái quýt","unit":"个","question":"两根稻草交换一个Trái quýt"]),	
			2:(["give":(["蚂蚁卵":2]),"object":"Trái lê","unit":"个","question":"两个蚂蚁卵交换一个Trái lê"]),	
			3:(["give":(["闪光的石头":3]),"object":"蜂蜜","unit":"罐","question":"三块闪光的石头交换一罐蜂蜜"]),
			]),		
	1015	: ([	1:(["give":(["蝎尾":2]),"object":"Trái lê","unit":"个","question":"两条蝎尾交换一个Trái lê子"]),	
			2:(["give":(["蛛网":2]),"object":"Đào","unit":"个","question":"两张蛛网交换一个Đào"]),	
			3:(["give":(["火凤之翼":2]),"object":"thịt bò khô","unit":"块","question":"两件火凤之翼交换一块thịt bò khô"]),
			4:(["give":(["玉束髻":2]),"object":"thịt nướng kebab","unit":"串","question":"两根玉束髻交换一串thịt nướng kebab"]),
			]),
	1016	: ([	1:(["give":(["鼻环":2]),"object":"Hoàng Tửu","unit":"坛","question":"两个鼻环交换一坛Hoàng Tửu"]),	
			...
			3:(["give":(["寒铁剑鞘":2]),"object":"Rượu Dukang","unit":"坛","question":"两把寒铁剑鞘交换一坛Rượu Dukang"]),
			]),	
	2015	: ([	1:(["give":(["蛙蹼":2]),"object":"Hoàng Tửu","unit":"坛","question":"两只蛙蹼交换一坛Hoàng Tửu"]),	
			2:(["give":(["铜罐":2]),"object":"Hỏa Đao Tửu","unit":"坛","question":"两个铜罐交换一坛Hỏa Đao Tửu"]),	
			]),
	2016	: ([	1:(["give":(["蜥蜴尾巴":2]),"object":"Trái Táo","unit":"个","question":"两条蜥蜴尾巴交换一个Trái Táo"]),	
			2:(["give":(["闪光的石头":2]),"object":"Trái lê","unit":"个","question":"两个闪光的石头交换一个Trái lê"]),	
			3:(["give":(["鱼叉":2]),"object":"Dưa hấu","unit":"个","question":"两把鱼叉交换一个Dưa hấu"]),
			4:(["give":(["黄色小石头":2]),"object":"Khoai Lang Nướng","unit":"个","question":"两块黄色小石头交换一个Khoai Lang Nướng"]),
			]),							
	3015	: ([	1:(["give":(["破旧的头盔":2]),"object":"Rượu gạo","unit":"坛","question":"两顶破旧的头盔交换一坛Rượu gạo"]),	
			2:(["give":(["剑鞘":2]),"object":"Hỏa Đao Tửu","unit":"坛","question":"两把剑鞘交换一坛Hỏa Đao Tửu"]),	
			]),
	3016	: ([	1:(["give":(["破旧的盔甲":2]),"object":"Trái Táo","unit":"个","question":"两件破旧的盔甲交换一个Trái Táo"]),	
			2:(["give":(["箭筒":2]),"object":"Khoai Lang Nướng","unit":"个","question":"两个箭筒交换一个Khoai Lang Nướng"]),	
			]),
	4015	: ([	1:(["give":(["死者遗物":2]),"object":"Đào","unit":"个","question":"两个死者遗物交换一只Đào"]),	
			2:(["give":(["蛛网":2]),"object":"Chuối","unit":"条","question":"两张蛛网交换一条Chuối"]),	
			3:(["give":(["铜罐":2]),"object":"Dưa hấu","unit":"个","question":"两个铜罐交换一个Dưa hấu"]),
			4:(["give":(["黄色小石头":2]),"object":"Khoai Lang Nướng","unit":"个","question":"两块黄色小石头交换一个Khoai Lang Nướng"]),
			]),
	4016	: ([	1:(["give":(["破布衣":2]),"object":"Lão Tửu","unit":"坛","question":"两件破布衣交换一坛Lão Tửu"]),	
			2:(["give":(["腐骨":2]),"object":"Hỏa Đao Tửu","unit":"坛","question":"两根腐骨交换一坛Hỏa Đao Tửu"]),	
			]),														
	5015	: ([	1:(["give":(["帽缨":2]),"object":"Lão Tửu","unit":"坛","question":"两个帽缨交换一坛Lão Tửu"]),	
			2:(["give":(["腐骨":2]),"object":"Hỏa Đao Tửu","unit":"坛","question":"两根腐骨交换一坛Hỏa Đao Tửu"]),	
			]),
	5016	: ([	1:(["give":(["红色小石头":2]),"object":"Chuối","unit":"条","question":"两块红色小石头交换一条Chuối"]),	
			2:(["give":(["鱼叉":2]),"object":"Dưa hấu","unit":"个","question":"两把鱼叉交换一个Dưa hấu"]),	
			3:(["give":(["箭筒":2]),"object":"Khoai Lang Nướng","unit":"个","question":"两个箭筒交换一个Khoai Lang Nướng"]),
			]),													
	6015	: ([	1:(["give":(["破损的头盔":2]),"object":"Rượu gạo","unit":"坛","question":"两件破损的头盔交换一坛Rượu gạo"]),	
			2:(["give":(["鼻环":2]),"object":"Hoàng Tửu","unit":"坛","question":"两个鼻环交换一坛Hoàng Tửu"]),	
			]),
	6016	: ([	1:(["give":(["狗尾巴":2]),"object":"Kẹo Hồ Lô","unit":"串","question":"两条狗尾巴交换一串Kẹo Hồ Lô"]),	
			2:(["give":(["黄蜂刺":2]),"object":"Trái quýt","unit":"个","question":"两根黄蜂刺交换一个Trái quýt"]),	
			3:(["give":(["剧毒刺":2]),"object":"Trái Táo","unit":"个","question":"两根剧毒刺交换一个Trái Táo"]),
			4:(["give":(["蜘蛛丝":2]),"object":"Trái lê","unit":"个","question":"两条蜘蛛丝交换一个Trái lê"]),
			]),		
	7015	: ([	1:(["give":(["腐骨":2]),"object":"Hỏa Đao Tửu","unit":"坛","question":"两根腐骨交换一坛Hỏa Đao Tửu"]),	
			2:(["give":(["魔之心":2]),"object":"Đầm Lầy","unit":"坛","question":"两个魔之心交换一坛Đầm Lầy"]),	
			]),
	7016	: ([	1:(["give":(["腐骨":2]),"object":"Dưa hấu","unit":"个","question":"两根腐骨交换一个Dưa hấu"]),	
			2:(["give":(["甲胄":2]),"object":"Bánh đậu đỏ","unit":"块","question":"两件甲胄交换一块Bánh đậu đỏ"]),	
			3:(["give":(["锁魔链":2]),"object":"Bánh đậu","unit":"块","question":"两条锁魔链交换一块Bánh đậu"]),
			]),			
	8015	: ([	1:(["give":(["小太极":2]),"object":"Đầm Lầy","unit":"坛","question":"两个小太极交换一坛Đầm Lầy"]),	
			2:(["give":(["寒铁枪头":2]),"object":"Rượu Dukang","unit":"坛","question":"两根寒铁枪头交换一坛Rượu Dukang"]),	
			3:(["give":(["寒铁":2]),"object":"Rượu vang đỏ","unit":"坛","question":"两块寒铁交换一坛Rượu vang đỏ"]),
			]),	
	8016	: ([	1:(["give":(["甲胄":2]),"object":"Bánh đậu đỏ","unit":"块","question":"两件甲胄交换一块Bánh đậu đỏ"]),	
			2:(["give":(["魔之心":2]),"object":"Bánh đậu","unit":"块","question":"两个魔之心交换一块Bánh đậu"]),	
			3:(["give":(["寒铁刀柄":2]),"object":"thịt nướng kebab","unit":"串","question":"两把寒铁刀柄交换一串thịt nướng kebab"]),
			4:(["give":(["寒铁枪头":2]),"object":"thịt bò khô","unit":"块","question":"两根寒铁枪头交换一块thịt bò khô"]),	
			5:(["give":(["寒铁":2]),"object":"bánh quy","unit":"个","question":"两块寒铁交换一个bánh quy"]),	
			]),																			
]);
mapping mpFile = ([
	"Hoàng Tửu" : "/item/31/3151",
	"Kẹo Hồ Lô"	: "/item/33/3325",
	"Trái quýt"	: "/item/32/3282",
	"thịt nướng kebab"	: "/item/33/3311",
	"Khoai Lang Nướng"	: "/item/33/3320",
	"Rượu Dukang"	: "/item/31/3155",
	"Trái Táo"	: "/item/32/3283",
	"thịt bò khô"	: "/item/33/3310",
	"Rượu gạo"	:	"/item/31/3150",
	"Rượu vang đỏ"	: "/item/31/3156",
	"Lão Tửu"	: "/item/31/3152",
	"Bánh đậu"	: "/item/33/3304",
	"Trái lê"	:	"/item/32/3284",
	"bánh quy"	: "/item/33/3301",
	"Hỏa Đao Tửu"	: "/item/31/3153",
	"Dưa hấu"	: "/item/32/3280",
	"Đào"	: "/item/32/3285",
	"Chuối"	: "/item/32/3281",
	"Đầm Lầy"	: "/item/31/3154",
	"蜂蜜"	:	"/item/32/3244",
	"Bánh đậu đỏ"	: "/item/33/3303",
]);
...
void do_exchange(string sArg,int iFlag)
{
	...
	obj->add_to_user(i);
	sTmp = sprintf("Bạn nhận được  " HIY "%s" NOR "！", obj->get_name());
...
{
        switch( id )    // 0: 等级不够；1: 询问任务；2: 答应任务；3: 没Hoàn thành任务；4: 刚Hoàn thành任务；5: Hoàn thành任务
        {
    ...
    case 0323 : return "谢谢您了，帮我Hoàn thành焚香祷告吧.";
    ...
    case 0622 : return "我想研究一下昨天的Sách cờ，可是红子少了几个，你能帮我吗?";
    ...
    case 0702 : return "我想研究一下昨天的Sách cờ，可是黑子少了几个，你能帮我吗?";
