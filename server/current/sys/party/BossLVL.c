...
//		x = p / 1000;
//		y = p % 1000;
		npc = new("/npc/event/BossLVL");
		npc->add_to_scene(089,139,96);	
		Scum += ({ npc });
//	}

	CHAT_D->sys_channel(0,HIC "Kẻ giết người không gớm tay \"Lê Văn Luyện\" đã trốn ngục. Hiện đã chạy đến "HIY "Hổ Lao Quan (139,96) "HIC ".Mọi người hãy nhanh chóng tiêu diệt hắn !");
//	CHAT_D->sys_channel(0,HIC "Nào mọi người. Hãy mau giết hắn!!.");
}
