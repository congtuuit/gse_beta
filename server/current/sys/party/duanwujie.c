...
void check_time2()
{
	...
	if (iHour < iFinish1)
	{
		CHAT_D->sys_channel(0,HIY"Qut Yuan, nhà thơ vĩ đại đã chết trên sông Miluo Đi tìm tài liệu của zongzi trong trạng thái nước Sở và đưa chúng cho người dân ở Đông Phương Hồ（161,177）的洞庭湖舟子来制作粽子抛进江中，以防止鱼儿去咬屈子的遗体啊。");
		generate_zhongzi();
	}
