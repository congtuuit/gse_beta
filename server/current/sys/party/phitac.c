		...
		else
		{
			...
			else
			{
				if (mixTime[TIME_MIN] >= 45) {
					...
					generate_scum();
					log_file("boss.txt", short_time() + " Phi tặc\n");
					call_out("check_time", i + 3600);
				}
...
void generate_scum()
{
	...
	CHAT_D->sys_channel(0, HIR"Nghe nói có một đám Trộm Bảo Phi Tặc đã xuất hiện !");
	CHAT_D->sys_channel(0, HIY"Nghe nói Trộm Bảo Phi Tặc đã xuất hiện tại Sở Phương Thành 1, Tân Thủ Thôn, Thủ Dương Sơn, Hổ Lao Quan, Ranh giới Đầm Lầy, Đông Hải Ngư Thôn, Kênh Trịnh Quốc 1, Yên Trường Thành 2, Bạch Vân Phong, Triệu Trường Thành 2, Tần Trường Thành 2, Linh Cốc Động, Loan Đạo 2, Khốn Ma Trận 1, Hư Lăng Động, Cầu Cửu Khúc 1. Các tráng sĩ hay mau đi tiêu diệt !");
	CHAT_D->sys_channel(0, HIY"Nghe nói Trộm Bảo Phi Tặc đã xuất hiện tại Tần Trường Thành 2, Linh Cốc Động, Loan Đạo 2, Khốn Ma Trận 1, Hư Lăng Động, Cầu Cửu Khúc 1, Tru Tiên Trận 1, Tru Tiên Trận 2, Tru Tiên Trận 3!");
