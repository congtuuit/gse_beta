...
void do_gift(object me, object who, string arg)
{
	...
	case 100:
		...
		result += sprintf(ESC"Tìm kiếm Thần Binh Phổ - Độc Long Tiễn\ntalk %x# nhannv.502\n", getoid(who));
	...
	case 506:
		...
		else if ( type==502 ) { ben3=2; ben5="Thần Binh Phổ - Độc Long Tiễn"; }
...
string send_task_intro(object me)
{
	...
	else if ( me->get_save("nhannvctben")==2 ) ben="Thần Binh Phổ - Độc Long Tiễn";
