...
void count_max_hp(object me) {
	...
	for (i = 0; i < MAX_EQUIP; i++)
		if (equip[i] && equip[i]->get_lasting() >= 100) {
			...
			if (p = equip[i]->get("hp") + equip[i]->get("hp+") + equip[i]->get("hpp") + equip[i]->get("hp2") + equip[i]->get("stoneHP+") + equip[i]->get("stoneHP++") + equip[i]->get("stoneHP+++")) add += p;
	...
	if (p = me->get_skill(SKILL_0375)) add += p * 6; // 强化周天运转（Hoa đào）
...
void count_ap(object me) {
	...
	for (i = 0; i < MAX_EQUIP; i++)
		if (equip[i] && equip[i]->get_lasting() >= 100) {
			if (i == 2 && get_effect(me, EFFECT_NO_WEAPON)) continue;
			if (i == 3 && get_effect(me, EFFECT_NO_CLOTH)) continue;
			if (p = equip[i]->get("goldAP+") + equip[i]->get("ap") + equip[i]->get("ap+") + equip[i]->get("app") + equip[i]->get("ap2") + equip[i]->get("stoneAP+") + equip[i]->get("stoneAP++") + equip[i]->get("stoneAP+++")) add += p;
			if (p = equip[i]->get("ap%") + equip[i]->get("ap%+") + equip[i]->get("aps%")) cent += p;
	...
	default:
		if (p = me->get_skill(SKILL_0111)) ap += me->set_temp_ap("0111", p); // 基本拳脚
		if (p = me->get_skill(SKILL_0211)) ap += me->set_temp_ap("0211", p); // 太古神拳
		if (p = me->get_skill(SKILL_0371)) ap += me->set_temp_ap("0371", p * 4); // 强化太古神拳
		break;

	case THROWING:
		if (p = me->get_skill(SKILL_0161)) ap += me->set_temp_ap("0161", p * 3 / 2); // 暗器投射
	...
	case BLADE:
		if (p = me->get_skill(SKILL_0121)) ap += me->set_temp_ap("0121", p);
		if (p = me->get_skill(SKILL_0221)) ap += me->set_temp_ap("0221", p * 8);
		if (p = me->get_skill(SKILL_0331)) ap += me->set_temp_ap("0331", p * 3);
		break;

	case SPEAR:
		if (p = me->get_skill(SKILL_0141)) ap += me->set_temp_ap("0141", p); // 基本枪法
	...
	case STICK:
		if (p = me->get_skill(SKILL_0151)) ap += me->set_temp_ap("0151", p); // 基本棍法
	...
	if (me->get_2("thucuoi.ap%")) {
		rate = me->get_2("thucuoi.ap%");
		ap = ap + ap * rate / 100;
	}
	...
	//-------------------------------------------------------------------------------------------------------
	if (item = me->get_equip(HAND_TYPE))
		if (item->get("time_item") && item->get_name() != "Thối Nguyệt Chi Hoàn") {
	...
	if (me->get_dame_title_code() == "P001") ap += 10;
	if (me->get_dame_title_code() == "P002") ap += 20;
	if (me->get_dame_title_code() == "P003") ap += 30;
	if (me->get_dame_title_code() == "P004") ap += 40;
	if (me->get_dame_title_code() == "P005") ap += 150;
	if (me->get_dame_title_code() == "P006") ap += 200;
	if (me->get_dame_title_code() == "P007") ap += 250;
	if (me->get_dame_title_code() == "P008") ap += 300;
	if (me->get_dame_title_code() == "P009") ap += 350;
	if (me->get_dame_title_code() == "P010") ap += 450;
	if (me->get_dame_title_code() == "P011") ap += 600;

	if (me->get_dame_title_code() == "W001") ap += 100;
	if (me->get_dame_title_code() == "W002") ap += 150;
	if (me->get_dame_title_code() == "W003") ap += 200;
	if (me->get_dame_title_code() == "W004") ap += 250;
	if (me->get_dame_title_code() == "W005") ap += 350;

	if (me->get_dame_title_code() == "E500") ap += 100;
...
void count_dp(object me) {
	...
	for (i = 0; i < MAX_EQUIP; i++)
		if (equip[i] && equip[i]->get_lasting() >= 100) {
			if (i == 2 && get_effect(me, EFFECT_NO_WEAPON)) continue;
			if (i == 3 && get_effect(me, EFFECT_NO_CLOTH)) continue;
			if (p = equip[i]->get("goldDP+") + equip[i]->get("dp") + equip[i]->get("dp+") + equip[i]->get("dpp") + equip[i]->get("dp2") + equip[i]->get("stoneDP+") + equip[i]->get("stoneDP++") + equip[i]->get("stoneDP+++")) add += p;
	...
	switch (me->get_weapon_code()) {
	default:
		if (p = me->get_skill(SKILL_0212)) add += p * 3; // 拳脚招架
	...
	case BLADE:
	case SWORD:
		if (p = me->get_skill(SKILL_0222)) add += p * 11 / 10; // 刀剑格挡
...
void count_cp(object me) {
	...
	for (i = 0; i < MAX_EQUIP; i++)
		if (equip[i] && equip[i]->get_lasting() >= 100) {
			if (i == 2 && get_effect(me, EFFECT_NO_WEAPON)) continue;
			if (i == 3 && get_effect(me, EFFECT_NO_CLOTH)) continue;
			if (p = equip[i]->get("goldCP+") +  equip[i]->get("cp") + equip[i]->get("cp+") + equip[i]->get("cpp") + equip[i]->get("cp2") + equip[i]->get("stoneCP+") + equip[i]->get("stoneCP++") + equip[i]->get("stoneCP+++")) add += p;
			if (p = equip[i]->get("cp%") + equip[i]->get("cp%+") + equip[i]->get("cps%")) cent += p;
	...
	switch (me->get_weapon_code()) {
	case SWORD:
		if (p = me->get_skill(SKILL_0131)) cp += me->set_temp_cp("0131", p); // 基本剑法
		break;
	}
	...
	if (me->get_2("thucuoi.cp%")) {
		rate = me->get_2("thucuoi.cp%");
		cp = cp + cp * rate / 100;
	}
	...
	if (me->get_dame_title_code() == "P001") cp += 10;
	if (me->get_dame_title_code() == "P002") cp += 20;
	if (me->get_dame_title_code() == "P003") cp += 30;
	if (me->get_dame_title_code() == "P004") cp += 40;
	if (me->get_dame_title_code() == "P005") cp += 150;
	if (me->get_dame_title_code() == "P006") cp += 200;
	if (me->get_dame_title_code() == "P007") cp += 250;
	if (me->get_dame_title_code() == "P008") cp += 300;
	if (me->get_dame_title_code() == "P009") cp += 350;
	if (me->get_dame_title_code() == "P010") cp += 450;
	if (me->get_dame_title_code() == "P011") cp += 600;

	if (me->get_dame_title_code() == "W001") cp += 100;
	if (me->get_dame_title_code() == "W002") cp += 150;
	if (me->get_dame_title_code() == "W003") cp += 200;
	if (me->get_dame_title_code() == "W004") cp += 250;
	if (me->get_dame_title_code() == "W005") cp += 350;

	if (me->get_dame_title_code() == "E500") cp += 100;
...
void count_pp(object me) {
	...
	for (i = 0; i < MAX_EQUIP; i++)
		if (equip[i] && equip[i]->get_lasting() >= 100) {
			if (i == 2 && get_effect(me, EFFECT_NO_WEAPON)) continue;
			if (i == 3 && get_effect(me, EFFECT_NO_CLOTH)) continue;
			if (p = equip[i]->get("goldPP+") + equip[i]->get("pp") + equip[i]->get("pp+") + equip[i]->get("ppp") + equip[i]->get("pp2") + equip[i]->get("stonePP+") + equip[i]->get("stonePP++") + equip[i]->get("stonePP+++")) add += p;
...
void count_hit_rate(object me) {
	...
	if (p = me->get_skill(0221)) cent1 += p * (250 / 1000);
	if (p = me->get_skill(0426)) cent1 += p * 2 / 10;
	//-----------------------------------------------------------------------------------------------------		
	if (me->get_save_2("marry_fashion.time") > time()) {
	...
	switch (me->get_weapon_code()) {
	default:
		if (p = me->get_skill(0374))
		{
			cent1 = cent1 + p * 9 / 100;
		}
		break;
	case SPEAR:
		if (p = me->get_skill(0351))
		{
			cent1 = cent1 + p * 9 / 100;
		}
		break;
...
void count_dodge_rate(object me) {
	...
	if (p = me->get_skill(SKILL_0104)) cent1 += p * 15;
...
void count_anti_hurt(object me) {
	...
	if (me->get_2("thucuoi.anti_hurt")) {
		anti = me->get_2("thucuoi.anti_hurt");
		add1 += anti;
		add2 += anti;
		cent1 += anti;
		cent2 += anti;
	...
	if (me->get_2("jiguan.anti_hurt")) {
		anti = me->get_2("jiguan.anti_hurt");
		add1 += anti;
		add2 += anti;
		cent1 += anti;
		cent2 += anti;
...
int count_title_bonus(object me) {
	return 1;
}