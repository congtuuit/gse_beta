...
void drop_items_callout(object me, object who)
{
	...
	for (i = 0; i < size; i++)
	{
		...
		if (p < 8210 * rate / 100);    // NONE

		else if (p < 8550 * rate / 100)    // Ngân lượng
		{
