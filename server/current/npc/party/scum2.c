...
void do_visit2(object me, string arg)
{
	...
	case 3:
		...
		if (YUANBAO->get_yuanbao(me) > 10) {
			me->set("doubleTapKich", 1);
			YUANBAO->add_yuanbao(me, -10);
			notify(HIY"Bạn sử dụng 10 Ngân bảo để nhận thêm 50%% kinh nghiệm");
		}
		break;
	case 4:
		who->set("c_n", 1);
