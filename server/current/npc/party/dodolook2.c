...
void do_welcome_call(object me, string arg)
{
	...
	case 3:
		...
		else if (rate >= 375 && rate < 500)
		{
			...
			result = result + HIR "100tiềm năng";
		}
	...
	case 4:
		...
		else if (rate >= 300 && rate < 425)
		{
			...
			result = result + HIR "500tiềm năng";
		}
	...
	case 5:
		...
		else if (rate >= 4999 && rate < 7499)
		{
			...
			result = result + HIR "1000tiềm năng";
		}
		...
		break;
	case 7:
		send_user(who, "%c%c%w%s", ':', 3, me->get_char_picid(), sprintf("%s：\n    目前为止，你已经给我了%d个七国令了，谢谢你哦～！还望你再接再厉，继续加油哦～！\n" ESC "Rời khỏi.", me->get_name(), who->get_save("qgl_n")));
		break;
	case 8:
