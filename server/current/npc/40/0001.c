...
void do_welcome2( object me, string arg )
{
        ...
        case 2:
			...
			who->add_cash(20000);
			send_user(who,"%c%s",';',"Tình yêu（3） 经验 20000 tiềm năng 290 Ngân lượng 20000 混天冠图纸 1");
	...
	case 3:
			...
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_WEIGUO,29,"Tình yêu（4）" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Tình yêu（4）");
        	}
        	break;  
        case 4:
			...
			who->add_cash(57000);
			send_user(who,"%c%s",';',sprintf("Tình yêu（4） 经验 56000 tiềm năng 830 Ngân lượng 57000 %s 1",tmp->get_name()));
