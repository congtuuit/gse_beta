...
void do_welcome2( object me, string arg )
{
        ...
        case 1:
                send_user( who, "%c%c%s", ':', 2,
                        sprintf("%s：\n    快乐的时间总是短暂的，这么快就要分别我还真是舍不得……这是我临别之前的一点心意……Rời khỏi.这里后，你就会到达一个叫" HIY "新手村" NOR "的小村庄，我" HIY "爷爷" NOR "就住在那里。我也事先与爷爷打过招呼了，只要你把这封介绍信交给他就可以了，如果今后遇到什么困难，尽管向爷爷请教，他都会帮助你的。\n"
