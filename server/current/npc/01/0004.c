	...
	object who,item;
        ...
        switch(flag)
        {
			...
			send_user( who, "%c%c%w%s", ':',3,get_char_picid(), sprintf(get_name() + "：\n    当人物等级达到10级就可以去各个国家学习生活技能。\n"ESC"有哪些生活技能？\ntalk %x# welcome.7\n"ESC"返回\ntalk %x# welcome.0\n"ESC"Rời khỏi.",id,id));
        		break;	        	
        	case 3:
			send_user( who, "%c%c%w%s", ':',3,get_char_picid(), sprintf(get_name() + "：\n    如果你觉得生活技能学错了，可以到周国找到申公豹把生活技能删除。不过你之前所学到的制造配方，升级所用过的经验、tiềm năng、Ngân lượng都会消失并且不会返还。所以选择生活技能要慎重。\n"ESC"有哪些生活技能？\ntalk %x# welcome.8\n"ESC"返回\ntalk %x# welcome.0\n"ESC"Rời khỏi.",id,id));
        		break;
        	case 4:
			send_user( who, "%c%c%w%s", ':',3,get_char_picid(), sprintf(get_name() + "：\n    升级生活技能你必须回去你学习生活技能的NPC，跟他对话选择所需的生活技能就可以升级。你可以使用经验或者tiềm năng来升级生活技能。生活技能有2个技能指标。一个是等级，一个是熟练度。生活技能满级是120级。\n"ESC"有哪些生活技能？\ntalk %x# welcome.9\n"ESC"什么是生活技能的等级？\ntalk %x# welcome.41\n"ESC"什么是生活技能的熟练度？\ntalk %x# welcome.42\n"ESC"返回\ntalk %x# welcome.0\n"ESC"Rời khỏi.",id,id,id,id));
        		break;
        	case 5:
			...
			send_user( who, "%c%c%w%s", ':',3,get_char_picid(), sprintf(get_name() + "：\n    矿冶就是采矿和冶金。矿冶包括2个技能，一个是矿石的采集，一个矿石的冶炼。我们在野外采集回来的是矿石的原矿，要进一步进行冶炼才能真正提供给铁匠、机关使用。矿冶可以在燕国找燕国工匠处学习技能，矿冶所需要的工具是锄头可以在燕国的杂货店老板处购买。矿石可以在各地的修理店老板附近熔炼成矿锭。\n"ESC"返回\ntalk %x# welcome.6\n"ESC"Rời khỏi.",id));
        		break; 
        	case 63:
			send_user( who, "%c%c%w%s", ':',3,get_char_picid(), sprintf(get_name() + "：\n    裁缝是制造各种防具的，包括了衣服、帽子、鞋子。裁缝可以在韩国找韩国工匠学习技能， 裁缝的工具是绣花针，可以在韩国杂货店老板处购买。 裁缝需要的原料是布和一些线。布料可以从怪物身上获得，而线可以在任何的Cửa hàng trang sức老板处购买。\n"ESC"返回\ntalk %x# welcome.6\n"ESC"Rời khỏi.",id));
        		break; 
        	case 64:
