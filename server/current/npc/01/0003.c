...
void do_welcome2( object me, string arg )
{
        ...
        case 2:
			...
			send_user(who,"%c%s",';',"亡羊补牢 经验 500 tiềm năng 10");
        	...
        	if ( who->get_legend(TASK_NEWBIE_03,23) && !who->get_legend(TASK_NEWBIE_03,24) )
		{
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"亡羊补牢(2)");
        	}
        	break;
        case 4:
		...
		who->delete_save_2("zxganliang");
		send_user(who,"%c%s",';',"亡羊补牢 经验 900 tiềm năng 40 Ngân lượng 1000");
		...
		send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"亡羊补牢(3)");        	
        	break;      	
        }
}