...
//		//send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_NEWBIE_01,22,"正义之战(已经Hoàn thành)" );
//		USER_TASK_D->send_task_intro(who,2,TID_NEWBIE_01,22);
//		send_user( who, "%c%s", '!', HIY"正义之战"NOR" 任务Hoàn thành");			
//		who->add_exp(80);
//		who->add_potential(1);
//		send_user(who,"%c%s",';',"你得到80点经验和1点tiềm năng");
//	}	
}