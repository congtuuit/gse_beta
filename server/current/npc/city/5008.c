...
void do_welcome2( object me, string arg )
{
        ...
        case 2:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"追捕逃犯");
        	}
        	break;
        case 3:
			...
			who->add_cash(7000);
			send_user(who,"%c%s",';',"追捕逃犯 经验 7500 tiềm năng 300 Ngân lượng 7000");
        ...
        case 5:
			...
			who->add_cash(22000);
			send_user(who,"%c%s",';',"Sự thật được tiết lộ 经验 23000 tiềm năng 420 Ngân lượng 22000 Rượu vang đỏ图纸 1");
        ...
        case 7:
			...
			who->add_cash(22000);
			send_user(who,"%c%s",';',"Hàm ý tội ác 经验 24000 tiềm năng 430 Ngân lượng 22000");
	...
	case 8:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"劝谏秦王");
        	}
        	break;  
        case 99:
