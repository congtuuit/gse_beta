...
void do_welcome2( object me, string arg )
{
	...
	case 2:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"出使秦国");
        	}
        	break;   
        case 3:
        	if ( who->get_legend(TASK_21,20) && !who->get_legend(TASK_21,21) )
	...
	case 4:
			...
			who->add_cash(17000);
			send_user(who,"%c%s",';',"出使信函 经验 17000 tiềm năng 390 Ngân lượng 17000");
	...
	case 5:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"面见赵王");
        	}
        	break;        	
	case 6:
		if ( who->get_level() >= 110 && !who->get_legend(TASK_43,5) )
	...
	case 7:
		if ( who->get_level() >= 110 && !who->get_legend(TASK_43,5) )
		{
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"询察起因");
        	}	
		break;
        case 99:	
