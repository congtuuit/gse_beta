...
void do_look( object who )
{
	...
	if ( who->get_legend(TASK_22,17) && !who->get_legend(TASK_22,18) )
		tmp += sprintf(ESC HIY "Khó khăn khi viết\ntalk %x# welcome.17\n",getoid(this_object()));
...
void do_welcome2( object me, string arg )
{
	...
	case 2:
			...
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_QINGUO,1,"Chạy trốn" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Chạy trốn");
        	}
        	break;
        case 3:
			...
			who->add_cash(3800);
			send_user(who,"%c%s",';',"Chạy trốn 经验 4700 tiềm năng 150 Ngân lượng 3800");
	...
	case 5:
			...
			send_user( who, "%c%c%c%w%s", 0x51, 2, 1,TID_QINGUO,"Tần Quốc" );
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_QINGUO,2,"Cuộc nổi dậy của lao động khổ sai" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Cuộc nổi dậy của lao động khổ sai");
        	}
        	break;
        case 6:
			...
			who->add_cash(3500);
			send_user(who,"%c%s",';',sprintf("Cuộc nổi dậy của lao động khổ sai 经验 5000 tiềm năng 160 Ngân lượng 3500 %s 1",tmp->get_name()));
        ...
        case 8:
			...
			who->add_cash(12000);
			send_user(who,"%c%s",';',"打听消息 经验 13000 tiềm năng 350 Ngân lượng 12000");
        ...
        case 10:
			...
			who->add_cash(13000);
			send_user(who,"%c%s",';',"破土动工 经验 15000 tiềm năng 360 Ngân lượng 13000 翠玉袍图纸 1",);
        ...
        case 11:
			...
			who->add_cash(15500);
			send_user(who,"%c%s",';',"寻求支持 经验 16000 tiềm năng 380 Ngân lượng 15500 血饮狂刀图纸 1");
        ...
        case 13:
			...
			who->add_cash(20000);
			send_user(who,"%c%s",';',"寻求支持 经验 19000 tiềm năng 390 Ngân lượng 20000");
	...
	case 14:
			...
			send_user( who, "%c%c%c%w%s", 0x51, 2, 1,TID_QINGUO,"Tần Quốc" );
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_QINGUO,39,"Vu khống" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Vu khống");
        	}
        	break;     
        case 15:
			...
			who->add_cash(21000);
			send_user(who,"%c%s",';',"Vu khống 经验 20000 tiềm năng 400 Ngân lượng 21000");
	...
	case 16:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"陈述冤情");
        	}
        	break;
	case 17:
		if ( who->get_legend(TASK_22,16) && !who->get_legend(TASK_22,17) )
        ...
        case 18:
			...
			who->add_cash(24000);
			send_user(who,"%c%s",';',"劝谏秦王 经验 25000 tiềm năng 420 Ngân lượng 24000 玄铁锄头图纸 1");
	...
	case 19:
			...
			send_user( who, "%c%c%c%w%s", 0x51, 2, 1,TID_QINGUO,"Tần Quốc" );
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_QINGUO,47,"Khó khăn khi viết" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Khó khăn khi viết");
        	}
        	break;        	
