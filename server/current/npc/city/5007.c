...
void do_welcome2( object me, string arg )
{
	...
	case 2:
			...
			who->add_cash(5100);
			send_user(who,"%c%s",';',"出使秦国 经验 5500 tiềm năng 230 Ngân lượng 5100");
	...
	case 4:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"准备出使");
        	}
        	break;
	case 5:
			...
			send_user( who, "%c%c%c%w%s", 0x51, 2, 1,TID_QINGUO,"Tần Quốc" );
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_QINGUO,34,"Khó khăn" );
	...
	case 6:
			...
			who->add_cash(16000);
			send_user(who,"%c%s",';',"Khó khăn 经验 16500 tiềm năng 370 Ngân lượng 16000");
	...
	case 7:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"出使信函");
        	}
        	break;
        case 99:	
