...
{ 
	...
	{
		tmp = sprintf(ESC HIY "Chờ và xem\ntalk %x# welcome.1\n",getoid(me));
	}
...
void do_welcome2( object me, string arg )
{
	...
	case 2:
			...
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_QIGUO,24,"Chờ và xem" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Chờ và xem");
        	}
        	break;
        case 3:
			...
			who->add_cash(44000);
			send_user(who,"%c%s",';',"Chờ và xem 经验 45500 tiềm năng 640 Ngân lượng 44000");
	...
	case 5:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"种庄稼的锄头");
        	}
        	break;
        case 99:
        	GUARDER_D->do_look_2( who, me ); 
