...
void do_look( object who )
{
	...
	{
		tmp = sprintf(ESC HIY "Đi vênh vang\ntalk %x# welcome.1\n",id);
	}
...
void do_welcome2( object me, string arg )
{
        ...
        case 2:
			...
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_WEIGUO,13,"Đi vênh vang" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Đi vênh vang");
        	}
        	break;
        case 3:
			...
			who->add_cash(1200);
			send_user(who,"%c%s",';',"Đi vênh vang 经验 1000 tiềm năng 70 Ngân lượng 1200 沙场甲图纸 1");
        ...
        case 5:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"了解情况");
        	}
        	break;
        }
}