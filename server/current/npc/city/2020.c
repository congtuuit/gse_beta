...
void do_welcome2( object me, string arg )
{
        ...
        case 1:
			...
			send_user(who, "%c%c%w%s", ':', 3, me->get_char_picid(), sprintf("%s:\n    修筑长城，抵御外侵。大王召我去修工事，可是我这人做工一定要喝Rượu gạo才能施展出神力，可惜家里的Rượu gạo已被喝完，你能帮我去找10坛Rượu gạo吗？我一定重重谢你。\n"ESC"Nhận nhiệm vụ\ntalk %x# welcome.2\n"ESC"Rời khỏi.", me->get_name(),getoid(me)));
        ...
        case 2:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"工匠的苦恼");
        	}
        	break;
        case 3:
        	if ( !who->get_legend(TASK_04,19) || who->get_legend(TASK_04,20) )
        		return ;
        	if ( TASK_LEGEND_D->check_task_item_amount(who,"Rượu gạo") >= 10  )
        ...
        case 4:
        	if ( who->get_legend(TASK_04,19) && !who->get_legend(TASK_04,20) )
        	{
        		if (TASK_LEGEND_D->check_task_item1(who,"Rượu gạo",10) != 1 ) 
        			return;
			...
			who->add_cash(1500);
			send_user(who,"%c%s",';',"工匠的苦恼 经验 1600 tiềm năng 80 Ngân lượng 1500 一口肉 3");
