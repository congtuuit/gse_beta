...
void do_look( object who )
{
	...
	if ( ( who->get_level() >= 35 && !who->get_legend(TASK_10,11) ) || ( who->get_legend(TASK_10,11) && !who->get_legend(TASK_10,13) ) )
		tmp += sprintf(ESC HIY "Kinh nghiệm kinh doanh\ntalk %x# welcome.5\n",getoid(me));
	...
	if ( (who->get_legend(TASK_30,23) && !who->get_legend(TASK_30,24)) || (who->get_legend(TASK_30,24) && !who->get_legend(TASK_30,26)))
		tmp += sprintf(ESC HIY "Đơn độc trong mộ cổ\ntalk %x# welcome.8\n",getoid(me));
	...
	if ( ( who->get_level() >= 100 && !who->get_legend(TASK_35,27) ) || ( who->get_legend(TASK_35,27) && !who->get_legend(TASK_35,29) ) )
		tmp += sprintf(ESC HIY "Ác ma trong lọ Tiên trong nồi\ntalk %x# welcome.15\n",getoid(me));
	if ( sizeof(tmp) )
...
void do_welcome2( object me, string arg )
{
	...
	string *nTmp,tmp;     
        ...
        case 2:
			...
			send_user(who,"%c%s",';',"买椟还珠 经验 600 tiềm năng 20");
        ...
        case 3 :
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"买椟还珠(2)");
        	}
        	break;
        case 4:
			...
			send_user(who,"%c%s",';',sprintf("买椟还珠 经验 800 tiềm năng 50 Ngân lượng 2000 %s 1",tmp->get_name()));
        ...
        case 6:
			...
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_QIGUO,12,"Kinh nghiệm kinh doanh" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Kinh nghiệm kinh doanh");
        	}
        	break;
       case 7:
			...
			who->add_cash(3000);
			send_user(who,"%c%s",';',"Kinh nghiệm kinh doanh 经验 4000 tiềm năng 115 Ngân lượng 3000");
	...
	case 8:
        ...
        case 9:
			...
			who->add_cash(53000);
			send_user(who,"%c%s",';',"商人诉苦 经验 70000 tiềm năng 820 Ngân lượng 53000");
        ...
        case 10:
			...
			send_user( who, "%c%c%c%w%s", 0x51, 2, 1,TID_QIGUO,"Tề Quốc" );
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_QIGUO,42,"Đơn độc trong mộ cổ" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Đơn độc trong mộ cổ");
        	}
        	break;
        case 11:
			...
			who->add_cash(55000);
			send_user(who,"%c%s",';',"Đơn độc trong mộ cổ 经验 69000 tiềm năng 800 Ngân lượng 55000");
        ...
        case 12:
			...
			send_user( who, "%c%c%c%w%s", 0x51, 2, 1,TID_QIGUO,"Tề Quốc" );
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_QIGUO,43,"Tống khứ bọn cướp đi" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Tống khứ bọn cướp đi");
        	}
        	break;
	case 13:
		if ( who->get_level() >= 95 && !who->get_legend(TASK_38,23) )
        ...
        case 14:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"讨好");
        	}
        	break;
        case 15:
        ...
        case 16:
			...
			send_user( who, "%c%c%c%w%s", 0x51, 2, 1,TID_QIGUO,"Tề Quốc" );
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_QIGUO,50,"Ác ma trong lọ Tiên trong nồi" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Ác ma trong lọ Tiên trong nồi");
        	}
        	break;
	case 17:
			...
			who->add_cash(3000);
			send_user(who,"%c%s",';',"Ác ma trong lọ Tiên trong nồi 经验 83000 tiềm năng 1040 Ngân lượng 72000 归元丹图纸 1");
