...
void do_welcome2( object me, string arg )
{
        ...
        case 2:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"御史的烦恼");
        	}
        	break;
        case 3:
			...
			who->add_cash(1500);
			send_user(who,"%c%s",';',"御史的烦恼 经验 1200 tiềm năng 70 Ngân lượng 1500");
	...
	case 5:
		...
		break;		
         case 6:
			...
			who->add_cash(36000);
			send_user(who,"%c%s",';',"Loại bỏ những kẻ phản bội 经验 35000 tiềm năng 530 Ngân lượng 36000");
	...
	case 9:
			...
			who->add_cash(38000);
			send_user(who,"%c%s",';',"寻求帮助 经验 36000 tiềm năng 550 Ngân lượng 38000");
	...
	case 10:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"御史的建议");
        	}
        	break;   
	case 11:
        	if ( who->get_legend(TASK_26,10) && !who->get_legend(TASK_26,11) )
			...
			send_user(who, "%c%c%w%s", ':', 3, me->get_char_picid(), sprintf("%s:\n    那杀害林为的妻子的土匪自持懂得操纵鬼灵之术，藏身在妖物满布的灵谷洞的最深处，想要捉拿他必须动员我国大量的兵士。但是我国的兵士现在都在边境提防秦国的进攻，一刻也不可以Rời khỏi.岗位，所以现在要捉拿那土匪有点困难。这件事我先交给内政官去处理，你去找他吧，他应该可以想到两全其美的方法。\n"ESC"Nhận nhiệm vụ\ntalk %x# welcome.13\n"ESC"Rời khỏi.", me->get_name(),getoid(me)));
	...
	case 12:
			...
			who->add_cash(38000);
			send_user(who,"%c%s",';',"商人哭诉 经验 38000 tiềm năng 570 Ngân lượng 38000");
	...
	case 13:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"御史的担心");
        	}
        	break; 
	case 14:
        	if ( who->get_legend(TASK_26,18) && !who->get_legend(TASK_26,19) )
			...
			who->add_cash(40000);
			send_user(who,"%c%s",';',"Loại bỏ cái ác cho nhân dân 经验 40000 tiềm năng 590 Ngân lượng 40000");
	...
	case 15:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"寻人避难");
        	}
        	break; 
	case 16:
        	if ( who->get_legend(TASK_26,24) && !who->get_legend(TASK_26,25) )
	...
	case 17:
			...
			who->add_cash(42000);
			send_user(who,"%c%s",';',"乐师的无奈 经验 42000 tiềm năng 610 Ngân lượng 42000");
	...
	case 18:
			...
			send_user( who, "%c%c%c%w%s", 0x51, 2, 1,TID_HANGUO,"Hàn Quốc" );
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_HANGUO,38,"Tìm một cách" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Tìm một cách");
        	}
        	break; 
        case 99:	
