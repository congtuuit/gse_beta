...
void do_welcome2( object me, string arg )
{
        ...
        case 2:
			...
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_WEIGUO,32,"Sư tử đá" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Sư tử đá");
        	}
        	break; 
        case 3:
			...
			who->add_cash(48000);
			send_user(who,"%c%s",';',"Sư tử đá 经验 52000 tiềm năng 720 Ngân lượng 48000");
