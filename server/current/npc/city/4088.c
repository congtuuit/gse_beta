...
void do_look( object who )
{
	...
	{
		tmp = sprintf(ESC HIY "Quên lời thề\ntalk %x# welcome.1\n",getoid(me));
	}
...
void do_welcome2( object me, string arg )
{
        ...
        case 1:
			...
			send_user(who, "%c%c%w%s", ':', 3, me->get_char_picid(), sprintf("%s:\n    这下不光是那个害人的劫匪被除掉了，我多年来的誓言也Hoàn thành了，非常感谢！\n"ESC"Hoàn thành任务\ntalk %x# welcome.3\n"ESC"Rời khỏi.", me->get_name(),getoid(me)));
        ...
        case 2:
			...
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_WEIGUO,17,"Quên lời thề" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Quên lời thề");
        	}
        	break;
        case 3:
			...
			who->add_cash(1200);
			send_user(who,"%c%s",';',sprintf("Quên lời thề 经验 1300 tiềm năng 70 Ngân lượng 1200 %s 1",tmp->get_name()));
        	...
        	if ( who->get_level() >= 90 && who->get_legend(TASK_38,17) && !who->get_legend(TASK_38,18) ) 
		{
			...
			who->add_cash(25000);
			send_user(who,"%c%s",';',"询问价格 经验 33000 tiềm năng 420 Ngân lượng 25000");
