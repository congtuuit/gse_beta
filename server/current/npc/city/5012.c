...
{ 
	...
	object me = this_object();
		...
		tmp += sprintf(ESC HIY "Điểm mấu chốt\ntalk %x# welcome.4\n",getoid(this_object())); 
...
void do_welcome2( object me, string arg )
{
        ...
        case 2:
			...
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_QINGUO,48,"Sát nhân" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Sát nhân");
        	}
        	break;
	case 3:
			...
			who->add_cash(8000);
			send_user(who,"%c%s",';',"Sát nhân 经验 7700 tiềm năng 270 Ngân lượng 8000");
	...
	case 4:
			...
			send_user(who, "%c%c%w%s", ':', 3, me->get_char_picid(), sprintf("%s:\n    哈哈，你这个家伙果然上当了，我可没有什么秘密，是你非得Điểm mấu chốt的，我只不过是消遣下！\n"ESC"Hoàn thành任务\ntalk %x# welcome.10\n"ESC"Rời khỏi.", me->get_name(),getoid(me)));
        ...
        case 5:
			...
			send_user( who, "%c%c%c%w%s", 0x51, 2, 1,TID_QINGUO,"Tần Quốc" );
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_QINGUO,56,"Điểm mấu chốt（1）" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Điểm mấu chốt（1）");
        	}
        	break;
	case 6:
			...
			who->add_cash(55000);
			send_user(who,"%c%s",';',"Điểm mấu chốt（1） 经验 35000  tiềm năng 649 Ngân lượng 55000");
        ...
        case 7:
			...
			send_user( who, "%c%c%c%w%s", 0x51, 2, 1,TID_QINGUO,"Tần Quốc" );
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_QINGUO,57,"Điểm mấu chốt（2）" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Điểm mấu chốt（2）");
        	}
        	break;
	case 8:
			...
			who->add_cash(38000);
			send_user(who,"%c%s",';',"Điểm mấu chốt（2） 经验 40000 tiềm năng 658 Ngân lượng 38000");
        ...
        case 9:
			...
			send_user( who, "%c%c%c%w%s", 0x51, 2, 1,TID_QINGUO,"Tần Quốc" );
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_QINGUO,58,"Điểm mấu chốt（3）" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Điểm mấu chốt（3）");
        	}
        	break;
	case 10:
			...
			who->add_cash(148000);
			send_user(who,"%c%s",';',"Điểm mấu chốt（3） 经验 145000 tiềm năng 1500 Ngân lượng 148000 飞天战盔图纸 1");
