...
void do_look( object who )
{
	...
	{
		tmp += sprintf(ESC HIY "Hoa mẫu đơn\ntalk %x# welcome.1\n",id);
	}
	...
	{
		tmp += sprintf(ESC HIY "Điều kiện của bọn bắt cóc\ntalk %x# welcome.5\n",id);
	}
...
void do_welcome2( object me, string arg )
{
	...
	case 2:
			...
			who->add_cash(1000);
			send_user(who,"%c%s",';',"去燕的盘缠 经验 1000 tiềm năng 10 Ngân lượng 1000");
	...
	case 3:
			...
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_WEIGUO,6,"Hoa mẫu đơn" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Hoa mẫu đơn");
        	}
        	break;
        case 4:
			...
			who->add_cash(1300);
			send_user(who,"%c%s",';',"Hoa mẫu đơn 经验 1500 tiềm năng 30 Ngân lượng 1300 盘缠 1");
        ...
        case 6:
			...
			send_user( who, "%c%c%c%w%s", 0x51, 2, 1,TID_WEIGUO,"Ngụy Quốc" );
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_WEIGUO,33,"Điều kiện của bọn bắt cóc" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Điều kiện của bọn bắt cóc");
        	}
        	break; 
        case 7:
			...
			who->add_cash(50000);
			send_user(who,"%c%s",';',"Điều kiện của bọn bắt cóc 经验 54000 tiềm năng 745 Ngân lượng 50000 飞羽冠图纸 1");
        ...
        case 9:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"打探消息");
        	}
        	break; 	   
        case 10:
        	if ( who->get_legend(TASK_34,7) && !who->get_legend(TASK_34,8) ) 
			...
			who->add_cash(60000);
			send_user(who,"%c%s",';',"Ngụy Quốc Bá Tánh 经验 73000 tiềm năng 900 Ngân lượng 60000 紫金丹图纸 1");
