...
{ 
	...
	{
		tmp = sprintf(ESC HIY "Bảo vệ hối hận\ntalk %x# welcome.1\n",getoid(me));
	}
	if ( sizeof(tmp) )
...
void do_welcome2( object me, string arg )
{
	...
	case 2:
			...
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_QIGUO,23,"Bảo vệ hối hận" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Bảo vệ hối hận");
        	}
        	break;
        case 3:
			...
			who->add_cash(43800);
			send_user(who,"%c%s",';',"Bảo vệ hối hận 经验 45000 tiềm năng 638 Ngân lượng 43800");
