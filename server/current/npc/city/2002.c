...
void do_look( object who )
{
	...
	{
		tmp += sprintf(ESC HIY "Thảm họa rò rỉ\ntalk %x# welcome.5\n",getoid(me));
	}
...
void do_welcome2( object me, string arg )
{
        ...
        case 2:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"将军之难");
        	}
        	break;
        case 3:
			...
			who->add_cash(1500);
			send_user(who,"%c%s",';',"将军之难 经验 2200 tiềm năng 80 Ngân lượng 1500 Đậu phụ khô 3");
        ...
        case 6:
			...
			send_user( who, "%c%c%c%w%s", 0x51, 2, 1,TID_HANGUO,"Hàn Quốc" );
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_HANGUO,44,"Thảm họa rò rỉ" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Thảm họa rò rỉ");
        	}
        	break;  
        case 7:
			...
			who->add_cash(23000);
			send_user(who,"%c%s",';',"Thảm họa rò rỉ 经验 25000 tiềm năng 430 Ngân lượng 23000");
        ...
        case 9:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"崔大官人的请柬");
        	}
        	break;
        case 99:	
