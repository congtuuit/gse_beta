...
void do_welcome2( object me, string arg )
{
        ...
        case 2:
			...
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_WEIGUO,35,"Truy nã" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Truy nã");
        	}
        	break; 
        case 3:
			...
			who->add_cash(50000);
			send_user(who,"%c%s",';',"Truy nã 经验 60000 tiềm năng 900 Ngân lượng 50000 云龙战靴图纸 1");
	...
	case 5:
			...
			who->add_cash(62000);
			send_user(who,"%c%s",';',"奏请王命 经验 74000 tiềm năng 930 Ngân lượng 62000 紫心丹图纸 1");
        ...
        case 7:
			...
			who->add_cash(71000);
			send_user(who,"%c%s",';',sprintf("禀告Ngụy Vương 经验 81000 tiềm năng 1100 Ngân lượng 71000 %s 1",tmp->get_name()));
	...
	case 22:
		if ( who->get_save("dodolook") == 1 )
		{
			...
			p = item->move(who,-1);
			item->add_to_user(p);
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIR"寻回玉玺");
			...
			send_user(who,"%c%s",';',"拜访Ngụy Chiêu Vương 经验 1000 tiềm năng 50 Ngân lượng 1000 行军散 5");
		}
		break;
	case 23:
		if ( who->get_save("dodolook") == 3 )
		{
			...
			send_user(who,"%c%s",';',"拜访Ngụy Chiêu Vương 经验 2000 tiềm năng 50 Ngân lượng 2000 行军散 5 正气散 5 七国令 1");
			me->do_welcome(21);
		}
		break;
