...
void do_welcome2( object me, string arg )
{
        ...
        case 2:
			...
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_HANGUO,12,"Truy bắt tội phạm" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Truy bắt tội phạm");
        	}
        	break;
        case 3:
			...
			who->add_cash(1600);
			send_user(who,"%c%s",';',sprintf("Truy bắt tội phạm 经验 1900 tiềm năng 70 Ngân lượng 1600 %s 1",tmp->get_name()));
        ...
        case 5:
			...
			send_user( who, "%c%c%c%w%s", 0x51, 2, 1,TID_HANGUO,"Hàn Quốc" );
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_HANGUO,14,"Bộ luật hình sự" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Bộ luật hình sự");
        	}
        	break;
        case 6:
			...
			who->add_cash(1600);
			send_user(who,"%c%s",';',"Bộ luật hình sự 经验 2100 tiềm năng 90 Ngân lượng 1600 铜剑图纸 1");
