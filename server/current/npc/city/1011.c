...
{ 
	...
	{
		tmp = sprintf(ESC HIY "Bảo vệ người chết\ntalk %x# welcome.1\n",getoid(me));
	}
...
void do_welcome2( object me, string arg )
{
	...
	case 2:
			...
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_QIGUO,21,"Bảo vệ người chết" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Bảo vệ người chết");
        	}
        	break;
        case 3:
			...
			who->add_cash(44500);
			send_user(who,"%c%s",';',"Bảo vệ người chết 经验 45000 tiềm năng 640 Ngân lượng 44500");
	...
	case 5:
		if ( who->get_level() >= 85 && !who->get_legend(TASK_38,17) )
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"询问价格");
        	}
		break;
        case 99:
        	GUARDER_D->do_look_3( who, me ); 
