...
void do_welcome2( object me, string arg )
{
        ...
        case 2:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"孝顺的守卫");        		
        	}
        	break;
        case 3:
			...
			send_user(who,"%c%s",';',"孝顺的守卫 经验 850 tiềm năng 50 Ngân lượng 1500");
	...
	case 4:
        ...
        case 5:
			...
			send_user( who, "%c%c%c%w%s", 0x51, 2, 1,TID_CHUGUO,"Sở Quốc" );
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_CHUGUO,35,"Cơ thể bận rộn" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Cơ thể bận rộn");        		
        	}
        	break;
        case 6:
			...
			who->add_cash(54500);
			send_user(who,"%c%s",';',"Cơ thể bận rộn 经验 63000 tiềm năng 908 Ngân lượng 54500");
	...
	case 7:
        ...
        case 8:
			...
			send_user( who, "%c%c%c%w%s", 0x51, 2, 1,TID_CHUGUO,"Sở Quốc" );
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_CHUGUO,36,"Trà Quan Vũ" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Trà Quan Vũ");        		
        	}
        	break;
        case 9:
        	if ( who->get_legend(TASK_33,11) && !who->get_legend(TASK_33,12) )
        	{
			if ( TASK_LEGEND_D->check_task_item(who,"Trà Quan Vũ",20) != 1)
				return;
			...
			who->add_cash(58000);
			send_user(who,"%c%s",';',"Trà Quan Vũ 经验 70000 tiềm năng 925 Ngân lượng 58000 神秘老火汤图纸 1");
        ...
        case 11:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"韩总管的帮助");
        	}
        	break;
        case 99:
        	GUARDER_D->do_look_3( who, me ); 
