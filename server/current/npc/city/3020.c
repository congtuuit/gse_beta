...
void do_welcome2( object me, string arg )
{
	...
	case 2:
			...
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_ZHAOGUO,10,"Nước mắt Vạn Lý Trường Thành" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Nước mắt Vạn Lý Trường Thành");
        	}
        	break;
        case 3:
			...
			who->add_cash(6000);
			send_user(who,"%c%s",';',"Nước mắt Vạn Lý Trường Thành 经验 6000 tiềm năng 240 Ngân lượng 6000 铁套 2");
	...
	case 5:
        	if( who->get_level() >=55 && !who->get_legend(TASK_17,1) )
        	{
   			...
   			send_user( who, "%c%c%c%w%s", 0x51, 2, 1,TID_ZHAOGUO,"Triệu Quốc" );
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_ZHAOGUO,20,"Hào quang trên bầu trời đêm" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Hào quang trên bầu trời đêm");
        	}
        	break;       
        case 6:
			...
			who->add_cash(6200);
			send_user(who,"%c%s",';',"Hào quang trên bầu trời đêm 经验 6600 tiềm năng 250 Ngân lượng 6200");
	...
	case 8:
        	if( who->get_level() >=80 && !who->get_legend(TASK_28,20) )
        	{
   			...
   			send_user( who, "%c%c%c%w%s", 0x51, 2, 1,TID_ZHAOGUO,"Triệu Quốc" );
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_ZHAOGUO,51,"Trận chiến cuối cùng" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Trận chiến cuối cùng");
        	}
        	break;       
        case 9:
			...
			who->add_cash(48800);
			send_user(who,"%c%s",';',"Trận chiến cuối cùng 经验 51000 tiềm năng 705 Ngân lượng 48800 冰魄银针图纸 1");
