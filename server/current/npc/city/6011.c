...
void do_welcome2( object me, string arg )
{
	...
	case 1:
        ...
        case 2:
			...
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_CHUGUO,37,"Hoa hồng" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Hoa hồng");        		
        	}
        	break;
        case 3:
        	if ( who->get_legend(TASK_33,14) && !who->get_legend(TASK_33,15) )
        	{
			if ( TASK_LEGEND_D->check_task_item(who,"Hoa hồng",11) != 1)
				return;
			...
			who->add_cash(55000);
			send_user(who,"%c%s",';',"Hoa hồng 经验 63500 tiềm năng 910 Ngân lượng 55000");
