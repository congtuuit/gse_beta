...
void do_look( object who )
{
	...
	if ( (who->get_level() >= 60 && !who->get_legend(TASK_2_01,7)) || (who->get_legend(TASK_2_01,7) && !who->get_legend(TASK_2_01,9)))
		tmp += sprintf(ESC HIY "Tìm kiếm họ hàng xa\ntalk %x# welcome.18\n",getoid(me));
...
void do_welcome2( object me, string arg )
{
        ...
        case 2:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"百姓的嘱托");
        	}
        	break;
        case 3:
        ...
        case 4:
			...
			who->add_cash(1200);
			send_user(who,"%c%s",';',"百姓的嘱托 经验 1600 tiềm năng 80 Ngân lượng 1200");
        ...
        case 6:
			...
			send_user( who, "%c%c%c%w%s", 0x51, 2, 1,TID_HANGUO,"Hàn Quốc" );
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_HANGUO,11,"Trừ gian diệt ác" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Trừ gian diệt ác");
        	}
        	break;
        case 7:
			...
			who->add_potential(80);
			who->add_cash(1600);
			send_user(who,"%c%s",';',"Trừ gian diệt ác 经验 1800 tiềm năng 80 Ngân lượng 1600 地瓜粥 3");
        ...
        case 9:
			...
			send_user( who, "%c%c%c%w%s", 0x51, 2, 1,TID_HANGUO,"Hàn Quốc" );
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_HANGUO,43,"Ma da" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Ma da");
        	}
        	break;  
        case 10:
			...
			who->add_cash(23000);
			send_user(who,"%c%s",';',"Ma da 经验 25000 tiềm năng 430 Ngân lượng 23000");
        ...
        case 12:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"索取宝图");
        	}        	
        	break;   	    
	case 13:
        	if ( who->get_legend(TASK_26,3) && !who->get_legend(TASK_26,4) )
	...
	case 14:
			...
			who->add_cash(37000);
			send_user(who,"%c%s",';',"御史的建议 经验 37000 tiềm năng 540 Ngân lượng 37000");
	...
	case 15:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"指明方向");
        	}
        	break; 
	case 16:
        	if ( who->get_level() >= 80 && !who->get_legend(TASK_26,22) )
	...
	case 17:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"百姓的好心");
        	}
        	break; 
        case 18:
        ...
        case 19:
			...
			send_user( who, "%c%c%c%w%s", 0x51, 2, 1,TID_HANGUO,"Hàn Quốc" );
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_HANGUO,101,"Tìm kiếm họ hàng xa" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Tìm kiếm họ hàng xa");
		}
        	break;
        case 20:
			...
			who->add_cash(9600);
			send_user(who,"%c%s",';',"Tìm kiếm họ hàng xa 经验 16800 tiềm năng 500 Ngân lượng 9600");
