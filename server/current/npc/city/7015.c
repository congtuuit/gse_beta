...
void do_welcome2( object me, string arg )
{
        ...
        case 2:
			...
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_YANGUO,42,"Hỗ trợ" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Hỗ trợ");
        	}
        	break;
        case 3:
			...
			who->add_cash(53000);
			send_user(who,"%c%s",';',"Hỗ trợ 经验 62000 tiềm năng 900 Ngân lượng 53000");
        ...
        case 5:
			...
			send_user( who, "%c%c%c%w%s", 0x51, 2, 1,TID_YANGUO,"Yên Quốc" );
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_YANGUO,51,"Bóng tối bao trùm chúng ta" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Bóng tối bao trùm chúng ta");
        	}
        	break;
        case 6:
			...
			who->add_cash(93500);
			send_user(who,"%c%s",';',"Bóng tối bao trùm chúng ta 经验 90000 tiềm năng 973 Ngân lượng 93500");
