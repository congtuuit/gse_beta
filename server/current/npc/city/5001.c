...
void do_look( object who )
{
	...
	{
		tmp += sprintf(ESC HIY "Sự thật được tiết lộ\ntalk %x# welcome.6\n",getoid(me));
	}	
...
void do_welcome2( object me, string arg )
{
	...
	case 2:
			...
			who->add_cash(14000);
			send_user(who,"%c%s",';',"降旨修墓 经验 15000 tiềm năng 370 Ngân lượng 14000");
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_QINGUO,30,"" );
        	}
        	break;
        case 3:
        	if ( who->get_legend(TASK_21,15) && !who->get_legend(TASK_21,16) )
			send_user(who, "%c%c%w%s", ':', 3, me->get_char_picid(), sprintf("%s:\n    使节果然是高瞻远瞩，本王也不愿兄弟相残，徒让外人得利，你带本王口谕，着他即可出使赵国，Hoàn thành本王重托.\n"ESC"Hoàn thành nhiệm vụ\ntalk %x# welcome.4\n"ESC"Rời khỏi", me->get_name(),getoid(me)));
	...
	case 4:
			...
			who->add_cash(16000);
			send_user(who,"%c%s",';',"准备出使 经验 17000 tiềm năng 380 Ngân lượng 16000");
	...
	case 5:
			...
			who->add_cash(19000);
			send_user(who,"%c%s",';',"回奏Tần Vương 经验 18000 tiềm năng 400 Ngân lượng 19000 活心丹图纸 1");
	...
	case 7:
			...
			who->add_cash(21000);
			send_user(who,"%c%s",';',"明辨是非 经验 22000 tiềm năng 410 Ngân lượng 21000 南瓜饼图纸 1");
	...
	case 8:
			...
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_QINGUO,42,"Sự thật được tiết lộ" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Sự thật được tiết lộ");
        	}
        	break;
	case 9:
		if ( me->get_city_name() != who->get_city_name() )
	...
	case 12:
        ...
        case 14:
			...
			who->add_cash(93000);
			send_user(who,"%c%s",';',"索取神剑5 经验 100000 tiềm năng 1500 Ngân lượng 93000 困敌索 1");
