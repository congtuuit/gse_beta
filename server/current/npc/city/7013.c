...
{ 
	...
	{
		tmp = sprintf(ESC HIY "Xóa bỏ linh hồn\ntalk %x# welcome.1\n",getoid(me));
	}
...
void do_welcome2( object me, string arg )
{
        ...
        case 2:
			...
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_YANGUO,44,"Xóa bỏ linh hồn" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Xóa bỏ linh hồn");
        	}
        	break;
        case 3:
			...
			who->add_cash(53500);
			send_user(who,"%c%s",';',"Xóa bỏ linh hồn 经验 63000 tiềm năng 905 Ngân lượng 53500");
