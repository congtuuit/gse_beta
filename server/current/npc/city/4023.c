...
void do_welcome2( object me, string arg )
{
		...
		case 1:
			if ( who->get_level() >= 110 && !who->get_legend(TASK_44,4) )
				...
				send_user(who, "%c%c%w%s", ':', 3, me->get_char_picid(), sprintf("%s:\n    哈哈哈，终于最重要的东西也凑齐了，我可以再一次体验一下Hoàn thành鹊缘床的成就感了，喂，你那小子还站这里干嘛，走开走开，我的独门技艺可不能被你偷学了去，我不是已经给你钱了么，（摸摸口袋）啊，拿去拿去，我们两清了，记住，千万别来偷看，要不别怪老儿不客气！\n"ESC"Hoàn thành任务\ntalk %x# welcome.7\n"ESC"Rời khỏi.", me->get_name(),getoid(me)));
	        ...
	        case 2:
				...
				send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_WEIGUO,62,"Giường đẹp（1）" );
				send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Giường đẹp（1）");
	        	}
	        	break;         	
		case 3:
				...
				who->add_cash(48000);
				send_user(who,"%c%s",';',"Giường đẹp（1） 经验 50000 tiềm năng 700 Ngân lượng 48000");
	        ...
	        case 4:
				...
				send_user( who, "%c%c%c%w%s", 0x51, 2, 1,TID_WEIGUO,"Ngụy Quốc" );
				send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_WEIGUO,63,"Giường đẹp（2）" );
				send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Giường đẹp（2）");
	        	}
	        	break;         	
		case 5:
				...
				who->add_potential(700);
				who->add_cash(48000);
				send_user(who,"%c%s",';',"Giường đẹp（2） 经验 50000 tiềm năng 700 Ngân lượng 48000");
	        ...
	        case 6:
				...
				send_user( who, "%c%c%c%w%s", 0x51, 2, 1,TID_WEIGUO,"Ngụy Quốc" );
				send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_WEIGUO,64,"Giường đẹp（3）" );
				send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Giường đẹp（3）");
	        	}
	        	break;         	
		case 7:
				...
				who->add_cash(190000);
				send_user(who,"%c%s",';',"Giường đẹp（3） 经验 180000 tiềm năng 1400 Ngân lượng 190000 透魂钉图纸 1");
