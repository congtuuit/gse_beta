...
void do_welcome2( object me, string arg )
{
        ...
        case 2:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"出使重任");
        	}
        	break;
        case 3:
			...
			who->add_cash(1200);
			send_user(who,"%c%s",';',"出使重任 经验 1400 tiềm năng 70 Ngân lượng 1200 烤地瓜 2");
        ...
        case 4:
			...
			send_user(who, "%c%c%w%s", ':', 3, me->get_char_picid(), sprintf("%s:\n    这下好了，有了玉龙睛我就可以Hoàn thành这出使的重任了，%s真不知该如何报答你。\n"ESC"Hoàn thành任务\ntalk %x# welcome.3\n"ESC"Rời khỏi.", me->get_name(),NPC_RANK_D->get_respect_2(who),getoid(me)));
		else
        ...
        case 6:
			...
			send_user( who, "%c%c%c%w%s", 0x51, 2, 1,TID_HANGUO,"Hàn Quốc" );
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_HANGUO,42,"Mồi câu vàng" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Mồi câu vàng");
        	}
        	break;  
        case 7:
			...
			who->add_cash(25600);
			send_user(who,"%c%s",';',"Mồi câu vàng 经验 27000 tiềm năng 448 Ngân lượng 25600");
