...
void do_welcome2( object me, string arg )
{
        ...
        case 2:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"游魂（1）");
        	}
        	break;
        case 3:
		if (who->get_legend(TASK_23,20) && !who->get_legend(TASK_23,21))
		{
			...
			who->add_cash(86000);
			send_user(who,"%c%s",';',sprintf("游魂（7） 经验 85000 tiềm năng 14000 Ngân lượng 86000 %s 1",tmp->get_name()));
	...
	case 5:
			...
			who->add_cash(35000);
			send_user(who,"%c%s",';',"上奏Hàn Vương 经验 36000 tiềm năng 520 Ngân lượng 35000");
	...
	case 6:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"与楚联盟");
        	}
        	break;     
	case 7:
        	if ( who->get_legend(TASK_26,29) && !who->get_legend(TASK_26,30) )
	...
	case 8:
			...
			who->add_cash(43000);
			send_user(who,"%c%s",';',sprintf("上奏Hàn Vương 经验 43000 tiềm năng 630 Ngân lượng 43000 %s 1",tmp->get_name()));
