...
void do_look( object who )
{
	...
	{
		tmp = sprintf(ESC HIY "Con gấu ngu ngốc\ntalk %x# welcome.1\n",getoid(me));
	}
...
void do_welcome2( object me, string arg )
{
        ...
        case 2:
			...
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_YANGUO,29,"Con gấu ngu ngốc" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Con gấu ngu ngốc");
        	}
        	break;
        case 3:
			...
			who->add_cash(4900);
			send_user(who,"%c%s",';',"Con gấu ngu ngốc 经验 6000 tiềm năng 245 Ngân lượng 4900");
