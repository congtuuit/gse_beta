...
void do_welcome2( object me, string arg )
{
        ...
        case 2:
			...
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_WEIGUO,22,"Giấc mơ xa" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Giấc mơ xa");
        	}
        	break;
        case 3:
			...
			who->add_cash(1400);
			send_user(who,"%c%s",';',"Giấc mơ xa 经验 1600 tiềm năng 70 Ngân lượng 1400 铜矛图纸 1");
        ...
        case 5:
			...
			send_user( who, "%c%c%c%w%s", 0x51, 2, 1,TID_WEIGUO,"Ngụy Quốc" );
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_WEIGUO,34,"Điều kiện để làm bảo vệ" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Điều kiện để làm bảo vệ");
        	}
        	break; 
        case 6:
			...
			who->add_cash(48000);
			send_user(who,"%c%s",';',"Điều kiện để làm bảo vệ 经验 52000 tiềm năng 720 Ngân lượng 48000");
        ...
        case 8:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"换份工作");
        	}
        	break;
        case 99:
        	GUARDER_D->do_look( who, me ); 
