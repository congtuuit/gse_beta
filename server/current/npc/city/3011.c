...
void do_welcome2( object me, string arg )
{
	...
	case 2:
			...
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_ZHAOGUO,7,"Chó đường phố" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Chó đường phố");
        	}
        	break;       
        case 3:
			...
			who->add_cash(5600);
			send_user(who,"%c%s",';',"Chó đường phố 经验 6500 tiềm năng 260 Ngân lượng 5600");
	...
	case 5:
			...
			send_user( who, "%c%c%c%w%s", 0x51, 2, 1,TID_ZHAOGUO,"Triệu Quốc" );
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_ZHAOGUO,45,"Điêu khắc" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Điêu khắc");
        	}
        	break;
        case 6:
			...
			who->add_cash(46800);
			send_user(who,"%c%s",';',"Điêu khắc 经验 48600 tiềm năng 688 Ngân lượng 46800 大夏龙雀图纸 1");
