...
void do_look( object who )
{
	...
	if ( ( who->get_level() >=49 && !who->get_legend(TASK_2_00,1) ) || ( who->get_legend(TASK_2_00,1) && !who->get_legend(TASK_2_00,2) ) || ( who->get_legend(TASK_2_00,2) && !who->get_legend(TASK_2_00,3) ) ) 
		tmp += sprintf(ESC HIY "Tiêu diệt lực lượng nổi loạn\ntalk %x# welcome.20\n",getoid(me)); 
...
void do_welcome2( object me, string arg )
{
	...
	case 2:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"大展神威（1）");
        	}
        	break;       
        case 3:
			...
			who->add_cash(6500);
			send_user(who,"%c%s",';',"大展神威（1） 经验 7500 tiềm năng 280 Ngân lượng 6500");
	...
	case 4:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"大展神威（2）");
        	}
        	break;
        case 5:
			...
			who->add_cash(6500);
			send_user(who,"%c%s",';',"大展神威（3） 经验 6800 tiềm năng 263 Ngân lượng 6500");
	...
	case 6:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"大展神威（4）");
        	}
        	break;       
        case 7:
			...
			who->add_cash(6800);
			send_user(who,"%c%s",';',"大展神威（4） 经验 7500 tiềm năng 290 Ngân lượng 6800 紫焰项链图纸 1");
	...
	case 8:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"大展神威（5）");
        	}
        	break;       
        case 9:
			...
			who->add_cash(8000);
			send_user(who,"%c%s",';',sprintf("大展神威（5） 经验 9000 tiềm năng 330 Ngân lượng 8000 %s 1",tmp->get_name()));
	...
	case 11:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"秦将辟谣");
        	}
        	break;      
	case 12:
	...
	case 13:
			...
			send_user( who, "%c%c%c%w%s", 0x51, 2, 1,TID_QINGUO,"Tần Quốc" );
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_QINGUO,63,"Đông cứng" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Đông cứng");
        	}
        	break; 
        case 14:
			...
			who->add_cash(94000);
			send_user(who,"%c%s",';',"Đông cứng 经验 91000 tiềm năng 980 Ngân lượng 94000");
        ...
        case 16:
			...
			who->add_cash(94000);
			send_user(who,"%c%s",';',"索取神剑1 经验 97000 tiềm năng 1200 Ngân lượng 94000");
        ...
        case 17:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"索取神剑2");
       		}
        	break;
        case 18:
        	if( who->get_legend(TASK_47,27)&&!who->get_legend(TASK_47,28) )
			...
			who->add_cash(92000);
			send_user(who,"%c%s",';',"索取神剑4 经验 93000 tiềm năng 1300 Ngân lượng 92000 药店连接器 1");
        ...
        case 19:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"索取神剑5");
       		}
        	break;
        case 20:
        ...
        case 21:
			...
			send_user( who, "%c%c%c%w%s", 0x51, 2, 1,TID_QINGUO,"Tần Quốc" );
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_QINGUO,101,"Tiêu diệt lực lượng nổi loạn" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Tiêu diệt lực lượng nổi loạn");
       		}
        	break;
        case 22:
			...
			who->add_cash(9600);
			send_user(who,"%c%s",';',"Tiêu diệt lực lượng nổi loạn 经验 6800 tiềm năng 400 Ngân lượng 9600");
