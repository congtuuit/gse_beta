...
void do_look( object who )
{
	...
	{
		tmp += sprintf(ESC HIY "Thu thập táo tàu\ntalk %x# welcome.1\n",getoid(me));
	}
...
void do_welcome2( object me, string arg )
{
	...
	case 2:
			...
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_YANGUO,45,"Thu thập táo tàu" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Thu thập táo tàu");
        	}
        	break;
        case 3:
			...
			who->add_cash(56000);
			send_user(who,"%c%s",';',"Thu thập táo tàu 经验 67000 tiềm năng 930 Ngân lượng 56000");
