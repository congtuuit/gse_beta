...
void do_welcome2( object me, string arg )
{
	...
	case 2:
			...
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_YANGUO,1,"Ngọn gió của..." );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Ngọn gió của...");
        	}
        	break;       
        case 3:
			...
			who->add_cash(4000);
			send_user(who,"%c%s",';',"Ngọn gió của... 经验 4500 tiềm năng 180 Ngân lượng 4000 荷包蛋图纸 1");
	...
	case 4:
			...
			send_user( who, "%c%c%c%w%s", 0x51, 2, 1,TID_YANGUO,"Yên Quốc" );
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_YANGUO,9,"Linh hồn của dòng sông" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Linh hồn của dòng sông");
        	}
        	break;       
        case 5:
			...
			who->add_cash(4500);
			send_user(who,"%c%s",';',"Linh hồn của dòng sông 经验 5300 tiềm năng 210 Ngân lượng 4500");
