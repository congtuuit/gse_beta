...
{ 
	...
	object me = this_object();
		...
		tmp += sprintf(ESC HIY "Kiểm soát số lượng\ntalk %x# welcome.5\n",getoid(this_object())); 
...
void do_welcome2( object me, string arg )
{
        ...
        case 2:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"兄弟情深");
        	}
        	break;
	case 3:
        ...
        case 4:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"找吕不韦谈谈");
        	}
        	break;
	case 5:
        ...
        case 6:
			...
			send_user( who, "%c%c%c%w%s", 0x51, 2, 1,TID_QINGUO,"Tần Quốc" );
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_QINGUO,55,"Kiểm soát số lượng" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Kiểm soát số lượng");
        	}
        	break;
	case 7:
			...
			who->add_cash(70000);
			send_user(who,"%c%s",';',"Kiểm soát số lượng 经验 80000 tiềm năng 960 Ngân lượng 70000");
