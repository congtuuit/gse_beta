...
void do_look( object who )
{
	...
	{
		tmp = sprintf(ESC HIY "Câu thần chú của Đường Cangwu\ntalk %x# welcome.1\n",getoid(me));
	}
...
void do_welcome2( object me, string arg )
{
	...
	case 2:
			...
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_CHUGUO,20,"Câu thần chú của Đường Cangwu" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Câu thần chú của Đường Cangwu");
        	}
        	break;
        case 3:
			...
			who->add_cash(2000);
			send_user(who,"%c%s",';',"Câu thần chú của Đường Cangwu 经验 2600 tiềm năng 90 Ngân lượng 2000 土制炸弹 5");
	...
	case 5:
			...
			who->add_cash(55000);
			send_user(who,"%c%s",';',"Giữ khoảng cách 经验 64000 tiềm năng 910 Ngân lượng 55000");
