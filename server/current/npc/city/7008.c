...
void do_welcome2( object me, string arg )
{
        ...
        case 2:
			...
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_YANGUO,16,"Ngàn năm" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Ngàn năm");
        	}
        	break;
        case 3:
			...
			who->add_cash(3600);
			send_user(who,"%c%s",';',"Ngàn năm 经验 4800 tiềm năng 150 Ngân lượng 3600");
        ...
        case 5:
			...
			send_user( who, "%c%c%c%w%s", 0x51, 2, 1,TID_YANGUO,"Yên Quốc" );
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_YANGUO,36,"Với sự trừng phạt" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Với sự trừng phạt");
        	}
        	break;
        case 6:
			...
			who->add_cash(5600);
			send_user(who,"%c%s",';',"Với sự trừng phạt 经验 6800 tiềm năng 260 Ngân lượng 5600");
