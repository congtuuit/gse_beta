...
void do_look( object who )
{
	...
	{
		tmp += sprintf(ESC HIY "Tìm kiếm con dấu chính thức\ntalk %x# welcome.1\n",id);
	}
...
void do_welcome2( object me, string arg )
{
	...
	case 2:
			...
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_QIGUO,16,"Tìm kiếm con dấu chính thức" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Tìm kiếm con dấu chính thức");
        	}
        	break;
        case 3:
			...
			who->add_cash(30000);
			send_user(who,"%c%s",';',"Tìm kiếm con dấu chính thức 经验 30000 tiềm năng 498 Ngân lượng 30000");
	...
	case 4:
        ...
        case 5:
			...
			who->add_cash(56000);
			send_user(who,"%c%s",';',"告知内政官 经验 71000 tiềm năng 810 Ngân lượng 56000");
	...
	case 6:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"通告百姓");
        	}
        	break;
        case 7:
        ...
        case 8:
			...
			send_user( who, "%c%c%c%w%s", 0x51, 2, 1,TID_QIGUO,"Tề Quốc" );
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_QIGUO,54,"Bệnh dịch" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Bệnh dịch");
        	}
        	break;
	case 9:
			...
			who->add_cash(73000);
			send_user(who,"%c%s",';',"Bệnh dịch 经验 84000 tiềm năng 1040 Ngân lượng 73000 六神丹图纸 1");
	...
	case 11:
			...
			who->add_cash(35000);
			send_user(who,"%c%s",';',"四面楚歌（1） 经验 36000 tiềm năng 600 Ngân lượng 35000");
        ...
        case 12:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"四面楚歌（2）");
        	}
        	break;
        case 99:	
		INTERIOR_D->do_look( who, me); 
