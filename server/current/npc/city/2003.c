...
void do_look( object who )
{
	...
	{
		tmp = sprintf(ESC HIY "Kho bạc bị đánh cắp\ntalk %x# welcome.1\n",getoid(me));
	}
...
void do_welcome2( object me, string arg )
{
        ...
        case 2:
			...
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_HANGUO,1,"Kho bạc bị đánh cắp" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Kho bạc bị đánh cắp");
        	}
        	break;
        case 3:
			...
			who->add_cash(1200);
			send_user(who,"%c%s",';',"Kho bạc bị đánh cắp 经验 1200 tiềm năng 70 Ngân lượng 1200 行军散 3");
        ...
        case 5:
			...
			who->add_cash(30000);
			send_user(who,"%c%s",';',"索取宝图 经验 31000 tiềm năng 480 Ngân lượng 30000");
        ...
        case 6:
			...
			send_user( who, "%c%c%c%w%s", 0x51, 2, 1,TID_HANGUO,"Hàn Quốc" );
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_HANGUO,17,"Xóa bỏ mối đe dọa" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Xóa bỏ mối đe dọa");
        	}
        	break;
        case 7:
			...
			who->add_cash(32000);
			send_user(who,"%c%s",';',"Xóa bỏ mối đe dọa 经验 30000 tiềm năng 490 Ngân lượng 32000");
        ...
        case 8:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"寻根问底");
        	}
        	break;
        case 99:	
