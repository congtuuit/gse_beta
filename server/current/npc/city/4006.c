...
void do_welcome2( object me, string arg )
{
        ...
        case 2:
			...
			who->add_cash(68000);
			send_user(who,"%c%s",';',"解除奇事 经验 78000 tiềm năng 1100 Ngân lượng 68000 六神丹 2");
	...
	case 4:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"探明原因");
        	}
        	break; 
        case 5:
        	if ( who->get_legend(TASK_35,23) && !who->get_legend(TASK_35,24) ) 
			...
			who->add_cash(70000);
			send_user(who,"%c%s",';',"通报情况 经验 80000 tiềm năng 1150 Ngân lượng 70000");
	...
	case 6:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"禀告魏王");
        	}
        	break;
        case 99:	
