...
void do_welcome2( object me, string arg )
{
        ...
        case 2:
			...
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_YANGUO,48,"Giết nó" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Giết nó");
        	}
        	break;
        case 3:
			...
			who->add_cash(53800);
			send_user(who,"%c%s",';',"Giết nó 经验 64000 tiềm năng 906 Ngân lượng 53800");
