...
void do_welcome2( object me, string arg )
{
	...
	case 1:
        ...
        case 2:
			...
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_CHUGUO,40,"Từ thực phẩm" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Từ thực phẩm");        		
        	}
        	break;
        case 3:
			...
			who->add_cash(60000);
			send_user(who,"%c%s",';',"Từ thực phẩm 经验 72000 tiềm năng 935 Ngân lượng 60000");
