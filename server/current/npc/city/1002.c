...
void do_look( object who )
{
	...
	{
		tmp += sprintf(ESC HIY "Không sợ\ntalk %x# welcome.13\n",id);
	}
	if ( who->get_legend(TASK_36,26) && !who->get_legend(TASK_36,28) )
	{
		tmp += sprintf(ESC HIY "Nổi loạn của Kỳ\ntalk %x# welcome.16\n",id);
	}
...
void do_welcome2( object me, string arg )
{
        ...
        case 2:
			...
			who->add_cash(3000);
			send_user(who,"%c%s",';',"Hình phạt cho gian lận 经验 3500 tiềm năng 112 Ngân lượng 3000 碧龙行装图纸 1");
        ...
        case 3:
			...
			send_user(who, "%c%c%w%s", ':', 3, me->get_char_picid(), sprintf("%s:\n    那群Ác ma trong lọ看来以后也不敢来我的军营捣乱了，这是我承诺过给你的奖励，本将军是语出必行的，拿好吧！\n"ESC"Hoàn thành任务\ntalk %x# welcome.5\n"ESC"Rời khỏi.", me->get_name(),getoid(me)));
        	break;
        case 4:
        	if ( who->get_level() >= 70 && !who->get_legend(TASK_24,4) )
        	{
			...
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_QIGUO,14,"Ác ma trong lọ" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Ác ma trong lọ");
        	}
        	break; 
        case 5:
			...
			who->add_cash(29000);
			send_user(who,"%c%s",';',"Ác ma trong lọ 经验 28000 tiềm năng 490 Ngân lượng 29000 幽魂项链图纸 1");
        ...
        case 7:
			...
			send_user( who, "%c%c%c%w%s", 0x51, 2, 1,TID_QIGUO,"Tề Quốc" );
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_QIGUO,17,"Chết tiệt" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Chết tiệt");
        	}
        	break; 
        case 8:
			...
			who->add_cash(33000);
			send_user(who,"%c%s",';',"Chết tiệt 经验 35000 tiềm năng 510 Ngân lượng 33000 狂龙鞋图纸 1");
        ...
        case 10:
			...
			who->add_cash(53000);
			send_user(who,"%c%s",';',"探访将军 经验 56000 tiềm năng 750 Ngân lượng 53000");
        ...
        case 11:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"将军信函");
        	}
        	break;
        case 12:
        	if ( who->get_legend(TASK_30,6) && !who->get_legend(TASK_30,7) )
			...
			who->add_cash(52000);
			send_user(who,"%c%s",';',"Mất và phục hồi 经验 63000 tiềm năng 800 Ngân lượng 52000 神秘果 5");
        ...
        case 14:
			...
			send_user( who, "%c%c%c%w%s", 0x51, 2, 1,TID_QIGUO,"Tề Quốc" );
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_QIGUO,53,"Không sợ" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Không sợ");
        	}
        	break;
	case 15:
			...
			who->add_cash(68000);
			send_user(who,"%c%s",';',"Không sợ 经验 80000 tiềm năng 955 Ngân lượng 68000");
	...
	case 17:
			...
			who->add_cash(73000);
			send_user(who,"%c%s",';',"Nổi loạn của Kỳ 经验 84000 tiềm năng 1048 Ngân lượng 73000 当铺链接器 1");
