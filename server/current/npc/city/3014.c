...
{ 
	...
	{
		tmp = sprintf(ESC HIY "Không ngừng\ntalk %x# welcome.1\n",getoid(me));
	}
...
void do_welcome2( object me, string arg )
{
	...
	case 2:
			...
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_ZHAOGUO,50,"Không ngừng" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Không ngừng");
        	}
        	break;
        case 3:
			...
			who->add_cash(48000);
			send_user(who,"%c%s",';',"Không ngừng 经验 50000 tiềm năng 700 Ngân lượng 48000 祝融火枪图纸 1");
