...
{ 
	...
	{
		tmp = sprintf(ESC HIY "Sâu trong đồng cỏ\ntalk %x# welcome.1\n",getoid(me));
	}
...
void do_welcome2( object me, string arg )
{
	...
	case 2:
			...
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_ZHAOGUO,46,"Sâu trong đồng cỏ" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Sâu trong đồng cỏ");
        	}
        	break;
        case 3:
			...
			who->add_cash(47000);
			send_user(who,"%c%s",';',"Sâu trong đồng cỏ 经验 49000 tiềm năng 690 Ngân lượng 47000 强效物防 1");
        ...
        case 5:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"心愿");
        	}
        	break; 
        case 99:
        	GUARDER_D->do_look_2( who, me ); 
