...
{ 
	...
	{
		tmp = sprintf(ESC HIY "Giấc mơ anh hùng\ntalk %x# welcome.1\n",getoid(me));
	}
...
void do_welcome2( object me, string arg )
{
        ...
        case 2:
			...
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_WEIGUO,21,"Giấc mơ anh hùng" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Giấc mơ anh hùng");
        	}
        	break;
        case 3:
			...
			who->add_cash(1200);
			send_user(who,"%c%s",';',"Giấc mơ anh hùng 经验 1500 tiềm năng 60 Ngân lượng 1200");
