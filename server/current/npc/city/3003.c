...
void do_look( object who )
{
	...
	{
		tmp = sprintf(ESC HIY "Thắt lưng buộc bụng\ntalk %x# welcome.1\n",getoid(me));
	}
...
void do_welcome2( object me, string arg )
{
	...
	case 2:
			...
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_ZHAOGUO,9,"Thắt lưng buộc bụng" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Thắt lưng buộc bụng");
        	}
        	break;       
        case 3:
			...
			who->add_cash(5800);
			send_user(who,"%c%s",';',"Thắt lưng buộc bụng 经验 6500 tiềm năng 265 Ngân lượng 5800");
