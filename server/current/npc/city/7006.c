...
void do_look( object who )
{
	...
	{
		tmp = sprintf(ESC HIY "Huyền thoại về gương\ntalk %x# welcome.1\n",getoid(me));
	}
...
void do_welcome2( object me, string arg )
{
	...
	case 2:
			...
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_YANGUO,14,"Huyền thoại về gương" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Huyền thoại về gương");
        	}
        	break;       
        case 3:
			...
			who->add_cash(5000);
			send_user(who,"%c%s",';',sprintf("Huyền thoại về gương 经验 5800 tiềm năng 210 Ngân lượng 5000 %s 1",tmp->get_name()));
	...
	case 5:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"浑仪（1）");
        	}
        	break;       
        case 6:
			...
			who->add_cash(2800);
			send_user(who,"%c%s",';',"浑仪（1） 经验 4000 tiềm năng 140 Ngân lượng 2800");
	...
	case 7:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"浑仪（2）");
        	}
        	break;       
        case 8:
			...
			who->add_potential(140);
			who->add_cash(2800);
			send_user(who,"%c%s",';',"浑仪（2） 经验 4000 tiềm năng 140 Ngân lượng 2800");
	...
	case 9:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"浑仪（3）");
        	}
        	break;    
        case 99:	
