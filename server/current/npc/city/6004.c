...
void do_welcome2( object me, string arg )
{
	...
	case 2:
			...
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_CHUGUO,13,"Quần áo bảo vệ" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Quần áo bảo vệ");
        	}
        	break;
        case 3:
			...
			who->add_cash(3000);
			send_user(who,"%c%s",';',"Quần áo bảo vệ 经验 3500 tiềm năng 70 Ngân lượng 3000");
	...
	case 5:
			...
			send_user( who, "%c%c%c%w%s", 0x51, 2, 1,TID_CHUGUO,"Sở Quốc" );
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_CHUGUO,25,"Bí mật của Châu Phi" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Bí mật của Châu Phi");
        	}
        	break;
        case 6:
			...
			who->add_cash(2100);
			send_user(who,"%c%s",';',"Bí mật của Châu Phi 经验 2600 tiềm năng 100 Ngân lượng 2100");
	...
	case 8:
			...
			who->add_cash(37000);
			send_user(who,"%c%s",';',"与楚联盟 经验 36000 tiềm năng 540 Ngân lượng 37000 丰盛的晚餐图纸 1");
