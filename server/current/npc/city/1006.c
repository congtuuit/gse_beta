...
void do_welcome2( object me, string arg )
{
        ...
        case 2:
			...
			who->add_cash(51000);
			send_user(who,"%c%s",';',"将军信函 经验 58000 tiềm năng 770 Ngân lượng 51000");
        ...
        case 3:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"民间探访");
        	}
        	break;
        case 4:
        	if ( who->get_level() >= 85 && !who->get_legend(TASK_30,8) )
        ...
        case 5:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"询查原因");
        	}
        	break;
        case 6:
        	if ( who->get_level() >= 85 && !who->get_legend(TASK_30,20) )
        ...
        case 7:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"深入民间");
        	}
        	break;
        case 8:
        	if ( who->get_legend(TASK_30,28) && !who->get_legend(TASK_30,29) )
			...
			who->add_cash(56000);
			send_user(who,"%c%s",';',"Tống khứ bọn cướp đi 经验 68000 tiềm năng 830 Ngân lượng 56000 斩侯鞋图纸 1");
        ...
        case 9:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"禀告齐王");
        	}
        	break;
        case 99:	
