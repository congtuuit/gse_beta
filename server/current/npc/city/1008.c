...
void do_look( object who )
{
	...
	{
		tmp += sprintf(ESC HIY "Khám phá khủng khiếp\ntalk %x# welcome.1\n",getoid(me));
	}
	if ( sizeof(tmp) )
...
void do_welcome2( object me, string arg )
{
        ...
        case 2:
			...
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_QIGUO,19,"Khám phá khủng khiếp" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Khám phá khủng khiếp");
        	}
        	break;
        case 3:
			...
			who->add_cash(35000);
			send_user(who,"%c%s",';',"Khám phá khủng khiếp 经验 37000 tiềm năng 528 Ngân lượng 35000 倾露鞋图纸 1");
