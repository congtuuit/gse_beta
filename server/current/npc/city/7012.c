...
{ 
	...
	{
		tmp = sprintf(ESC HIY "Sức mạnh của trụy lạc\ntalk %x# welcome.1\n",getoid(me));
	}
...
void do_welcome2( object me, string arg )
{
        ...
        case 2:
			...
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_YANGUO,46,"Sức mạnh của trụy lạc" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Sức mạnh của trụy lạc");
        	}
        	break;
        case 3:
			...
			who->add_cash(53800);
			send_user(who,"%c%s",';',"Sức mạnh của trụy lạc 经验 63000 tiềm năng 905 Ngân lượng 53800");
