...
void do_look( object who )
{
	...
	{
		tmp = sprintf(ESC HIY "Giải cứu công tượng\ntalk %x# welcome.1\n",getoid(me));
	}
...
void do_welcome2( object me, string arg )
{
        ...
        case 2:
			...
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_HANGUO,13,"Giải cứu công tượng" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Giải cứu công tượng");
        	}
        	break;
        case 3:
			...
			who->add_cash(1800);
			send_user(who,"%c%s",';',"Giải cứu công tượng 经验 2000 tiềm năng 80 Ngân lượng 1800 初级血气 1");
