...
{ 
	...
	{
		tmp = sprintf(ESC HIY "Vụ án đang chờ xử lý ở làng\ntalk %x# welcome.1\n",getoid(me));
	}
...
void do_welcome2( object me, string arg )
{
	...
	case 2:
			...
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_CHUGUO,24,"Vụ án đang chờ xử lý ở làng" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Vụ án đang chờ xử lý ở làng");
        	}
        	break;
        case 3:
			...
			who->add_cash(2000);
			send_user(who,"%c%s",';',"Vụ án đang chờ xử lý ở làng 经验 2600 tiềm năng 100 Ngân lượng 2000");
	...
	case 5:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"遗忘的佩剑");
        	}
        	break;
	case 99:
        	GUARDER_D->do_look( who, me ); 
