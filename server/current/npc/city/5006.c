...
void do_welcome2( object me, string arg )
{
        ...
        case 2:
			...
			who->add_cash(22000);
			send_user(who,"%c%s",';',"陈述冤情 经验 21000 tiềm năng 410 Ngân lượng 22000");
	...
	case 3:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"明辨是非");
        	}
        	break;
	case 4:
		if ( who->get_legend(TASK_22,19) && !who->get_legend(TASK_22,20) )
        ...
        case 5:
			...
			who->add_cash(24000);
			send_user(who,"%c%s",';',sprintf("Khó khăn khi viết 经验 25500 tiềm năng 430 Ngân lượng 24000 %s 1",tmp->get_name()));
        ...
        case 7:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"平阳之乱1");
       		}
        	break;
        case 8:
        	if( who->get_legend(TASK_46,24)&&!who->get_legend(TASK_46,25) )
			...
			who->add_cash(92000);
			send_user(who,"%c%s",';',"平阳之乱5 经验 94000 tiềm năng 950 Ngân lượng 92000 凤羽靴图纸 1");
        ...
        case 10:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"破除谣言1");
       		}
        	break;
        case 11:
        	if( who->get_legend(TASK_47,17)&&!who->get_legend(TASK_47,18) )
			...
			who->add_cash(95000);
			send_user(who,"%c%s",';',"破除谣言5 经验 96000 tiềm năng 1300 Ngân lượng 95000 天香续命丹 1");
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_QINGUO,83,"" );
        	}
        	break;
        case 12:
        	if ( who->get_level() >=115 && !who->get_legend(TASK_47,19) )
			send_user(who, "%c%c%w%s", ':', 3, me->get_char_picid(), sprintf("%s:\n    据说最近大将军整日Bận tâm，仿佛有很忧心的事情却无法办到，但是我等并非执掌军务，不便相问，你代我拜访一下，问他可有什么需要帮忙的。\n"ESC"Nhận nhiệm vụ\ntalk %x# welcome.13\n"ESC"Rời khỏi.", me->get_name(),getoid(me)));
        ...
        case 13:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"索取神剑1");
       		}
        	break;
        case 99:	
