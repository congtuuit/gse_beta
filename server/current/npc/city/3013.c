...
void do_welcome2( object me, string arg )
{
	...
	case 2:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"木箱的秘密（1）");
        	}
        	break;
        case 3:
			...
			who->add_cash(25000);
			send_user(who,"%c%s",';',"木箱的秘密（1） 经验 26000 tiềm năng 445 Ngân lượng 25000");
	...
	case 4:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"木箱的秘密（2）");
        	}
        	break;
        case 5:
        	if ( who->get_level() >= 80 && !who->get_legend(TASK_38,15) )
	...
	case 6:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"弟弟的问候");
        	}
        	break;
        case 99:
        	GUARDER_D->do_look_2( who, me ); 
