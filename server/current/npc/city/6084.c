...
{ 
	...
	if ( who->get_level() >= 95 && !who->get_legend(TASK_33,19) )
		tmp += sprintf(ESC HIY "Giữ khoảng cách\ntalk %x# welcome.16\n",id);
...
void do_welcome2( object me, string arg )
{
        ...
        case 2:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"亡羊补牢(1)");
        	}
        	break;
        case 3:
	...
	case 4:
			...
			send_user( who, "%c%c%c%w%s", 0x51, 2, 1,TID_CHUGUO,"Sở Quốc" );
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_CHUGUO,14,"Mảnh ghép thung lũng" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Mảnh ghép thung lũng");
        	}
        	break;
        case 5:
			...
			who->add_cash(1600);
			send_user(who,"%c%s",';',"Mảnh ghép thung lũng 经验 2300 tiềm năng 80 Ngân lượng 1600");
	...
	case 7:
			...
			send_user( who, "%c%c%c%w%s", 0x51, 2, 1,TID_CHUGUO,"Sở Quốc" );
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_CHUGUO,22,"Kho báu ở thung lũng" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Kho báu ở thung lũng");
        	}
        	break;
        case 8:
			...
			who->add_cash(1900);
			send_user(who,"%c%s",';',"Kho báu ở thung lũng 经验 2600 tiềm năng 100 Ngân lượng 1900");
        ...
        case 10:
			...
			who->add_cash(13000);
			send_user(who,"%c%s",';',"Trà Jasmine（1） 经验 14000 tiềm năng 238 Ngân lượng 13000");
        ...
        case 11:
			...
			send_user( who, "%c%c%c%w%s", 0x51, 2, 1,TID_CHUGUO,"Sở Quốc" );
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_CHUGUO,29,"Trà Jasmine（2）" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Trà Jasmine（2）");
        	}
        	break; 
        case 12:
        	if ( who->get_legend(TASK_24,10) && !who->get_legend(TASK_24,11) )
        	{
        		if (TASK_LEGEND_D->check_task_item(who,"Hoa nhài",20) != 1 )
        			return;
			TASK_LEGEND_D->task_finish(who);
			...
			who->add_cash(21000);
			send_user(who,"%c%s",';',"Trà Jasmine（2） 经验 22000 tiềm năng 300 Ngân lượng 21000");
        ...
        case 13:
			...
			send_user( who, "%c%c%c%w%s", 0x51, 2, 1,TID_CHUGUO,"Sở Quốc" );
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_CHUGUO,30,"Trà Jasmine（3）" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Trà Jasmine（3）");
        	}
        	break; 
        case 14:
			...
			who->add_potential(300);
			who->add_cash(21000);
			send_user(who,"%c%s",';',"Trà Jasmine（3） 经验 22000 tiềm năng 300 Ngân lượng 21000 幽魂项链图纸 1");
        ...
        case 15:
			...
			send_user( who, "%c%c%c%w%s", 0x51, 2, 1,TID_CHUGUO,"Sở Quốc" );
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_CHUGUO,31,"Trà Jasmine（4）" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Trà Jasmine（4）");
        	}
        	break;
	case 16:
		if ( who->get_level() >= 95 && !who->get_legend(TASK_33,19) )
        ...
        case 17:
			...
			send_user( who, "%c%c%c%w%s", 0x51, 2, 1,TID_CHUGUO,"Sở Quốc" );
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_CHUGUO,39,"Giữ khoảng cách" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Giữ khoảng cách");        		
        	}
        	break;
