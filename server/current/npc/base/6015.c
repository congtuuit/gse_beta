...
//        tmp += sprintf(ESC"换取食物\ntalk %x# exchange\n",id);
		...
		tmp += sprintf(ESC HIY "Tiếng kêu dưới chân núi\ntalk %x# welcome.6\n",getoid(this_object())); 
...
void do_welcome2( object me, string arg )
{
        ...
        case 2:
			...
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_CHUGUO,11,"Ba lông" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Ba lông");
        	}
        	break;
        case 3:
			...
			who->add_cash(1500);
			send_user(who,"%c%s",';',"Ba lông 经验 1800 tiềm năng 30 Ngân lượng 1500");
        ...
        case 5:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"唤醒记忆");
        	}
        	break;
        case 6:
	...
	case 7:
			...
			send_user( who, "%c%c%c%w%s", 0x51, 2, 1,TID_CHUGUO,"Sở Quốc" );
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_CHUGUO,23,"Tiếng kêu dưới chân núi" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Tiếng kêu dưới chân núi");
        	}
        	break;
        case 8:
			...
			who->add_cash(2000);
			send_user(who,"%c%s",';',sprintf("Tiếng kêu dưới chân núi 经验 2700 tiềm năng 100 Ngân lượng 2000 %s 1",tmp->get_name()));
