...
void do_welcome2( object me, string arg )
{
	...
	case 2:
			...
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_YANGUO,6,"Giai thoại trong giấc mơ" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Giai thoại trong giấc mơ");
        	}
        	break;       
        case 3:
			...
			who->add_cash(4500);
			send_user(who,"%c%s",';',"Giai thoại trong giấc mơ 经验 5000 tiềm năng 180 Ngân lượng 4500 唤云鞋图纸 1");
	...
	case 4:
			...
			send_user( who, "%c%c%c%w%s", 0x51, 2, 1,TID_YANGUO,"Yên Quốc" );
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_YANGUO,15,"Người lính vô song" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Người lính vô song");
        	}
        	break;       
        case 5:
			...
			who->add_cash(4600);
			send_user(who,"%c%s",';',"Người lính vô song 经验 5700 tiềm năng 210 Ngân lượng 4600 战天甲图纸 1");
