...
void do_welcome2( object me, string arg )
{
	...
	case 2:
		if ( who->get_level() >= 55 && !who->get_legend(TASK_2_00,28) )
		{
			...
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_QINGUO,102,"Phá hoại" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Phá hoại");
		}
		break;        	
	case 3:
		if ( who->get_legend(TASK_2_00,29) && !who->get_legend(TASK_2_00,30) )
		{
			...
			who->add_cash(19600);
			send_user(who,"%c%s",';',"Phá hoại 经验 9800 tiềm năng 400 Ngân lượng 19600");
