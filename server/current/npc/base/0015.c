...
void do_welcome2( object me, string arg )
{
	...
	case 5:
		if ( who->get_legend(TASK_NEWBIE_02, 19) && !who->get_legend(TASK_NEWBIE_02, 20) )
		{
			...
			send_user(who,"%c%s",';',"Nguyên liệu thô để làm rượu 经验 220 tiềm năng 10");
        ...
        case 7:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"食物的来源");
        	}
        	break;
        case 8:
		if( !who->get_legend(TASK_49, 18) )
        		...
        		send_user(who,"%c%s",':',sprintf("%s\n    多谢你帮我教训了它们，希望它们以后不要去我的作坊里面捣乱了，这里有几瓶我店里的Rượu gạo，你拿去尝尝吧，小心不要喝太多。\n"ESC"Hoàn thành任务\ntalk %x# welcome.10\n"ESC"Rời khỏi.",me->get_name(),getoid(me)));
        	break;
	case 9:
		if( !who->get_legend(TASK_49, 18) )
		{
	...
	case 10:
		if ( who->get_legend(TASK_49, 19) && !who->get_legend(TASK_49, 20) )
		{
			...
			send_user(who,"%c%s",';',"Một con thỏ nhỏ 经验 150 tiềm năng 20 Ngân lượng 500 Rượu gạo 5");
