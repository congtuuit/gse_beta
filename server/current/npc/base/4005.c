...
void do_look( object who )
{
	...
	{
		result += sprintf(ESC HIY "Giấc mơ thợ may\ntalk %x# welcome.1\n",getoid(me));
	}
...
void do_welcome2( object me, string arg )
{
        ...
        case 2:
			...
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_WEIGUO,15,"Giấc mơ thợ may" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Giấc mơ thợ may");
        	}
        	break;
        case 3:
			...
			who->add_cash(1500);
			send_user(who,"%c%s",';',"Giấc mơ thợ may 经验 1100 tiềm năng 70 Ngân lượng 1500");
