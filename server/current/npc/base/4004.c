...
void do_look( object who )
{
	...
	{
		result = result + sprintf( ESC HIY "Đường mòn\ntalk %x# welcome.1\n", getoid(me) );
	}
...
void do_welcome2( object me, string arg )
{
        ...
        case 2:
			...
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_WEIGUO,11,"Đường mòn" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Đường mòn");
        	}
        	break;
        case 3:
			...
			who->add_cash(1200);
			send_user(who,"%c%s",';',"Đường mòn 经验 1000 tiềm năng 70 Ngân lượng 1200");
