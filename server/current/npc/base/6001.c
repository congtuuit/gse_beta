...
void do_welcome2( object me, string arg )
{
	...
	case 2:
			...
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_CHUGUO,18,"Hào Quang Kim Long" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Hào Quang Kim Long");
        	}
        	break;
        case 3:
			...
			who->add_cash(1700);
			send_user(who,"%c%s",';',"Hào Quang Kim Long 经验 2500 tiềm năng 80 Ngân lượng 1700");
	...
	case 5:
			...
			send_user( who, "%c%c%c%w%s", 0x51, 2, 1,TID_CHUGUO,"Sở Quốc" );
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_CHUGUO,27,"Những gì còn lại" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Những gì còn lại");
        	}
        	break;
        case 6:
			...
			who->add_cash(2000);
			send_user(who,"%c%s",';',"Những gì còn lại 经验 2700 tiềm năng 110 Ngân lượng 2000 初级物攻 1");
