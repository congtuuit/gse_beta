...
{ 
	...
	object me = this_object();
		...
		tmp += sprintf(ESC HIY "Món quà phù hợp\ntalk %x# welcome.1\n",getoid(this_object())); 
...
void do_welcome2( object me, string arg )
{
        ...
        case 2:
			...
			who->add_cash(3600);
			send_user(who,"%c%s",';',"赵姬 经验 3880 tiềm năng 175 Ngân lượng 3600");
        ...
        case 3:
			...
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_ZHAOGUO,37,"Món quà phù hợp" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Món quà phù hợp");
        	}
        	break;
        case 4:
			...
			who->add_cash(3700);
			send_user(who,"%c%s",';',"Món quà phù hợp 经验 4000 tiềm năng 188 Ngân lượng 3700");
        ...
        case 5:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"宝剑");
        	}
        	break;
        }
}