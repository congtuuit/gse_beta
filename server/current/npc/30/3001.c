...
void do_welcome2( object me, string arg )
{
        ...
        case 2:
			...
			who->add_cash(3600);
			send_user(who,"%c%s",';',"找吕不韦谈谈 经验 3800 tiềm năng 170 Ngân lượng 3600");
        ...
        case 3:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"赵姬");
        	}
        	break;
        case 4:
        	if( who->get_legend(TASK_19,29)&&!who->get_legend(TASK_19,30) )
			...
			who->add_cash(3600);
			send_user(who,"%c%s",';',"宝剑 经验 3800 tiềm năng 177 Ngân lượng 3600 紫焰项链图纸 1");
        ...
        case 5:
			...
			send_user( who, "%c%c%c%w%s", 0x51, 2, 1,TID_ZHAOGUO,"赵国" );
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_ZHAOGUO,39,"Duyệt" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Duyệt");
        	}
        	break;
        case 6:
			...
			who->add_cash(18000);
			send_user(who,"%c%s",';',"Duyệt 经验 12000 tiềm năng 730 Ngân lượng 18000");
