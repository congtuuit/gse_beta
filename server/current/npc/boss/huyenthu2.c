...
void create()
{
	...
	log_file("boss.txt", short_time() + " Huyễn Thú 2 xuất hiện\n");
}
		...
		if (gone_time(saytime) >= 60)
		{
			...
			if (random(2))
			{
				...
				case 2:
					...
					break;
				default:
					SAY_CMD->say(me, "Ta là Huyễn Thú bất bại!!");
					break;
				}
			}
		}
...
void win_bonus_callout(object me, object who)
{
	...
	CHAT_D->rumor_channel(0, CHAT + "Nghe nói Huyễn Thú hung hãn đã bị hiệp sĩ dũng cảm tiêu diệt");
	log_file("boss.txt", short_time() + " Huyễn Thú bị tiêu diệt\n");
