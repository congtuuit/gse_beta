...
//		ESC"35000 Sử dụng Vô Song Điểm Phiếu đổi Túi Tử Kim cấp 55 8 sao\ntalk %x# bonus.1\n"
		ESC"20 Sử dụng Vô Song Điểm Phiếu đổi Chiến Quốc Lệnh\ntalk %x# bonus.1\n"
		ESC"20 Sử dụng Vô Song Điểm Phiếu đổi Phục Sinh Đơn\ntalk %x# bonus.2\n"
		ESC"800 Sử dụng Vô Song Điểm Phiếu đổi Túi Tử Kim cấp 55\ntalk %x# bonus.3\n"
//		ESC"16000 Sử dụng Vô Song Điểm Phiếu đổi Túi Bá Vương cấp 115\ntalk %x# bonus.20\n"
	...
	object who,item;
		...
		case 2:
			send_user(who,"%c%s",':',sprintf( get_name() + ":\n    Hoan nghênh! Vô Song Thành là thiên hạ đệ nhất đại thành với những bảo vật quý hiếm trên nhân gian, chỉ cần ngươi giao cho ta Vô Song Điểm Phiếu thì sẽ được tưởng thưởng hậu hĩ!\n"
				...
				ESC"100 Sử dụng Vô Song Điểm Phiếu đổi x5 Chén Bạc\ntalk %x# bonus.10\n"
				ESC"Thoát\n",id,id));
			break;
        }	
}
        ...
        switch(flag)
        {
       	case 1:
			...
			case 2:
				...
				break;
			case 3:
				send_user(who,"%c%s",':',sprintf( "Bạn muốn dùng 800 Vô Song Điểm Phiếu đổi Túi Tử Kim không?\n"
					ESC"xác định\ntalk %x# bonus.13\n"
					ESC"bỏ",getoid(me)));
				break;
			case 4:
			...
			case 7:
       		...
       		case 9:
				...
				break;
			case 10:
				send_user(who,"%c%s",':',sprintf( "Bạn muốn dùng 100 Vô Song Điểm Phiếu đổi x5 Chén Bạc không?\n"
				ESC"xác định\ntalk %x# bonus.20\n"
				ESC"bỏ",getoid(me)));
				break;
       	case 11:
