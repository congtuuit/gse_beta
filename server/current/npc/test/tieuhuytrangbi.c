...
void create()
{
	...
	set_2("good", ([
		"01":"/item/test/chenbacvip",
			"02" : "/item/test/tuitukim85",
			"03" : "/item/sell/3032",
			"04" : "/item/sell/0032",
			"05" : "/item/sell/1032",
			"06" : "/item/sell/2032",
			"07" : "/item/91/9167",
			"08" : "/item/test2/KyNangNgheNghiep",
			"09" : "/item/test2/bbbzzz/QuyMoBangPhai",
			"10" : "/item/test2/bbbzzz/HuanLuyenBangPhai",
			"11" : "/item/std/0095",
			"12" : "/item/test/vosongdiemphieu",
			"13" : "/item/test2/bbbzzz/DuTruBangPhai100",
			"14" : "/item/test2/bbbzzz/CongHienBangPhai",
			"15" : "/item/test2/bbbzzz/KyNangBangDuongMon",
			"16" : "/item/test2/bbbzzz/KyNangBangNgoaiCong",
			"17" : "/item/test2/bbbzzz/KyNangBangNoiCong",
			"18" : "/item/test2/bbbzzz/NghienCuuBangPhai",
			//"19" : "/item/test2/bbbzzz/TuiDuTruBangPhai",	
			"19" : "/item/SpItem/doanThach7",
			"20" : "/item/test/tuihoangkimtanthucap60",
			"21" : "/item/ride/thanthu2/tuithanthuVIP",
			"22" : "/npc/event/PhoBan/item/manhngoc",
			"23" : "/item/08/0016",
			"24" : "/item/test/tuihoangkimtanthucap80",


			// "01" : "/item/test/chenbacvip",
			// "02" : "/item/test/tuitukim85",
			// "03" : "/item/common/dacuonghoa",
			// "04" : "/item/91/9167",
			// "05" : "/item/test2/KyNangNgheNghiep",
			// "06" : "/item/test2/bbbzzz/QuyMoBangPhai",
			// "07" : "/item/test2/bbbzzz/HuanLuyenBangPhai",
			// "08" : "/item/std/0095",
			// "09" : "/item/test/vosongdiemphieu",
			// "10" : "/item/test2/bbbzzz/DuTruBangPhai100",
			// "11" : "/item/test2/bbbzzz/CongHienBangPhai",
			// "12" : "/item/test2/bbbzzz/KyNangBangDuongMon",
			// "13" : "/item/test2/bbbzzz/KyNangBangNgoaiCong",
			// "14" : "/item/test2/bbbzzz/KyNangBangNoiCong",
			// "15" : "/item/test2/bbbzzz/NghienCuuBangPhai",
			// //"19" : "/item/test2/bbbzzz/TuiDuTruBangPhai",	
			// "16" : "/item/SpItem/ve/ve5sao",
			// "17" : "/item/SpItem/ve/ve7sao",
			// "18" : "/item/test/tuihoangkimtanthucap60",
			// 	"19" : "/item/test/tuihoangkimtanthucap80",
			// 	"20" : "/item/common/box/ruongdong/1",
			// 	"21" : "/item/common/box/trangbi/1",
			// 	"22" : "/item/common/box/tukim/1",
			// 	"23" : "/item/event/tuinganluong",
			// 	"24" : "/item/spitem/vehoangkim",
	]));
	set_2("talk", ([
		"welcome":(: do_welcome:),
			"accept" : (: do_accept:),
...
void do_welcome2(object npc, string arg)
{
	...
	case 100:
		...
		tell_user(player, ECHO"Bạn nhận được 1.000.0000 lượng");
		break;
	}
}
void do_look(object player)
{
	...
	send_user(player, "%c%c%w%s", ':', 3, npc->get_char_picid(), sprintf("%s :\n" + "Alt + G đưa cho ta trang bị và ta sẽ định giá bán cho ngươi\n"
