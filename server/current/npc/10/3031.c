...
void do_welcome2( object me, string arg )
{
        ...
        case 2:
			...
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_YANGUO,19,"Viên đá" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Viên đá");
        	}
        	break;
        ...
        case 3:
			...
			who->add_cash(4000);
			send_user(who,"%c%s",';',"Viên đá 经验 5000 tiềm năng 160 Ngân lượng 4000");
