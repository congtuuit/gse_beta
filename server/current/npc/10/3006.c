...
void do_look( object who )
{
	...
	id = getoid(this_object());
		...
		tmp += sprintf(ESC HIY "Loại bỏ tên dối trá\ntalk %x# welcome.1\n",id); 
...
void do_welcome2( object me, string arg )
{
        ...
        case 2:
			...
			who->add_cash(63000);
			send_user(who,"%c%s",';',"了解情况 经验 73000 tiềm năng 900 Ngân lượng 63000");
	...
	case 3:
			...
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_WEIGUO,43,"Chứng minh bản thân" );
        ...
        case 4:
			...
			who->add_cash(62000);
			send_user(who,"%c%s",';',"Chứng minh bản thân 经验 72000 tiềm năng 880 Ngân lượng 62000");
	...
	case 5:
			...
			send_user( who, "%c%c%c%w%s", 0x51, 2, 1,TID_WEIGUO,"魏国" );
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_WEIGUO,44,"Loại bỏ tên dối trá" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Loại bỏ tên dối trá");
        	}
        	break;  
        case 6:
			...
			who->add_potential(900);
			who->add_cash(61000);
			send_user(who,"%c%s",';',"Loại bỏ tên dối trá 经验 72000 tiềm năng 900 Ngân lượng 61000");
	...
	case 7:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"官府备案");
        	}
        	break; 
        case 8:
        	if ( who->get_legend(TASK_35,15) && !who->get_legend(TASK_35,16) )
        ...
        case 9:
			...
			who->add_cash(69000);
			send_user(who,"%c%s",';',"探明原因 经验 80000 tiềm năng 1200 Ngân lượng 69000");
	...
	case 10:
			...
			send_user( who, "%c%c%c%w%s", 0x51, 2, 1,TID_WEIGUO,"魏国" );
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_WEIGUO,58,"Dũng cảm đột nhập vào hang động" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Dũng cảm đột nhập vào hang động");
        	}
        	break; 
        case 11:
			...
			who->add_potential(1200);
			who->add_cash(69000);
			send_user(who,"%c%s",';',"Dũng cảm đột nhập vào hang động 经验 81000 tiềm năng 1200 Ngân lượng 69000");
	...
	case 12:
			...
			send_user( who, "%c%c%c%w%s", 0x51, 2, 1,TID_WEIGUO,"魏国" );
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_WEIGUO,59,"Giải quyết nguồn gốc của thảm họa" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Giải quyết nguồn gốc của thảm họa");
        	}
        	break; 
        case 13:
			...
			who->add_cash(70000);
			send_user(who,"%c%s",';',"Giải quyết nguồn gốc của thảm họa 经验 79000 tiềm năng 1100 Ngân lượng 70000");
	...
	case 14:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"通报情况");
        	}
        	break; 
        }
}