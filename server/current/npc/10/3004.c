...
void do_welcome2( object me, string arg )
{
	...
	case 1:
        ...
        case 2:
			...
			who->add_cash(88000);
			send_user(who,"%c%s",';',"破除谣言2 经验 91000 tiềm năng 1200 Ngân lượng 88000");
        ...
        case 3:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"破除谣言3");
       		}
        	break;
        case 4:
			...
			who->add_cash(86000);
			send_user(who,"%c%s",';',"破除谣言3 经验 93000 tiềm năng 1350 Ngân lượng 86000");
        ...
        case 5:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"破除谣言4");
       		}
        	break;
        }
}