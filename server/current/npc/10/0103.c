...
void do_welcome2( object me, string arg )
{
        ...
        case 2:
			...
			who->add_cash(40000);
			send_user(who,"%c%s",';',"Tiểu Đồ（2） 经验 36000 tiềm năng 600 Ngân lượng 40000");
	...
	case 3:
			...
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_DONGHAIDAO,1,"Tiểu Đồ（3）" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Tiểu Đồ（3）");
        	}
        	break;
        case 4:
			...
			who->add_cash(44000);
			send_user(who,"%c%s",';',"Tiểu Đồ（3） 经验 45000 tiềm năng 655 Ngân lượng 44000");
	...
	case 5:
			...
			send_user( who, "%c%c%c%w%s", 0x51, 2, 1,TID_DONGHAIDAO,"东海岛" );
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_DONGHAIDAO,2,"Tiểu Đồ（4）" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Tiểu Đồ（4）");
        	}
        	break;
        case 6:
			...
			who->add_cash(210000);
			send_user(who,"%c%s",';',sprintf("Tiểu Đồ（4） 经验 210000 tiềm năng 2300 Ngân lượng 210000 %s 1",tmp->get_name()));
