...
void do_look( object who )
{
	...
	object me = this_object();
		...
		tmp += sprintf(ESC HIY "Bài kiểm tra cuối cùng\ntalk %x# welcome.1\n",getoid(me)); 
...
void do_welcome2( object me, string arg )
{
	...
	case 2:
			...
			who->add_cash(38000);
			send_user(who,"%c%s",';',"指明方向 经验 37000 tiềm năng 550 Ngân lượng 38000");
	...
	case 3:
			...
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_HANGUO,30,"Bài kiểm tra cuối cùng" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Bài kiểm tra cuối cùng");
        	}
        	break;
	case 4:
			...
			who->add_potential(550);
			who->add_cash(37000);
			send_user(who,"%c%s",';',"Bài kiểm tra cuối cùng 经验 38000 tiềm năng 550 Ngân lượng 37000 Rượu Dukang图纸 1");
