...
void do_look( object who )
{
	...
	if ( who->get_legend(TASK_36,8) && !who->get_legend(TASK_36,9) )
		...
		tmp += sprintf(ESC HIY "Tống khứ bọn cướp đi\ntalk %x# welcome.11\n",getoid(this_object())); 
...
void do_welcome2( object me, string arg )
{
	...
	case 2:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"大葫芦（1）");
        	}
        	break;       
        case 3:
        	if ( who->get_legend(TASK_19,5) && !who->get_legend(TASK_19,6) )
			...
			who->add_cash(3560);
			send_user(who,"%c%s",';',"大葫芦（3） 经验 3830 tiềm năng 165 Ngân lượng 3560");
	...
	case 4:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"大葫芦（4）");
        	}
        	break;  
        case 5:
			...
			who->add_cash(3700);
			send_user(who,"%c%s",';',"大葫芦（4） 经验 6000 tiềm năng 190 Ngân lượng 3700 紫焰项链图纸 1");
	...
	case 6:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"大葫芦（5）");
        	}
        	break;  
        case 7:
			...
			who->add_cash(15000);
			send_user(who,"%c%s",';',sprintf("大葫芦（5） 经验 10000 tiềm năng 680 Ngân lượng 15000 %s 1",tmp->get_name()));
	...
	case 9:
			...
			who->add_cash(37000);
			send_user(who,"%c%s",';',"完美宝石（3） 经验 39000 tiềm năng 650 Ngân lượng 37000");
	...
	case 10:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"完美宝石（4）");
        	}
        	break;
        case 11:
        	if ( who->get_legend(TASK_46,13)&&!who->get_legend(TASK_46,14) ) 
			...
			send_user(who, "%c%c%w%s", ':', 3, me->get_char_picid(), sprintf("%s:\n    最近平阳附近盘踞了一个恶匪展五，端是个九尺大汉，善使一对黄金锏，生的一声好武力，他纠集了一帮子匪类，窝在诛仙阵二层中部，时时出来我们镇Cướp nhà，欺凌妇孺，稍有反抗动辄行凶伤人，周围无人制得他，曾有人想上告竟然不知为何被他得知，被他活生生劈为两段，死状惨不忍睹，自此人人都噤若寒蝉。要不是看你一身正气，又有一身好武艺，老夫为了老骨头和妻儿性命，也断断不敢告诉你的，你前往那里杀掉展五，他手下小喽啰自然会一哄而散，但且记住，未杀掉之前万万不可来再见老夫，否则老夫恐怕惹来杀生之祸。你杀掉之后先去通知程强，他的弟弟就是被展五给杀害的。\n"ESC"接受任务\ntalk %x# welcome.15\n"ESC"Rời khỏi.", me->get_name(),getoid(me)));
        ...
        case 12:
			...
			who->add_cash(91000);
			send_user(who,"%c%s",';',"平阳之乱1 经验 89000 tiềm năng 950 Ngân lượng 91000");
        ...
        case 13:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"平阳之乱2");
       		}
        	break;
        case 14:
			...
			who->add_cash(93000);
			send_user(who,"%c%s",';',"平阳之乱2 经验 88000 tiềm năng 910 Ngân lượng 93000");
        ...
        case 15:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"平阳之乱3");
       		}
        	break;
        case 16:
        	if ( who->get_legend(TASK_46,26)&&!who->get_legend(TASK_46,27) ) 
			...
			send_user(who, "%c%c%w%s", ':', 3, me->get_char_picid(), sprintf("%s:\n    呵呵，秦管家果然找了个利索的人啊，年轻人，以后跟着我做，保你Đi vênh vang无往不利！\n"ESC"Hoàn thành任务\ntalk %x# welcome.19\n"ESC"Rời khỏi.", me->get_name(),getoid(me)));
        ...
        case 17:
			...
			who->add_cash(91000);
			send_user(who,"%c%s",';',"炼药之路1 经验 98000 tiềm năng 1010 Ngân lượng 91000");
        ...
        case 18:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"炼药之路2");
       		}
        	break;
        case 19:
			...
			who->add_cash(92000);
			send_user(who,"%c%s",';',"炼药之路2 经验 89000 tiềm năng 990 Ngân lượng 92000");
        ...
        case 20:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"炼药之路3");
       		}
        	break;
        case 21:
        	if( who->get_legend(TASK_47,4)&&!who->get_legend(TASK_47,5) )
			...
			who->add_potential(910);
			who->add_cash(93000);
			send_user(who,"%c%s",';',"炼药之路4 经验 88000 tiềm năng 910 Ngân lượng 93000 破云行装图纸 1");
        ...
        case 22:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"炼药之路5");
       		}
        	break;
        }
}