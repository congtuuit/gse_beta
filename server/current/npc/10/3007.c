...
void do_welcome2( object me, string arg )
{
        ...
        case 2:
			...
			who->add_cash(56000);
			send_user(who,"%c%s",';',"询问小贩 经验 70000 tiềm năng 840 Ngân lượng 56000");
	...
	case 3:
			...
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_QIGUO,46,"Nghi ngờ" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Nghi ngờ");
        	}
        	break;  
        case 4:
			...
			who->add_cash(55000);
			send_user(who,"%c%s",';',"Nghi ngờ 经验 69000 tiềm năng 830 Ngân lượng 55000");
	...
	case 5:
			...
			send_user( who, "%c%c%c%w%s", 0x51, 2, 1,TID_QIGUO,"齐国" );
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_QIGUO,47,"Thoát khỏi kẻ bắt nạt" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Thoát khỏi kẻ bắt nạt");
        	}
        	break;  
        case 6:
			...
			who->add_cash(57000);
			send_user(who,"%c%s",';',"Thoát khỏi kẻ bắt nạt 经验 70000 tiềm năng 820 Ngân lượng 57000");
	...
	case 7:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"告知内政官");
        	}
        	break;
        case 8:
        	if ( who->get_level() >= 85 && who->get_legend(TASK_38,15) && !who->get_legend(TASK_38,16) ) 
        ...
        case 9:
			...
			who->add_cash(22000);
			send_user(who,"%c%s",';',"弟弟的问候 经验 30000 tiềm năng 400 Ngân lượng 22000");
