...
void do_welcome2( object me, string arg )
{
        ...
        case 2:
			...
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_QIGUO,11,"Bị mất đồ" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Bị mất đồ");
        	}
        	break;
       case 3:
			...
			who->add_cash(3000);
			send_user(who,"%c%s",';',"Bị mất đồ 经验 4000 tiềm năng 115 Ngân lượng 3000");
