...
void do_welcome2( object me, string arg )
{
        ...
        case 2:
			...
			who->add_cash(2800);
			send_user(who,"%c%s",';',"唤醒记忆 经验 4000 tiềm năng 50 Ngân lượng 2800 鹤顶红图纸 1");
        	...
        	if ( who->get_level() >= 20 && who->get_legend(TASK_37,19) && !who->get_legend(TASK_37,20) ) 
		{
			...
			who->add_cash(1200);
			send_user(who,"%c%s",';',"崔大官人的请柬 经验 1200 tiềm năng 60 Ngân lượng 1200");
        	...
        	if ( who->get_level() >= 95 && who->get_legend(TASK_38,19) && !who->get_legend(TASK_38,20) ) 
		{
			...
			who->add_cash(30000);
			send_user(who,"%c%s",';',"遗忘的佩剑 经验 35000 tiềm năng 600 Ngân lượng 30000");
