...
void do_welcome2( object me, string arg )
{
	...
	case 2:
			...
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_YANGUO,8,"Thần sông" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Thần sông");
        	}
        	break;       
        case 3:
			...
			who->add_cash(4700);
			send_user(who,"%c%s",';',"Thần sông 经验 5100 tiềm năng 200 Ngân lượng 4700 鲤鱼靴图纸 1");
	...
	case 4:
			...
			send_user( who, "%c%c%c%w%s", 0x51, 2, 1,TID_YANGUO,"燕国" );
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_YANGUO,10,"Các ý kiến ​​khác nhau" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Các ý kiến ​​khác nhau");
        	}
        	break;       
        case 5:
			...
			who->add_potential(200);
			who->add_cash(4800);
			send_user(who,"%c%s",';',"Các ý kiến ​​khác nhau 经验 5500 tiềm năng 200 Ngân lượng 4800 宣明鞋图纸 1");
	...
	case 9:
			...
			send_user( who, "%c%c%c%w%s", 0x51, 2, 1,TID_YANGUO,"燕国" );
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_YANGUO,28,"Đàn nhị" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Đàn nhị");
        	}
        	break;       
        case 10:
        	if ( who->get_legend(TASK_14,16) && !who->get_legend(TASK_14,17) )
        	{
        		if (TASK_LEGEND_D->check_task_item(who,"Đàn nhị",1) != 1 )
        			return;
			TASK_LEGEND_D->task_finish(who);
			...
			who->add_cash(4800);
			send_user(who,"%c%s",';',"Đàn nhị 经验 6000 tiềm năng 240 Ngân lượng 4800");
