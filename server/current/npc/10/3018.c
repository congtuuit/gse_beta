...
void do_welcome2( object me, string arg )
{
	...
	case 2:
			...
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_CHUGUO,19,"Lạc lối" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Lạc lối");
        	}
        	break;
        case 3:
			...
			who->add_cash(1900);
			send_user(who,"%c%s",';',"Lạc lối 经验 2500 tiềm năng 80 Ngân lượng 1900 地瓜解暑汤图纸 1");
