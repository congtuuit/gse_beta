...
void do_welcome2( object me, string arg )
{
        ...
        case 2:
			...
			who->add_cash(51000);
			send_user(who,"%c%s",';',"明辨是非 经验 65000 tiềm năng 780 Ngân lượng 51000");
        ...
        case 3:
			...
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_QIGUO,37,"Xác định đối thủ" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Xác định đối thủ");
        	}
        	break; 
        case 4:
			...
			who->add_cash(53000);
			send_user(who,"%c%s",';',"Xác định đối thủ 经验 67000 tiềm năng 790 Ngân lượng 53000");
        ...
        case 5:
			...
			send_user( who, "%c%c%c%w%s", 0x51, 2, 1,TID_QIGUO,"齐国" );
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_QIGUO,38,"Diệt trừ cái ác" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Diệt trừ cái ác");
        	}
        	break; 
        case 6:
			...
			who->add_potential(790);
			who->add_cash(52000);
			send_user(who,"%c%s",';',"Diệt trừ cái ác 经验 66000 tiềm năng 790 Ngân lượng 52000 荧光鞋图纸 1");
        ...
        case 7:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"驯服恶霸");
        	}
        	break; 
        }
}