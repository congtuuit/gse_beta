...
void do_look( object who )
{
	string tmp="";
		...
		tmp += sprintf(ESC HIY "Thiên thanh niên trên hồ\ntalk %x# welcome.1\n",getoid(this_object())); 
...
void do_welcome2( object me, string arg )
{
	...
	case 2:
			...
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_CHUGUO,17,"Thiên thanh niên trên hồ" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Thiên thanh niên trên hồ");
        	}
        	break;
        case 3:
			...
			who->add_cash(1800);
			send_user(who,"%c%s",';',"Thiên thanh niên trên hồ 经验 2500 tiềm năng 90 Ngân lượng 1800 玉容膏图纸 1");
