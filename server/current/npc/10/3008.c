...
void do_welcome2( object me, string arg )
{
       ...
       case 2:
			...
			who->add_cash(3500);
			send_user(who,"%c%s",';',"情锁秦宫（2） 经验 4200 tiềm năng 130 Ngân lượng 3500");
        ...
        case 3:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"情锁秦宫（3）");
        	}
        	break;
        case 4:
 		if ( who->get_legend(TASK_11,7) && !who->get_legend(TASK_11,8) )
 		{
			...
			who->add_cash(4000);
			send_user(who,"%c%s",';',"情锁秦宫（3） 经验 5500 tiềm năng 180 Ngân lượng 4000 中级物攻 1");
        ...
        case 5:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"情锁秦宫（4）");
        	}
        	break;
        }
}