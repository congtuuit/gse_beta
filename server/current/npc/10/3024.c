...
void do_welcome2( object me, string arg )
{
	...
	case 2:
			...
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_YANGUO,23,"Trả thù" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Trả thù");
        	}
        	break;       
        case 3:
			...
			who->add_cash(4700);
			send_user(who,"%c%s",';',"Trả thù 经验 5800 tiềm năng 230 Ngân lượng 4700");
