...
void do_welcome2( object me, string arg )
{
        ...
        case 2:
			...
			who->add_cash(68000);
			send_user(who,"%c%s",';',"刀魂传说1 经验 82000 tiềm năng 980 Ngân lượng 68000");
        ...
        case 3:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"刀魂传说2");
       		}
        	break;
        case 4:
			...
			who->add_cash(96000);
			send_user(who,"%c%s",';',"刀魂传说2 经验 83000 tiềm năng 920 Ngân lượng 96000");
        ...
        case 5:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"刀魂传说3");
       		}
        	break;
        case 6:
		if ( who->get_legend(TASK_47,15)&&!who->get_legend(TASK_47,16) ) 
        ...
        case 7:
			...
			who->add_cash(97000);
			send_user(who,"%c%s",';',"破除谣言4 经验 95000 tiềm năng 1200 Ngân lượng 97000 摄魂行装图纸 1");
        ...
        case 8:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"破除谣言5");
       		}
        	break;
        }
}