...
void do_welcome2( object me, string arg )
{
        ...
        case 2:
			...
			who->add_cash(6500);
			send_user(who,"%c%s",';',"贺礼 经验 6800 tiềm năng 265 Ngân lượng 6500");
        ...
        case 4:
			...
			who->add_cash(22000);
			send_user(who,"%c%s",';',"身世之谜 经验 30000 tiềm năng 400 Ngân lượng 22000");
	...
	case 5:
		...
		if ( who->get_legend(TASK_41,18) && !who->get_legend(TASK_41,19) )
		{
			...
			who->add_cash(83000);
			send_user(who,"%c%s",';',"打探下落 经验 91000 tiềm năng 1600 Ngân lượng 83000");
	...
	case 7:
			...
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_ZHAOGUO,70,"Kiểm tra sức mạnh" );
		...
		if ( who->get_legend(TASK_41,21) && !who->get_legend(TASK_41,22) )
		{
			...
			who->add_cash(82000);
			send_user(who,"%c%s",';',"Kiểm tra sức mạnh 经验 92000 tiềm năng 1400 Ngân lượng 82000");
	...
	case 9:
			...
			send_user( who, "%c%c%c%w%s", 0x51, 2, 1,TID_ZHAOGUO,"Triệu Quốc" );
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_ZHAOGUO,71,"Cuộc phiêu lưu Thiên Môn" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Cuộc phiêu lưu Thiên Môn");
        	}
        	break;  
        }
}