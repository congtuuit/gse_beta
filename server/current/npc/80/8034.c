...
void do_welcome2( object me, string arg )
{
        ...
        case 2:
			...
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_WEIGUO,8,"Thảm họa của Ngụy quản gia（1）" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Thảm họa của Ngụy quản gia（1）");
        	}
        	break;
        case 3:
			...
			who->add_cash(1500);
			send_user(who,"%c%s",';',"Thảm họa của Ngụy quản gia（1） 经验 1800 tiềm năng 40 Ngân lượng 1500");
        ...
        case 5:
			...
			send_user( who, "%c%c%c%w%s", 0x51, 2, 1,TID_WEIGUO,"Ngụy Quốc" );
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_WEIGUO,9,"Thảm họa của Ngụy quản gia（2）" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Thảm họa của Ngụy quản gia（2）");
        	}
        	break;
        case 6:
			...
			who->add_potential(40);
			who->add_cash(1500);
			send_user(who,"%c%s",';',"Thảm họa của Ngụy quản gia（2） 经验 1800 tiềm năng 40 Ngân lượng 1500");
        ...
        case 8:
			...
			send_user( who, "%c%c%c%w%s", 0x51, 2, 1,TID_WEIGUO,"Ngụy Quốc" );
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_WEIGUO,10,"Thảm họa của Ngụy quản gia（3）" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Thảm họa của Ngụy quản gia（3）");
        	}
        	break;
        case 9:
			...
			who->add_cash(5000);
			send_user(who,"%c%s",';',"Thảm họa của Ngụy quản gia（3） 经验 5800 tiềm năng 200 Ngân lượng 5000 初级法力 1");
