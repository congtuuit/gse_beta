...
void do_look( object who ) 
{
	...
	if ( ( who->get_level() >= 100 && !who->get_legend(TASK_37,1) ) || ( who->get_legend(TASK_37,1) && !who->get_legend(TASK_37,3) ) )
		tmp += sprintf(ESC HIY "Đột phá hệ tầng Thiên Môn\ntalk %x# welcome.1\n",getoid(this_object()));
...
void do_welcome2( object me, string arg )
{
        ...
        case 2:
			...
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_QIGUO,59,"Đột phá hệ tầng Thiên Môn" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Đột phá hệ tầng Thiên Môn");
        	}
        	break;
        case 3:
			...
			who->add_cash(70000);
			send_user(who,"%c%s",';',"Đột phá hệ tầng Thiên Môn 经验 80000 tiềm năng 960 Ngân lượng 70000");
