...
void do_welcome2( object me, string arg )
{
        ...
        case 2:
			...
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_WEIGUO,19,"Linh hồn khóc" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Linh hồn khóc");
        	}
        	break;
        case 3:
        ...
        case 5:
			...
			send_user( who, "%c%c%c%w%s", 0x51, 2, 1,TID_WEIGUO,"Ngụy Quốc" );
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_WEIGUO,3,"Trộm gà" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Trộm gà");
        	}
        	break;
        case 6:
			...
			who->add_cash(1000);
			send_user(who,"%c%s",';',"Trộm gà 经验 2500 tiềm năng 50 Ngân lượng 1000");
        ...
        case 8:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"家庭聚会");
        	}
        	break;
        }
}