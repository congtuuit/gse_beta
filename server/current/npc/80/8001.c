...
void do_welcome2( object me, string arg )
{
        ...
        case 2:
			...
			who->add_cash(53000);
			send_user(who,"%c%s",';',"询查原因 经验 62000 tiềm năng 770 Ngân lượng 53000");
        ...
        case 4:
			...
			who->add_cash(51000);
			send_user(who,"%c%s",';',"驯服恶霸 经验 68000 tiềm năng 800 Ngân lượng 51000 紫金丹 2");
        ...
        case 6:
			...
			send_user( who, "%c%c%c%w%s", 0x51, 2, 1,TID_QIGUO,"齐Quốc" );
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_QIGUO,66,"Ấm và lạnh（1）" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Ấm và lạnh（1）");
        	}
        	break;
	case 7:
			...
			who->add_cash(50300);
			send_user(who,"%c%s",';',"Ấm và lạnh（1） 经验 51000 tiềm năng 778 Ngân lượng 50300");
        ...
        case 8:
			...
			send_user( who, "%c%c%c%w%s", 0x51, 2, 1,TID_QIGUO,"齐Quốc" );
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_QIGUO,67,"Ấm và lạnh（2）" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Ấm và lạnh（2）");
        	}
        	break;
        }
}
