...
void do_look( object who )
{
	...
	if ( ( who->get_level() >= 40 && !who->get_legend(TASK_10,17) ) || ( who->get_legend(TASK_10,17) && !who->get_legend(TASK_10,19) ) )
		tmp += sprintf(ESC HIY "Tìm kiếm công thức nấu ăn\ntalk %x# welcome.1\n",getoid(me));
...
void do_welcome2( object me, string arg )
{
        ...
        case 2:
			...
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_QINGUO,17,"Tìm kiếm công thức nấu ăn" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Tìm kiếm công thức nấu ăn");
        	}
        	break;
       case 3:
			...
			who->add_cash(3000);
			send_user(who,"%c%s",';',"Tìm kiếm công thức nấu ăn 经验 4200 tiềm năng 115 Ngân lượng 3000");
	...
	case 4:
		if ( who->get_legend(TASK_46,6)&&!who->get_legend(TASK_46,7) ) 
			...
			send_user(who, "%c%c%w%s", ':', 3, me->get_char_picid(), sprintf("%s:\n    我占过卦之后，得到上天提示，甑九共抢劫了30个刀魂和30个枪魂的镇魂石，为了天地秩序回归正常，重新恢复诛仙阵的阵法，必须杀掉30个刀魂和30个枪魂使之镇魂的力量与魂魄数量相符，你记住，一个不可多，一个不可少，否则也可能出现不可控的灾难，Hoàn thành任务之后回来告诉我，我再问问天是否有其他没有考虑到的遗漏。\n"ESC"Nhận nhiệm vụ\ntalk %x# welcome.6\n"ESC"Rời khỏi.", me->get_name(),getoid(me)));
        ...
        case 5:
			...
			who->add_cash(98000);
			send_user(who,"%c%s",';',"刀魂传说3 经验 85000 tiềm năng 810 Ngân lượng 98000 霸王战甲图纸 1");
        ...
        case 6:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"刀魂传说4");
       		}
        	break;
        case 7:
			...
			who->add_cash(96000);
			send_user(who,"%c%s",';',"刀魂传说4 经验 89000 tiềm năng 1000 Ngân lượng 96000");
        ...
        case 8:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"刀魂传说5");
       		}
        	break;
	case 9:
		if ( who->get_legend(TASK_47,8)&&!who->get_legend(TASK_47,9) ) 
        ...
        case 10:
			...
			who->add_cash(90000);
			send_user(who,"%c%s",';',"破除谣言1 经验 87000 tiềm năng 1100 Ngân lượng 90000");
        ...
        case 11:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"破除谣言2");
       		}
        	break;
        case 21:
        case 22:
