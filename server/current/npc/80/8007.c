...
void do_look( object who ) 
{
	...
	{
		tmp += sprintf(ESC HIY "Làm bài kiểm tra\ntalk %x# welcome.4\n",id);
	}
...
void do_welcome2( object me, string arg )
{
        ...
        case 2:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"唇亡齿寒（1）");
        	}
        	break;
       case 3:
        	if ( who->get_legend(TASK_09,26) && !who->get_legend(TASK_09,27) )
			...
			who->add_cash(3000);
			send_user(who,"%c%s",';',"唇亡齿寒（4） 经验 3300 tiềm năng 100 Ngân lượng 3000 油炸地瓜片图纸 1");
        ...
        case 5:
			...
			who->add_cash(52000);
			send_user(who,"%c%s",';',"打听消息 经验 50000 tiềm năng 700 Ngân lượng 52000");
	...
	case 6:
			...
			send_user( who, "%c%c%c%w%s", 0x51, 2, 1,TID_QIGUO,"Tề Quốc" );
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_QIGUO,27,"Làm bài kiểm tra" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Làm bài kiểm tra");
        	}
        	break;
        case 7:
			...
			who->add_cash(53000);
			send_user(who,"%c%s",';',"Làm bài kiểm tra 经验 53000 tiềm năng 710 Ngân lượng 53000");
	...
	case 8:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"水落石出");
        	}
        	break;
        case 9:
        	if ( who->get_level() >= 90 && !who->get_legend(TASK_31,1) )
        ...
        case 10:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"询问小贩");
        	}
        	break;
        case 11:
        	if ( who->get_level() >= 35 && !who->get_legend(TASK_37,29) )
        ...
        case 12:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"交换心得");
        	}
        	break;
        case 13:
        ...
        case 14:
			...
			send_user( who, "%c%c%c%w%s", 0x51, 2, 1,TID_QIGUO,"Tề Quốc" );
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_QIGUO,55,"Niết bàn" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Niết bàn");
        	}
        	break;
	case 15:
			...
			who->add_cash(69000);
			send_user(who,"%c%s",';',"Niết bàn 经验 80000 tiềm năng 958 Ngân lượng 69000");
