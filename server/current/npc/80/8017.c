...
void do_welcome2( object me, string arg )
{
        ...
        case 2:
			...
			who->add_cash(3800);
			send_user(who,"%c%s",';',"无奈的求助（1） 经验 4400 tiềm năng 140 Ngân lượng 3800");
        ...
        case 3:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"无奈的求助（2）");
        	}
        	break;
        case 4:
			...
			who->add_cash(4500);
			send_user(who,"%c%s",';',"无奈的求助（2） 经验 6000 tiềm năng 190 Ngân lượng 4500 青龙冠图纸 1");
        ...
        case 5:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"无奈的求助（3）");
        	}
        	break;
        case 6:
			...
			who->add_potential(190);
			who->add_cash(4500);
			send_user(who,"%c%s",';',"无奈的求助（3） 经验 6000 tiềm năng 190 Ngân lượng 4500 狂战盔图纸 1");
	...
	case 9:
			...
			send_user( who, "%c%c%c%w%s", 0x51, 2, 1,TID_ZHAOGUO,"Triệu Quốc" );
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_ZHAOGUO,25,"Than phiền cô đơn" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Than phiền cô đơn");
        	}
        	break;
        case 10:
			...
			who->add_cash(6400);
			send_user(who,"%c%s",';',"Than phiền cô đơn 经验 6700 tiềm năng 250 Ngân lượng 6400");
	...
	case 12:
			...
			send_user( who, "%c%c%c%w%s", 0x51, 2, 1,TID_ZHAOGUO,"Triệu Quốc" );
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_ZHAOGUO,26,"Cuộc phiêu lưu" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Cuộc phiêu lưu");
        	}
        	break;
        case 13:
			...
			who->add_cash(6500);
			send_user(who,"%c%s",';',"Cuộc phiêu lưu 经验 6800 tiềm năng 270 Ngân lượng 6500");
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_ZHAOGUO,26,"" );
        	}
        	break;   
        case 14:
        	if ( who->get_level() >= 55 && !who->get_legend(TASK_17,22) )
			send_user(who, "%c%c%w%s", ':', 3, me->get_char_picid(), sprintf("%s:\n    昨天我路过燕长城的匝道处时，见到有一团Huỳnh quang bí ẩn在上面飘动，我估计是失落已久的碧光石出现了，你愿意帮我寻到它吗？\n"ESC"接受任务\ntalk %x# welcome.15\n"ESC"Rời khỏi.", me->get_name(),getoid(me)));
	...
	case 15:
			...
			send_user( who, "%c%c%c%w%s", 0x51, 2, 1,TID_ZHAOGUO,"Triệu Quốc" );
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_ZHAOGUO,27,"Huỳnh quang bí ẩn" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Huỳnh quang bí ẩn");
        	}
        	break;
        case 16:
			...
			who->add_cash(6300);
			send_user(who,"%c%s",';',"Huỳnh quang bí ẩn 经验 7000 tiềm năng 260 Ngân lượng 6300");
        ...
        case 18:
			...
			who->add_cash(23000);
			send_user(who,"%c%s",';',"木箱的秘密（2） 经验 23500 tiềm năng 430 Ngân lượng 23000");
	...
	case 19:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"木箱的秘密（3）");
        	}
        	break;
        case 20:
       		if ( who->get_level() >= 105 && !who->get_legend(TASK_41,16) )
	...
	case 21:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"询问原由");
        	}
        	break;
        }
}