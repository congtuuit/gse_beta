...
void do_welcome2( object me, string arg )
{
        ...
        case 2:
 		if ( who->get_legend(TASK_44,28) && !who->get_legend(TASK_44,29) )
			...
			who->add_cash(50300);
			send_user(who,"%c%s",';',"Ấm và lạnh（2） 经验 51000 tiềm năng 778 Ngân lượng 50300");
        ...
        case 3:
			...
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_QIGUO,68,"Ấm và lạnh（3）" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Ấm và lạnh（3）");
        	}
        	break;        	
        case 4:
 		if ( who->get_legend(TASK_45,2) && !who->get_legend(TASK_45,3) )
			...
			who->add_cash(193000);
			send_user(who,"%c%s",';',"Ấm và lạnh（3） 经验 190000 tiềm năng 1450 Ngân lượng 193000 飓风拳套图纸 1");
