...
void do_welcome2( object me, string arg )
{
        ...
        case 2:
			...
			who->add_cash(3550);
			send_user(who,"%c%s",';',"大葫芦（1） 经验 3800 tiềm năng 165 Ngân lượng 3550");
	...
	case 3:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"大葫芦（2）");
        	}
        	break;      
        case 4:
			...
			who->add_potential(165);
			who->add_cash(3500);
			send_user(who,"%c%s",';',"大葫芦（2） 经验 3830 tiềm năng 165 Ngân lượng 3500");
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"大葫芦（3）");
       		}
        	break;
        }
}