...
void do_welcome2( object me, string arg )
{
	...
	case 2:
			...
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_YANGUO,4,"Dòng sông lớn" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Dòng sông lớn");
        	}
        	break;       
        case 3:
			...
			who->add_cash(4100);
			send_user(who,"%c%s",';',"Dòng sông lớn 经验 4900 tiềm năng 160 Ngân lượng 4100 宣明冠图纸 1");
	...
	case 5:
			...
			send_user( who, "%c%c%c%w%s", 0x51, 2, 1,TID_YANGUO,"Yên Quốc" );
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_YANGUO,33,"Cửa hàng trang sức" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Cửa hàng trang sức");
        	}
        	break;       
        case 6:
			...
			who->add_cash(5500);
			send_user(who,"%c%s",';',"Cửa hàng trang sức 经验 6500 tiềm năng 225 Ngân lượng 5500 高级法力 1");
