...
void do_welcome2( object me, string arg )
{
        ...
        case 2:
			...
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_CHUGUO,4,"打造惊世之剑" );	
        		...
        		send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"打造惊世之剑");
        	}
        	break;
        case 3:
			...
			send_user(who,"%c%s",';',"打造惊世之剑 经验 500 tiềm năng 50 Ngân lượng 1300 一口肉 3");
			me->do_welcome(1);
        	}
        	break;
        case 4:
			...
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_CHUGUO,5,"斑点狗的血液" );	
        		...
        		send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"斑点狗的血液");
        	}
        	break;
        case 5:
			...
			who->add_cash(1300);
			send_user(who,"%c%s",';',"斑点狗的血液 经验 550 tiềm năng 55 Ngân lượng 1300");
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_CHUGUO,5,"" );	        			
        	}
        	break;     
        case 6:
        	if ( who->get_legend(TASK_32,29) && !who->get_legend(TASK_32,30) )
			send_user(who, "%c%c%w%s", ':', 3, me->get_char_picid(), sprintf("%s:\n    是的，%s，我曾经是丁鹤年祖父的忘年交，他曾经嘱托过我，如果有人拿着这张虎皮遗书来找我，首先要叫他去Hoàn thành一件极为重要的事情，当然这件事情要等到你愿意的时候，我才会告诉你。\n"ESC"Hoàn thành任务\ntalk %x# welcome.7\n"ESC"Rời khỏi.", me->get_name(),who->get_name(),getoid(me)));
		else if ( who->get_legend(TASK_32,30) && !who->get_legend(TASK_33,1) )
			send_user(who, "%c%c%w%s", ':', 3, me->get_char_picid(), sprintf("%s:\n    丁鹤年的祖父曾经嘱托过我，如果有人拿着这张虎皮遗书来找我，首先要叫他去虚陵洞杀掉害死他的金精与木精，如果能替他Trả thù，那么我才能将遗产的秘密告诉他。他说能拿到虎皮遗书的人只会是他孙子或者他孙子的朋友，所以我可以放心的将这件事情交给你去做。\n"ESC"接受任务\ntalk %x# welcome.8\n"ESC"Rời khỏi.", me->get_name(),getoid(me)));
        ...
        case 7:
			...
			who->add_cash(30000);
			send_user(who,"%c%s",';',"祖父的遗产（2） 经验 31000 tiềm năng 605 Ngân lượng 30000");
        ...
        case 8:
			...
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_CHUGUO,33,"祖父的遗产（3）" );	
        		...
        		send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"祖父的遗产（3）");
        	}
        	break;
        case 9:
			...
			who->add_cash(33500);
			send_user(who,"%c%s",';',"祖父的遗产（3） 经验 37000 tiềm năng 633 Ngân lượng 33500");
        ...
        case 10:
			...
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_CHUGUO,34,"祖父的遗产（4）" );	
        		...
        		send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"祖父的遗产（4）");
        	}
        	break;
        }
}