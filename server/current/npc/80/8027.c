...
void do_welcome2( object me, string arg )
{
        ...
        case 2:
			...
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_WEIGUO,24,"Tiếng vọng trong thung lũng" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Tiếng vọng trong thung lũng");
        	}
        	break;
        case 3:
			...
			who->add_cash(1500);
			send_user(who,"%c%s",';',sprintf("Tiếng vọng trong thung lũng 经验 1700 tiềm năng 70 Ngân lượng 1500 %s 1",tmp->get_name()));
        ...
        case 5:
			...
			send_user( who, "%c%c%c%w%s", 0x51, 2, 1,TID_WEIGUO,"Ngụy Quốc" );
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_WEIGUO,25,"Sự báo oán của các vị thần" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Sự báo oán của các vị thần");
        	}
        	break;
        case 6:
			...
			who->add_cash(1300);
			send_user(who,"%c%s",';',"Sự báo oán của các vị thần 经验 1800 tiềm năng 60 Ngân lượng 1300 金项链图纸 1");
