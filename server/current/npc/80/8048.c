...
void do_welcome2( object me, string arg )
{
	...
	string *nTmp,tmp;
        ...
        case 2:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"祖父的遗产（1）");
        	}
        	break;
        case 3:
			...
			who->add_cash(33000);
			send_user(who,"%c%s",';',"祖父的遗产（1） 经验 36000 tiềm năng 630 Ngân lượng 33000");
        ...
        case 4:
			...
			who->add_cash(150000);
			send_user(who,"%c%s",';',sprintf("祖父的遗产（4） 经验 160000 tiềm năng 2000 Ngân lượng 150000 %s 1",tmp->get_name()));
