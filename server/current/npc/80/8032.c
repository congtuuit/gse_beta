...
void do_welcome2( object me, string arg )
{
        ...
        case 2:
			...
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_WEIGUO,18,"Tin đồn kho báu" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Tin đồn kho báu");
        	}
        	break;
        case 3:
			...
			who->add_cash(1200);
			send_user(who,"%c%s",';',"Tin đồn kho báu 经验 1300 tiềm năng 60 Ngân lượng 1200 古藤袍图纸 1");
        ...
        case 5:
			...
			send_user( who, "%c%c%c%w%s", 0x51, 2, 1,TID_WEIGUO,"Ngụy Quốc" );
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_WEIGUO,7,"Giấc mơ" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Giấc mơ");
        	}
        	break;
        case 6:
			...
			who->add_cash(2000);
			send_user(who,"%c%s",';',"Giấc mơ 经验 2800 tiềm năng 90 Ngân lượng 2000");
