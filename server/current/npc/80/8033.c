...
void do_welcome2( object me, string arg )
{
        ...
        case 2:
			...
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_WEIGUO,16,"Kiếm Hồn" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Kiếm Hồn");
        	}
        	break;
        case 3:
			...
			who->add_cash(1000);
			send_user(who,"%c%s",';',"Kiếm Hồn 经验 1200 tiềm năng 60 Ngân lượng 1000");
        ...
        case 5:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"姻缘之路1");
        	}
        	break;
        case 6:
        	if ( who->get_level() >= 95 && !who->get_legend(TASK_35,3)  )
        ...
        case 7:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"探访奇事");
        	}
        	break;
        }
}