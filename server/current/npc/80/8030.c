...
void do_welcome2( object me, string arg )
{
        ...
        case 2:
			...
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_WEIGUO,4,"Rượu cho Lão Đinh" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Rượu cho Lão Đinh");
        	}
        	break;
        case 3:
        	if ( who->get_legend(TASK_07,2) && !who->get_legend(TASK_07,3) )
        	{
        		if (TASK_LEGEND_D->check_task_item(who,"Rượu vang đỏ",10) != 1 )
        			return;
			...
			who->add_cash(1200);
			send_user(who,"%c%s",';',"Rượu cho Lão Đinh 经验 1500 tiềm năng 30 Ngân lượng 1200");
	...
	case 4:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"去燕的盘缠");
        	}
        	break;
	case 5:
			...
			who->add_cash(4000);
			send_user(who,"%c%s",';',"返还盘缠 经验 5000 tiềm năng 160 Ngân lượng 4000");
	...
	case 7:
			...
			who->add_cash(69000);
			send_user(who,"%c%s",';',"探访奇事 经验 77000 tiềm năng 990 Ngân lượng 69000");
        ...
        case 8:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"询问情况");
        	}
        	break;
        }
