...
void do_welcome2( object me, string arg )
{
	...
	case 2:
			...
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_YANGUO,11,"Bận tâm" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Bận tâm");
        	}
        	break;       
        case 3:
			...
			who->add_cash(4900);
			send_user(who,"%c%s",';',"Bận tâm 经验 5400 tiềm năng 190 Ngân lượng 4900");
