...
void do_welcome2( object me, string arg )
{
        ...
        case 2:
			...
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_WEIGUO,2,"Bọn trộm" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Bọn trộm");
        	}
        	break;
        case 3:
			...
			who->add_cash(1200);
			send_user(who,"%c%s",';',"Bọn trộm 经验 1800 tiềm năng 70 Ngân lượng 1200 金项链图纸 1");
	...
	case 5:
			...
			who->add_cash(68000);
			send_user(who,"%c%s",';',"询问情况 经验 76000 tiềm năng 1100 Ngân lượng 68000");
        ...
        case 6:
			...
			send_user( who, "%c%c%c%w%s", 0x51, 2, 1,TID_WEIGUO,"Ngụy Quốc" );
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_WEIGUO,54,"Thử kỹ năng của bạn" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Thử kỹ năng của bạn");
        	}
        	break;
	case 7:
			...
			who->add_cash(65000);
			send_user(who,"%c%s",';',"Thử kỹ năng của bạn 经验 78000 tiềm năng 1000 Ngân lượng 65000");
        ...
        case 8:
			...
			send_user( who, "%c%c%c%w%s", 0x51, 2, 1,TID_WEIGUO,"Ngụy Quốc" );
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_WEIGUO,55,"Đuổi theo bọn cướp" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Đuổi theo bọn cướp");
        	}
        	break;
	case 9:
			...
			who->add_cash(67000);
			send_user(who,"%c%s",';',"Đuổi theo bọn cướp 经验 79000 tiềm năng 1050 Ngân lượng 67000 强效法攻 1");
        ...
        case 10:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"解除奇事");
        	}
        	break;
        }
}
