...
void do_welcome2( object me, string arg )
{
        ...
        case 2:
			...
			who->add_cash(6600);
			send_user(who,"%c%s",';',"大展神威（2） 经验 6900 tiềm năng 260 Ngân lượng 6600");
 			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_QINGUO,13,"大展神威（3）" );
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_QINGUO,12,"" );
 			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"大展神威（3）");
       		}
        	break;
        case 3:
		if  ( who->get_legend(TASK_47,1) && !who->get_legend(TASK_47,2) )
        ...
        case 4:
			...
			who->add_cash(91000);
			send_user(who,"%c%s",';',"炼药之路3 经验 87000 tiềm năng 920 Ngân lượng 91000");
        ...
        case 5:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"炼药之路4");
       		}
        	break;
        case 6:
        	if( who->get_legend(TASK_47,6) && !who->get_legend(TASK_47,7) )
			...
			who->add_cash(91000);
			send_user(who,"%c%s",';',"炼药之路5 经验 86000 tiềm năng 1000 Ngân lượng 91000 驱魔散图纸 1");
        ...
        case 8:
			...
			who->add_cash(91000);
			send_user(who,"%c%s",';',"索取神剑2 经验 98000 tiềm năng 1400 Ngân lượng 91000");
        ...
        case 9:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"索取神剑3");
       		}
        	break;
        case 10:
			...
			who->add_cash(88000);
			send_user(who,"%c%s",';',"索取神剑3 经验 95000 tiềm năng 1500 Ngân lượng 88000");
        ...
        case 11:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"索取神剑4");
       		}
        	break;
        }
}