...
void do_look( object who ) 
{
	...
	if ( (who->get_legend(TASK_22,9) && !who->get_legend(TASK_22,10)) || (who->get_legend(TASK_22,10) && !who->get_legend(TASK_22,12)) )
		tmp += sprintf(ESC HIY "Xác nhận tin đồn\ntalk %x# welcome.1\n",getoid(me));
	if ( who->get_legend(TASK_22,12) && !who->get_legend(TASK_22,13) )
		tmp += sprintf(ESC HIY "Hàm ý tội ác\ntalk %x# welcome.1\n",getoid(me));
...
void do_welcome2( object me, string arg )
{
        ...
        case 2:
			...
			who->add_cash(21000);
			send_user(who,"%c%s",';',"道听途说 经验 22000 tiềm năng 410 Ngân lượng 21000");
        ...
        case 3:
			...
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_QINGUO,44,"Xác nhận tin đồn" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Xác nhận tin đồn");
        	}
        	break; 
        case 4:
			...
			who->add_cash(23000);
			send_user(who,"%c%s",';',"Xác nhận tin đồn 经验 23000 tiềm năng 430 Ngân lượng 23000");
        ...
        case 5:
			...
			send_user( who, "%c%c%c%w%s", 0x51, 2, 1,TID_QINGUO,"Tần Quốc" );
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_QINGUO,45,"Hàm ý tội ác" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Hàm ý tội ác");
        	}
        	break; 
	case 6:
		if ( who->get_legend(TASK_44,16) && !who->get_legend(TASK_44,17) )
	...
	case 7:
			...
			who->add_cash(50000);
			send_user(who,"%c%s",';',"Tư vấn nhiệt tình（2） 经验 48000 tiềm năng 750 Ngân lượng 50000");
	...
	case 8:
			...
			send_user( who, "%c%c%c%w%s", 0x51, 2, 1,TID_QINGUO,"Tần Quốc" );
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_QINGUO,61,"Tư vấn nhiệt tình（3）" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Tư vấn nhiệt tình（3）");
        	}
        	break;
	case 9:
			...
			who->add_cash(50300);
			send_user(who,"%c%s",';',"Tư vấn nhiệt tình（3） 经验 51000 tiềm năng 778 Ngân lượng 50300");
	...
	case 10:
			...
			send_user( who, "%c%c%c%w%s", 0x51, 2, 1,TID_QINGUO,"Tần Quốc" );
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_QINGUO,62,"Tư vấn nhiệt tình（4）" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Tư vấn nhiệt tình（4）");
        	}
        	break;
        }
}