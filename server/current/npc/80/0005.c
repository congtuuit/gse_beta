...
70: ([
	...
	"密探" : "在弯道可以杀到密探 ",
	"水鬼" : "在弯道可以杀到水鬼 ",
	"Ác ma trong lọ" : "在灵谷洞二层可以杀到Ác ma trong lọ ",
	"豆兵" : "在灵谷洞二层可以杀到豆兵 ",
	"冤魂" : "在灵谷洞二层可以杀到冤魂 ",
	"魍魉鬼" : "在灵谷洞二层可以杀到魍魉鬼 ",
	"疫鬼" : "在灵谷洞二层可以杀到疫鬼 ",
...
80: ([
	"铜甲尸" : "在灵谷洞一层可以杀到铜甲尸 ",
	"Bảo vệ người chết" : "在灵谷洞二层可以杀到Bảo vệ người chết ",
	"铁甲尸" : "在灵谷洞二层可以杀到铁甲尸 ",
	"刀盾骷髅" : "在万人坑一层可以杀到刀盾骷髅 ",
	"剑盾骷髅" : "在困魔阵一层可以杀到剑盾骷髅 ",
	"双刀骷髅" : "在万人坑二层可以杀到双刀骷髅 ",
	"僵尸" : "在万人坑四层可以杀到僵尸 ",
	"Sư tử đá" : "在将军古墓一层可以杀到Sư tử đá ",
	"石虎" : "在将军古墓二层可以杀到石虎 ",
	"刀俑" : "在将军古墓二层可以杀到刀俑 ",
...
void do_look_call(object me,object who)
{
	...
	if ( who->get_save_2("dapang.name") )
	{
		if ( who->get_save_2("dapang.count") < who->get_save_2("dapang.total") )
			send_user(who,"%c%c%w%s",':',3,me->get_char_picid(),sprintf("%s：\n    你想知道我横着走的秘诀吗？如果你能够在30分钟内，Hoàn thành我所交给你的任务，你就可以和我一样享受横着走的乐趣！想什么呢？还不赶快来试试～！\n"ESC"Rời khỏi.",me->get_name(),id,));
		else
			send_user(who,"%c%c%w%s",':',3,me->get_char_picid(),sprintf("%s：\n    你想知道我横着走的秘诀吗？如果你能够在30分钟内，Hoàn thành我所交给你的任务，你就可以和我一样享受横着走的乐趣！想什么呢？还不赶快来试试～！\n"ESC"Hoàn thành任务\ntalk %x# welcome.3\n"ESC"Rời khỏi.",me->get_name(),id,));
	}
	else	
...
void do_welcome_call( object me,string arg )
{
	...
	case 1:
		...
		send_user(who,"%c%c%w%s",':',3,me->get_char_picid(),sprintf("%s：\n    如今天下世道纷乱不堪，Quái vật四出肆虐，此乃天理不容。为拯救苍生，你前去杀20只%s，只望以此来警示那些蠢蠢欲动的妖孽，Hoàn thành此使命还望告知我一声。\n"ESC"接受\ntalk %x# welcome.2\n"ESC"Rời khỏi.",me->get_name(),tmp1,id,));
		break;
	case 2:
		tmp1 = who->get_2("dapang.name");
		tmp2 = who->get_2("dapang.where");
	...
	case 3:
		...
		send_user(who,"%c%c%w%s",':',3,me->get_char_picid(),sprintf("%s：\n    呵呵～！怎么样？好玩吧！按我说的去做没错吧～！等你变身效果消失后，你再来找我吧～！\n"ESC"Rời khỏi.",me->get_name(),));
		send_user(who,"%c%s",';',"大胖任务 Ngân lượng 3000 经验 1000 tiềm năng 200");
		break;	
	}
