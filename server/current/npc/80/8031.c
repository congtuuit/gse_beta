...
void do_look( object who )
{
	...
	if ( ( who->get_level() >= 25 && !who->get_legend(TASK_07,22) ) || ( who->get_legend(TASK_07,22) && !who->get_legend(TASK_07,24) ) )
		tmp += sprintf(ESC HIY "Bữa tối cầu kỳ\ntalk %x# welcome.1\n",getoid(this_object()));
...
void do_welcome2( object me, string arg )
{
        ...
        case 2:
			...
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_WEIGUO,26,"Bữa tối cầu kỳ" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Bữa tối cầu kỳ");
        	}
        	break;
        case 3:
			...
			who->add_cash(2000);
			send_user(who,"%c%s",';',sprintf("Bữa tối cầu kỳ 经验 3000 tiềm năng 60 Ngân lượng 2000 %s 1",tmp->get_name()));
	...
	case 5:
			...
			who->add_cash(66000);
			send_user(who,"%c%s",';',"姻缘之路2 经验 75000 tiềm năng 940 Ngân lượng 66000");
        ...
        case 6:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"姻缘之路3");
        	}
        	break;
	case 7:
			...
			who->add_potential(940);
			who->add_cash(66000);
			send_user(who,"%c%s",';',"姻缘之路3 经验 75000 tiềm năng 940 Ngân lượng 66000");
        ...
        case 8:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"姻缘之路4");
        	}
        	break;
	case 9:
			...
			who->add_cash(68000);
			send_user(who,"%c%s",';',"姻缘之路4 经验 77000 tiềm năng 980 Ngân lượng 68000 强效法防 1");
        ...
        case 10:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"姻缘之路5");
        	}
        	break;
        }
