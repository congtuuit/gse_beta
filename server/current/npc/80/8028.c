...
void do_welcome2( object me, string arg )
{
        ...
        case 2:
			...
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_WEIGUO,1,"Sợi tóc" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Sợi tóc");
        	}
        	break;
        case 3:
			...
			who->add_cash(1500);
			send_user(who,"%c%s",';',"Sợi tóc 经验 2000 tiềm năng 60 Ngân lượng 1500 铜针图纸 1");
	...
	case 5:
			...
			who->add_cash(65000);
			send_user(who,"%c%s",';',"姻缘之路1 经验 75000 tiềm năng 950 Ngân lượng 65000");
        ...
        case 6:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"姻缘之路2");
        	}
        	break;
	case 7:
        	if ( who->get_legend(TASK_35,1) && !who->get_legend(TASK_35,2) )
...
//        			return ;
			...
			who->add_cash(67000);
			send_user(who,"%c%s",';',"姻缘之路5 经验 75000 tiềm năng 980 Ngân lượng 67000 归元丹 2");
