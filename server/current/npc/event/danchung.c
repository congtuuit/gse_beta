...
void do_bonus();
int* ta = ({ "Trái quýt","Chuối","Trái lê","Trái Táo","Khoai Lang", });
void create()
{
	set_name("Dân Bị Nạn");
	set_2("talk", ([
...
void do_bonus()
{
	...
	if (who->get_level() < 20)
	{
		send_user(who, "%c%c%w%s", ':', 3, 0450, "Dân Bị Nạn:\n Thật xin lỗi ngài, tôi thấy ngài vẫn còn nhỏ, làm sao giúp được tôi, khi nào ngài đạt cấp 80 thì đến gặp tôi nhé #2 \n");
		return 0;
	}
