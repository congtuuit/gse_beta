...
int get_use_effect_callout(object who, object gift)
{
	...
	{
	case 1:
		item = new("item/trangbi110/dhn/1");
		break;
	case 2:
		item = new("item/trangbi110/ts/1");
		break;
	case 3:
		item = new("item/trangbi110/cvq/1");
		break;
	case 4:
		item = new("item/trangbi110/dm/1");
		break;
	case 5:
		item = new("item/trangbi110/ms/1");
		break;
	case 6:
		item = new("item/trangbi110/cl/1");
		break;
	case 7:
		item = new("item/trangbi110/vmc/1");
		break;
	}
