...
int get_use_effect_callout(object who, object gift)
{
	...
	{
	case 1:
		item = new (sprintf("item/trangbi110/dhn/4"));
		break;
	case 2:
		item = new (sprintf("item/trangbi110/ts/4"));
		break;
	case 3:
		item = new (sprintf("item/trangbi110/cvq/4"));
		break;
	case 4:
		item = new (sprintf("item/trangbi110/dm/4"));
		break;
	case 5:
		item = new (sprintf("item/trangbi110/ms/4"));
		break;
	case 6:
		item = new (sprintf("item/trangbi110/cl/4"));
		break;
	case 7:
		item = new (sprintf("item/trangbi110/vmc/4"));
		break;
	}
