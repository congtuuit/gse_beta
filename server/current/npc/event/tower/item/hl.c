...
void create()
{
	set_name("Túi Huyết Long (Hạng Liên)");
	set_picid_1(3104);
	set_picid_2(3104);
	set_level(105);
	set_value(10000);
...
int get_use_effect_callout(object who, object gift)
{
	...
	{
	case 1:
		item = new (sprintf("item/trangbi110/dhn/2"));
		break;
	case 2:
		item = new (sprintf("item/trangbi110/ts/2"));
		break;
	case 3:
		item = new (sprintf("item/trangbi110/cvq/2"));
		break;
	case 4:
		item = new (sprintf("item/trangbi110/dm/2"));
		break;
	case 5:
		item = new (sprintf("item/trangbi110/ms/2"));
		break;
	case 6:
		item = new (sprintf("item/trangbi110/cl/2"));
		break;
	case 7:
		item = new (sprintf("item/trangbi110/vmc/2"));
		break;
	}
