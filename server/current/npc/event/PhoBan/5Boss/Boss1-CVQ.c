...
int LEVEL = 70;
int flag;
int saytime,hptime,RelaxTime,pTime,pTime1,pTime2,pTime3,iRelax,i3484,i2415,i2513,i2516, SumTime;
...
void win_bonus_callout( object me, object who )
{
		...
		//owner
		CHAT_D->sys_channel(0, HIY"Nghe nói tên "HIG"Tử Long "HIY"đã bị bằng hữu "HIR"" + who->get_name() + " "HIY"đánh bại.");
