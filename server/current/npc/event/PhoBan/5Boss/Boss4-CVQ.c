...
int get_hair() { return 1003; }
int get_photo() { return 3; }
...
int perform_action(object who)
{
	...
	if (gone_time(pTime1) > 5)
	{
		...
		default:
			...
			break;
		case 1:
			"skill/03/03163"->perform_action_npc(me, who);
			break;
		case 2:
...
void win_bonus_callout(object me, object who)
{
	...
	//owner
	CHAT_D->sys_channel(0, HIY"Nghe nói tướng quân "HIG"Hạng Vũ "HIY"đã bị bằng hữu "HIR"" + who->get_name() + " "HIY"đánh bại.");
