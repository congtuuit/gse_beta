...
void do_look( object who )
{
	...
	{
		tmp += sprintf(ESC HIY "茅山Kẻ phản bội\ntalk %x# welcome.1\n",getoid(me));
	}
...
void do_welcome2( object me, string arg )
{
        ...
        case 2:
			...
			who->add_cash(11000);
			send_user(who,"%c%s",';',"游魂（1） 经验 12000 tiềm năng 215 Ngân lượng 11000");
        ...
        case 3:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"游魂（2）");
        	}
        	break;
        case 4:
		if (who->get_legend(TASK_23,6) && !who->get_legend(TASK_23,7))
		{
			...
			who->add_potential(215);
			who->add_cash(11000);
			send_user(who,"%c%s",';',"游魂（2） 经验 12000 tiềm năng 215 Ngân lượng 11000");
        ...
        case 5:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"游魂（3）");
        	}
        	break;
        case 6:
		if (who->get_legend(TASK_23,9) && !who->get_legend(TASK_23,10))
		{
			...
			who->add_cash(17000);
			send_user(who,"%c%s",';',"游魂（3） 经验 16000 tiềm năng 260 Ngân lượng 17000");
        ...
        case 7:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"游魂（4）");
        	}
        	break;
        case 8:
		if (who->get_legend(TASK_23,11) && !who->get_legend(TASK_23,13) && objectp(pet=USER_BEAST_D->have_beast(who,"斑点狗")))
		{
			...
			who->add_cash(19000);
			send_user(who,"%c%s",';',"游魂（4） 经验 17000 tiềm năng 280 Ngân lượng 19000");
        ...
        case 9:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"游魂（5）");
        	}
        	break;
        case 10:
		if (who->get_legend(TASK_23,15) && !who->get_legend(TASK_23,16))
		{
			...
			who->add_potential(280);
			who->add_cash(19000);
			send_user(who,"%c%s",';',"游魂（5） 经验 17000 tiềm năng 280 Ngân lượng 19000 混天战盔图纸 1");
        ...
        case 11:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"游魂（6）");
        	}
        	break;
        case 12:
		if (who->get_legend(TASK_23,18) && !who->get_legend(TASK_23,19))
		{
			...
			who->add_potential(280);
			who->add_cash(19000);
			send_user(who,"%c%s",';',"游魂（6） 经验 17000 tiềm năng 280 Ngân lượng 19000 神风盔图纸 1");
        ...
        case 13:
			...
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"游魂（7）");
        	}
        	break;
	case 99:
 		TASK_MASTER_D->do_look( who, me );
