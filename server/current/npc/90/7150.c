...
void do_welcome2( object me, string arg )
{
        	...
        	if ( who->get_legend(TASK_45,21) && !who->get_legend(TASK_45,22) )
		{
			...
			who->add_cash(50000);
			send_user(who,"%c%s",';',"Theo y tế （2）经验 48000 tiềm năng 750 Ngân lượng 50000");
	...
	case 3:
			...
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_YUNMENZE,1,"Theo y tế （3）" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Theo y tế （3）");
        	}
        	break;
	case 4:
		if ( who->get_legend(TASK_45,24) && !who->get_legend(TASK_45,25) )
		{
			...
			who->add_cash(52000);
			send_user(who,"%c%s",';',"Theo y tế （3）经验 52000 tiềm năng 790 Ngân lượng 52000");
	...
	case 5:
			...
			send_user( who, "%c%c%c%w%s", 0x51, 2, 1,TID_YUNMENZE,"Vân Mộng Cốc" );
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_YUNMENZE,2,"Theo y tế （4）" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Theo y tế （4）");
        	}
        	break;
	case 6:
		if ( who->get_legend(TASK_45,27) && !who->get_legend(TASK_45,28) )
		{
			...
			who->add_potential(790);
			who->add_cash(52000);
			send_user(who,"%c%s",';',"Theo y tế （4）经验 52000 tiềm năng 790 Ngân lượng 52000");
	...
	case 7:
			...
			send_user( who, "%c%c%c%w%s", 0x51, 2, 1,TID_YUNMENZE,"Vân Mộng Cốc" );
			send_user( who, "%c%c%c%w%w%s", 0x51, 2, 2,TID_YUNMENZE,3,"Theo y tế （5）" );
			send_user( who, "%c%s", '!', "Nhận nhiệm vụ  "HIY"Theo y tế （5）");
        	}
        	break;
	case 99:
		TASK_MASTER_D->do_look( who, me ); 
