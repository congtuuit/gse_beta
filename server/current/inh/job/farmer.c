...
string *PlantName = ({ "幼苗", "一成", "二成", "三成", "四成", "五成", "六成", "七成", "八成", "九成", "成熟" });
...
void do_look_1( object me, object who )
{
      ...
      default : result = "";  break;
       case 1 : result = "它四周杂草丛生。";  break;
       case 2 : result = "它枝叶枯黄，似乎有点营养不良。";  break;
       case 3 : result = "它四周土壤干涸龟裂。";  break;
       case 4 : result = "它枝叶上爬着一些小虫子。";  break;
        }

        result = sprintf( "农作物的成长度为 %d。%s\n", who->get("time"), result );
...
void do_plant( object me, object who, string arg )
{
        ...
        if( work == 5 && who->get("time") >= 10 )    // 收割
        {
                ...
                write_user( me, ECHO "您成功地收割了农作物。" );

                who->remove_from_scene();
                destruct(who);

                send_user( me, "%c%w", 0x0d, MUSIC_TASK );
                write_user( me, ECHO "您的农夫经验 +60, 忠实 +3, 诚信 +60, 勇敢 +60, 声望 +3, 国家贡献 +10, Ngân lượng %+d, 经验 %+d, tiềm năng +10。", gold, exp );
                ...
                if( p < 50 )    // 好的事件
                {
                        ...
                        else if( p < 60 )
                        {
                                ...
                                write_user( me, ECHO "您挖出了一些值钱的东西！Bạn nhận được  1000 金。" );
                        }
                        else if( p < 80 )    // 挖出药材
                        {
                                switch( random(35) )
...
void do_fish_finish( object me, object who, string arg )
{
        ...
        {
                cx = 5;  me->add_gift_cx(cx);    // 所得属性、Ngân lượng减半
        ...
        send_user( me, "%c%w", 0x0d, MUSIC_TASK );
        write_user( me, ECHO "您的农夫经验 %+d, 忠实 +1, 诚信 %+d, 勇敢 %+d, 声望 +1, 国家贡献 +1, Ngân lượng %+d, 经验 %+d, tiềm năng +1。", 
                exp2, cx, yg, gold, exp );
