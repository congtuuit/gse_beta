...
private static int iWeapon;		// 战斗傀儡 1 表示已经有了，否则就是Hoàn thành的时间
...
// 函数：获取公告
string get_bulletin() { return Bulletin ? Bulletin : "请按“编辑”修改，Hoàn thành后按“Chấp nhận”。"; }

// 函数：Thiết lập 公告
string set_bulletin( string text ) { return Bulletin = text; }

// 函数：获取大事记
string get_note() { return Note ? Note : "请按“编辑”修改，Hoàn thành后按“Chấp nhận”。"; }
