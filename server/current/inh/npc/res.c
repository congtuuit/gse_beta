...
string set_reset_file(string file){return reset_file = file;}	// 函数：Thiết lập 刷新文件
                                                                             
string get_reset_file(string file){return reset_file;}		// 函数：获取刷新文件

int set_tool_type(int type){return tool_type = type;}		// 函数：Thiết lập 工具类型
                                                                             
int get_tool_type(){return tool_type;}				// 函数：获取工具类型

string set_pf_name(string name){return pf_name = name;}		// 函数：Thiết lập 技能名称
                                                                             
string get_pf_name(){return pf_name;}				// 函数：获取技能名称

int set_stuff_number2(int num){return stuff_number2 = num;}	// 函数：Thiết lập 附加资源编号
                                                                             
int get_stuff_number2(){return stuff_number2;}			// 函数：获取附加资源编号

int set_stuff_number(int num){return stuff_number = num;}	// 函数：Thiết lập 资源编号
                                                                             
int get_stuff_number(){return stuff_number;}			// 函数：获取资源编号

int set_tool_level(int lv){return tool_level = lv;}		// 函数：Thiết lập 工具等级
                                                                             
int get_tool_level(){return tool_level;}			// 函数：获取工具等级

int set_reset_time(int t){return reset_time = t;}		// 函数：Thiết lập 刷新时间
                                                                             
int get_reset_time(){return reset_time;}			// 函数：获取刷新时间

int set_skill_exp(int exp){return skill_exp = exp;}		// 函数：Thiết lập 采集经验奖励
                                                                             
int get_skill_exp(){return skill_exp;}				// 函数：获取采集经验奖励

int set_skill_level(int slv){return skill_level = slv;}		// 函数：Thiết lập 对应的技能等级
                                            
int get_skill_level(){return skill_level;}			// 函数：获取对应的技能等级

int set_this_skill(int sk){return this_skill = sk;}		// 函数：Thiết lập 对应的技能类型
                                            
int get_this_skill(){return this_skill;}			// 函数：获取对应的技能类型

int set_char_picid(int pic){return pic_id = pic;}			// 函数：Thiết lập 人物造型
