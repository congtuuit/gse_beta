...
private int NoTrade = 0;       // 禁止Giao dịch
...
private int TradeOpen = 1;  // Giao dịch开关
...
int set_latest_city(int flag)
{
        ...
        for (i = 0, size = sizeof(inv); i < size; i++)
                send_user(me, "%c%d%c", 0x31, getoid(inv[i]), 0);
...
{
        if (get_login_flag() > 1)
                send_user(this_object(), "%c%c%c", 0x3d, 120, flag);
...
int set_no_give(int flag)
{
        ...
        if (get_login_flag() > 1)
                send_user(this_object(), "%c%c%c", 0x3d, 121, flag);
        return NoGive = flag;
}
...
int set_mouse(int flag)
{
        flag = range_value(flag, 0, 1);
        if (get_login_flag() > 1)
                send_user(this_object(), "%c%c%c", 0x3d, 143, flag);
        return Mouse = flag;
}
...
int set_mode(int flag)
{
        flag = range_value(flag, 0, 1);
        if (get_login_flag() > 1)
                send_user(this_object(), "%c%c%c", 0x3d, 144, flag);
        return Mode = flag;
}
...
int set_no_fly(int flag)
{
        flag = range_value(flag, 0, 1);
        if (get_login_flag() > 1)
                send_user(this_object(), "%c%c%c", 0x3d, 122, flag);
        return NoFly = flag;
}
...
int set_no_trans(int flag)
{
        flag = range_value(flag, 0, 1);
        if (get_login_flag() > 1)
                send_user(this_object(), "%c%c%c", 0x3d, 123, flag);
        return NoTrans = flag;
}
...
int set_no_team(int flag)
{
        flag = range_value(flag, 0, 1);
        if (get_login_flag() > 1)
                send_user(this_object(), "%c%c%c", 0x3d, 124, flag);
        return NoTeam = flag;
}
...
int set_no_friend(int flag)
{
        flag = range_value(flag, 0, 1);
        if (get_login_flag() > 1)
                send_user(this_object(), "%c%c%c", 0x3d, 125, flag);
...
int set_no_tell(int flag)
{
        flag = range_value(flag, 0, 1);
        if (get_login_flag() > 1)
                send_user(this_object(), "%c%c%c", 0x3d, 126, flag);
        return NoTell = flag;
}
...
// 函数：Thiết lập 禁止Giao dịch
int set_no_trade(int flag)
{
        flag = range_value(flag, 0, 1);
        if (get_login_flag() > 1)
                send_user(this_object(), "%c%c%c", 0x3d, 127, flag);
        return NoTrade = flag;
}
...
int set_say_open(int flag)
{
        flag = range_value(flag, 0, 1);
        if (get_login_flag() > 1)
                send_user(this_object(), "%c%c%c", 0x3d, 130, flag);
        return SayOpen = flag;
}
...
int set_chat_open(int flag)
{
        flag = range_value(flag, 0, 1);
        if (get_login_flag() > 1)
                send_user(this_object(), "%c%c%c", 0x3d, 131, flag);
...
// 函数：Thiết lập Giao dịch开关
int set_trade_open(int flag)
{
        flag = range_value(flag, 0, 1);
        if (get_login_flag() > 1)
                send_user(this_object(), "%c%c%c", 0x3d, 132, flag);
...
int set_city_open(int flag)
{
        flag = range_value(flag, 0, 1);
        if (get_login_flag() > 1)
                send_user(this_object(), "%c%c%c", 0x3d, 133, flag);
...
int set_family_open(int flag)
{
        flag = range_value(flag, 0, 1);
        if (get_login_flag() > 1)
                send_user(this_object(), "%c%c%c", 0x3d, 134, flag);
...
int set_org_open(int flag)
{
        flag = range_value(flag, 0, 1);
        if (get_login_flag() > 1)
                send_user(this_object(), "%c%c%c", 0x3d, 135, flag);
        return OrgOpen = flag;
}
...
int set_team_open(int flag)
{
        flag = range_value(flag, 0, 1);
        if (get_login_flag() > 1)
                send_user(this_object(), "%c%c%c", 0x3d, 136, flag);
...
int set_rumor_open(int flag)
{
        flag = range_value(flag, 0, 1);
        if (get_login_flag() > 1)
                send_user(this_object(), "%c%c%c", 0x3d, 137, flag);
...
int set_id_locked(int flag)
{
        flag = range_value(flag, 0, 1);
        if (get_login_flag() > 1)
                send_user(this_object(), "%c%c%c", 0x3d, 140, flag);
...
string set_id_protect(string passwd)
{
        if (!passwd)
                passwd = "";
        if (strlen(passwd) > 200)
                passwd = passwd[0..199];
        if (get_login_flag() > 1)
                send_user(this_object(), "%c%c%s", 0x3d, 141, passwd);
