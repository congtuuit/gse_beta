...
string get_desc( object me )
{
        ...
        if (level<SKILL_LEVEL)
        	return HIR + PF_NAME +"\n Võ công yêu cầu: 34 cấp\n    	Tuyệt kĩ tay không tước binh khí, làm cho đối thủ bị tê liệt không thể sử dụng bất kì vũ khí nào trong thời gian 8 giây. Sử dụng với quái vật sẽ làm giảm 30 điểm Ngoại Công của mục tiêu.";
