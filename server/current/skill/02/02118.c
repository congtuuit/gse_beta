...
{	
        ...
        if (level<SKILL_LEVEL)
        	return HIR + PF_NAME +"\n Võ công yêu cầu: 40 cấp\n    Nguyên khí bạo kình phát tán, tăng thêm 40 điểm sát thương và làm Choáng tất cả mục tiêu xung quanh trong 1 giây.";
        cur_level = (level - SKILL_LEVEL)/16 + 1;
        result = sprintf(HIC" %s (Cấp %d )\n " NOR "Võ công yêu cầu: Cấp %d \n Nguyên khí tiêu hao: %d điểm\n Tái sử dụng sau: %d giây\n    Nguyên khí bạo kình phát tán, tăng thêm %d điểm sát thương và làm Choáng tất cả mục tiêu xung quanh trong 1 giây.\n " HIC"Cấp tiếp theo:\n "NOR "Võ công yêu cầu: " HIR "Cấp %d " NOR "\n    Tăng thêm %d điểm sát thương.", 
