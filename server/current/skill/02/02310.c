...
#define SUB_MP          ( 10 + ( me->get_skill(THIS_SKILL)-SKILL_LEVEL) / 15 * 6 )
#define ADD_RATE	( 5 + ( me->get_skill(THIS_SKILL)-SKILL_LEVEL) / 15 * 1 )
#define ADD_AP          0
...
string get_desc( object me )
{
        ...
        if (level<SKILL_LEVEL)
        	return HIR + PF_NAME +"\n Võ công yêu cầu: 5 cấp\n    Chiêu thức cơ bản dùng kiếm khí tấn công 1 mục tiêu trong tầm nhìn. Khi sát thương sẽ có tỉ lệ bỏ qua Nội Kháng của đối thủ.";
