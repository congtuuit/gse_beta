...
string get_desc( object me )
{
        ...
        if (level<SKILL_LEVEL)
        	return sprintf(HIR " %s \n Võ công yêu cầu: Cấp 17\n Thương pháp hung hãn như Rồng dữ xuyên thấu đối thủ trong nháy mắt, tăng thêm 30 điểm Ngoại Công khi sát thương và làm mục tiêu bị Trọng Thương trong 6 giây.", PF_NAME);
