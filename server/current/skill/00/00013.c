...
#define PF_NAME        "Sưu tập"

// 函数：获取描述
string get_desc( object me ) 
{ 
        return "［" PF_NAME "］\nThu thập thảo dược bên ngoài thành phố\n"; 
}
...
int main( object me, object who, int x, int y, string arg )
{
	...
	send_user( me, "%c%s", '!', "Bộ sưu tập chưa mở。" );                
	return;

        if( get_effect(me, EFFECT_USER_HERB) )
        {
                send_user(me, "%c%s", '!', "Anh đang bận thu thập thảo dược！");
                return 1;
        }
      ...
      default :        y --;  break;
       ...
       case 8 : x ++;  y ++;  break;
        ...
        {
                send_user(me, "%c%s", '!', "Bạn nhận được 田地采集草药。");
                return 1;
        }
