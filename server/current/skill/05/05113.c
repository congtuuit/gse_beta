...
string get_desc( object	me )
{
	...
	result = sprintf(HIC" %s (Cấp %d )\n " NOR "Võ công yêu cầu: Cấp %d \n Pháp Lực tiêu hao: %d điểm\n Tái sử dụng sau: %d giây\n	  Y thuật trung cấp, có thể hồi phục %d (+4%% điểm nội công) điểm Khí Huyết cho toàn bộ đồng đội trong phạm vi 3×3 ô.\n " HIC"Cấp tiếp theo:\n "NOR"Võ công yêu cầu: " HIR "Cấp %d " NOR"\n	Y thuật trung cấp, có thể hồi phục %d (+4%% nội công) điểm Khí Huyết cho toàn bộ đồng đội trong phạm vi 3×3 ô.",
		PF_NAME, cur_level, SKILL_LEVEL, SUB_MP, TIME_INTERVAL,	ADD_EFFECT + BONUS, cur_level*14+SKILL_LEVEL, ADD_EFFECT+ 90 + BONUS );
	return result;
}
