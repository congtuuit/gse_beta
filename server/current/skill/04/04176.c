...
int cast_done(object me)
{
    ...
    npc->set_max_hp((2000 + (level - 35) / 10 * 1000) + ben * 2);
    npc->set_ap(2700 + level * (level + 1) / 10 + cp * 7 / 10 + ap);
    npc->set_dp(600 + level * (level + 1) / 50 + pp * 4 / 10);
    npc->set_pp(600 + level * (level + 1) / 50 + pp * 4 / 10);
    npc->set_sp(200 + level * (level + 1) / 80 + cp / 10);
    npc->set_hp(npc->get_max_hp());
    npc->set_mp(npc->get_max_mp());

   /* if (me->get_skill(0432) > 0) {
        npc->set_skill(0438, me->get_skill(0432));
    }*/

    /*npc->set_skill(0437, me->get_skill(0437) + 10);
    npc->set_skill(0432, me->get_skill(0432));
    npc->set_skill(0430, me->get_skill(0430));
    npc->set_skill(0435, me->get_skill(0435));*/
