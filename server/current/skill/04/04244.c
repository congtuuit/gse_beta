...
#define SIZE     ( 9 + ( me->get_skill(THIS_SKILL)-SKILL_LEVEL) / 10 * 1 )
#define TIME_INTERVAL   4
#define SUB_MP          ( 200 + ( me->get_skill(THIS_SKILL)-SKILL_LEVEL) / 10 * 30 )
#define ADD_CP          ( 250 + ( me->get_skill(THIS_SKILL)-SKILL_LEVEL) / 10 * 50 )
...
string get_desc(object me)
{
	...
	if (level < SKILL_LEVEL)
		return HIR + PF_NAME + "\n Võ công yêu cầu: 44 cấp\n Vật phẩm tiêu hao: 6 lá Bùa Giấy\n    Triệu hồi Thượng Cổ Lôi Long tấn công địch thủ, tăng thêm 150 điểm Nội Công khi sát thương tất cả mục tiêu trong phạm vi 7x7 ô liên tục trong 6 giây. Đồng thời có 30%% khả năng khiến địch thủ bị Choáng trong 1 giây";
