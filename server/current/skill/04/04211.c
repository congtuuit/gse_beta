...
#define SUB_MP          ( 30 + ( me->get_skill(THIS_SKILL)-SKILL_LEVEL) / 17 * 20 )
#define ADD_INTERVAL    ( 15 + ( me->get_skill(THIS_SKILL)-SKILL_LEVEL) / 15 * 2)
...
string get_desc(object me)
{
	...
	if (level < SKILL_LEVEL)
		return HIR + PF_NAME + "\n Võ công yêu cầu: 35 cấp\n Vật phẩm tiêu hao: 3 lá Bùa Giấy\n    Đạo thuật biến kẻ địch thành một động vật. Trong hình thể động vật sẽ không thể sử dụng phép thuật hay kỹ năng nào (Có thể sử dụng vật phẩm).";
	cur_level = (level - SKILL_LEVEL) / 17 + 1;
	result = sprintf(HIC" %s (Cấp %d )\n " NOR "Võ công yêu cầu: Cấp %d \n Vật phẩm tiêu hao: 3 lá Bùa Giấy\n Pháp Lực tiêu hao: %d điểm\n Tái sử dụng sau: %d giây\n    Đạo thuật biến kẻ địch thành một động vật. Trong hình thể động vật sẽ không thể sử dụng bất cứ phép thuật hay kỹ năng nào (Có thể sử dụng vật phẩm). Bị biến thân, Né tránh gia tăng 200%%, Thân thủ gia tăng 50%%.\n Vô hiệu với quái và Boss.\n Xác xuất thành công dựa vào cấp bậc của mình và nạn nhân.\n Biến thân thuật hiểu qua trong %d giây.\n " HIC"Cấp tiếp theo:\n "NOR "Võ công yêu cầu: " HIR "Cấp %d " NOR "\n    Biến thân thuật hiệu quả kéo dài %d giây.",
...
int cast_done(object me)
{
	...
	if (get_effect(who, EFFECT_MAGIC_4243)) return 2;
	...
	if (rate < 5) rate = 5;
	if (get_effect(me, EFFECT_CHAR_BLIND)) rate /= 2;
