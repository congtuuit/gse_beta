...
#define ADD_AP          ( 200 + ( me->get_skill(THIS_SKILL)-SKILL_LEVEL) / 19 * 5 )
...
string get_desc(object me)
{
	...
	if (level < SKILL_LEVEL)
		return HIR + PF_NAME + "\n Võ công yêu cầu: 35 cấp\n Vật phẩm tiêu hao: 5 lá Bùa Giấy\n    Phát ra thần công cực hàn hộ thể trong phạm vi 7×7 ô, sát thương với 150 điểm Nội Công và làm tất cả mục tiêu bị Đóng Băng trong 6 giây";
