#define FILE_GUMU "sys/party/thap105"

inherit COPY_MAP;

// 函数：构造处理
int is_pvp() { return 1; }
int is_tower() { return 1; }
...
void heart_beat_loop(int effect1, int effect2, int effect3, int effect4, int effect5, int effect6, int effect7, int effect8) { 
    __FILE__->heart_beat_loop_callout(this_object(), effect1, effect2, effect3, effect4, effect5, effect6, effect7, effect8); 
}
