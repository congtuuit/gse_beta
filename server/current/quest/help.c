...
mapping TipsTable = ([
	...
	1  :	({ "接任务", "你可以从头顶有黄色小问号的ＮＰＣ人物处"HIR"Nhận nhiệm vụ"NOR"，然后点击屏幕右下方的"HIR"卷轴型图标"NOR"打开任务界面，查看你的任务信息。", }),
	2  :	({ "交任务", "当你Hoàn thành某个任务后，你可以点击屏幕右下方的卷轴型图标打开任务界面，并且按照任务界面的提示找到"HIR"任务Hoàn thành人"NOR"领取奖励。", }),
	...
	6  :	({ "组队", "点击右下方的"HIR"组队按钮"NOR"后，你的鼠标会变成小红旗，用这个小红旗点击其他玩家，你就可以邀请他组队。", }),
        ...
        8  :	({ "卫队长", "在新手村的卫队长处你可以领取到"HIR"协助村庄治安"NOR"任务，协助村庄治安任务是可以无限领取的任务。多Hoàn thành几次该任务会得到不错的奖励。", }),
        ...
        12 :	({ "师门任务", "在你的门派师父处可以领取到"HIR"师门任务"NOR"，Hoàn thành10轮的师门任务你可以获得非常丰富的经验奖励，强烈建议你每天都去Hoàn thành20轮。", }),
        ...
        23 :	({ "摆摊贩卖", "当你身上有多余的物品时，你不妨到"HIR"周国摆摊区"NOR"摆设一个摊位把这些东西卖给其他玩家，通过摆摊出售东西也是一个获得更多Ngân lượng的途径。", }),
...
mapping GTipsTable = ([
        ...
        2  :    ({ "Nhận nhiệm vụ", "游戏中有可领取的剧情任务的NPC头顶都会有一个"HIR"黄色的小问号"NOR"作为标记。", }),
        3  :    ({ "双倍经验时间", "每个星期都可以找神仙爷爷领取4个小时的"HIR"双倍经验时间"NOR"。在双倍经验时间内击败怪物所获得的经验将翻倍。", }),
        4  :    ({ "使用当铺", "你可以把你道具栏暂时不用的物品和Ngân lượng免费存放在当铺内，等有需要再取出来。", }),
        5  :    ({ "购买物品", "点击商铺里面的物品，选择好数量再点击确认，就可以购买物品了。当然你也可以把你道具栏的物品拖放到商店栏里"HIR"出售"NOR"换取Ngân lượng。", }),
        6  :    ({ "修理物品", "如果你的装备耐久下降了，你可以去"HIR"修理店老板"NOR"处支付一定Ngân lượng修理装备。", }),
        7  :    ({ "鉴定物品", "你可以把"HIR"未鉴定"NOR"的装备拿去"HIR"修理店老板"NOR"处进行鉴定，但必须支付少量Ngân lượng。", }),
        ...
        16 :    ({ "使命人物", "如果能击败使命人物，你可以获得一定的"HIR"经验和tiềm năng"NOR"奖励。", }),
        ...
        24 :    ({ "装备绑定", "有些装备在拾取后或者装备后会"HIR"绑定在身上"NOR"，绑定后的装备是不可以跟其他玩家Giao dịch的。", }),
        ...
        33 :    ({ "世界BOSS", HIR"世界BOSS"NOR"是一种非常强力的怪物。如果你对自己能力有自信的话，不妨多招募些好友来一齐Thử thách他。击败他会获得非常丰厚的奖励。", }),
        34 :    ({ "使用信物", "点击"HIR"门派信物"NOR"或者使用基础技能里面的使用信物技能，就可以把你传送回新手村或者你所在的门派。", }),
        35 :    ({ "tiềm năng", "消灭怪物除了能获得经验外，还能获得"HIR"tiềm năng"NOR"。tiềm năng是作为以后技能修炼时的一种消耗，越高级的技能消耗的tiềm năng就越多。", }),
        ...
        38 :    ({ "店铺", "基本的店铺有武器店、防具店、杂货店和药店，还有作为仓库用途的当铺。这些店铺是玩家与 NPC 互动Giao dịch的主要场所。", }),
        39 :    ({ "武器店", "您可以在武器店买到刀、枪、剑、棍、拳套、暗器等不同种类的武器。同时您也可以将自己身上没用的物品卖给武器店老板。", }),
        40 :    ({ "防具店", "防具店可以买到各种各样防具用品。同时您也可以将自己身上没有用的物品卖给防具店老板。", }),
        41 :    ({ "杂货店", "您可以在杂货店买到各种必须的用品，比如回城符、飞行符等等。您也可以将自己身上没用的物品卖给杂货店老板换取一些Ngân lượng。", }),
        42 :    ({ "药店", "在药店老板处你可以购买到各类恢复气血和法力的药品，出门在外，肯定少不了多带些药品防身的了。", }),
        43 :    ({ "Rời khỏi.队伍", "你加入了一个队伍，如果想Rời khỏi.队伍的话，右键点击游戏"HIR"界面左上方"NOR"自己的头像，在弹出菜单选择离队就可以了。", }),
        ...
        51 :	({ "Cửa hàng trang sức", "Cửa hàng trang sức老板是出售鞋子和腰带的商人，跟普通商人一样，你也可以将自己身上没有用的物品卖给Cửa hàng trang sức老板。", }),
