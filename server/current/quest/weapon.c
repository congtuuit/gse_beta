...
string get_weapon_file(int level)
{
        ...
        {
        default:
                return FileTable00b[random(sizeof_file_00b)];
        case 1:
                return FileTable10b[random(sizeof_file_10b)];
        case 2:
                return FileTable20b[random(sizeof_file_20b)];
        case 3:
                return FileTable30[random(sizeof_file_30)];
        case 4:
                return FileTable40[random(sizeof_file_40)];
        case 5:
                return FileTable50[random(sizeof_file_50)];
        case 6:
                return FileTable60[random(sizeof_file_60)];
        case 7:
                return FileTable70[random(sizeof_file_70)];
        case 8:
                return FileTable80[random(sizeof_file_80)];
        case 9:
                return FileTable90[random(sizeof_file_90)];
        case 10:
                return FileTable100[random(sizeof_file_100)];
        case 11:
                return FileTable110[random(sizeof_file_110)];
        case 12:
        case 13:
        case 14:
        case 15:
...
string get_weapon_file_0(int level)
{
        ...
        case 2:
                return FileTable20b[random(sizeof_file_20b)];
        case 3:
                return FileTable30b[random(sizeof_file_30b)];
        case 4:
                return FileTable40b[random(sizeof_file_40b)];
        case 5:
                return FileTable50b[random(sizeof_file_50b)];
        }
}
