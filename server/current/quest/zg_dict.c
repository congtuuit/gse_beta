...
static mapping lv_user_info = ([0:([9:({
							   ...
							   41:([50:({"◇    Đông Hải Ngư Thôn, Bờ Đông Hải, Hải Tân 1, Hải Tân 2, Đông Hải Đảo, Kênh Trịnh Quốc 1, Kênh Trịnh Quốc 2, Kênh Trịnh Quốc 3 đều là nơi luyện cấp tốt nhất của ngươi hiện giờ.",
...
void player_can_get_prize(object player, int if_can); //	Thiết lập 当前玩家是否可以摇奖
void player_can_be_gala(object player, int if_can);	  //	Thiết lập 当前玩家在得到提示的同时出现恭喜信息
...
//	return item_info;
//}
//	处理一个物品信息的描述返回一个实际物品 处理物品的格式:<物品位置/cash> <颜色/Ngân lượng数量> <物品数量>
