...
int get_use_effect_callout(object who, object gift)
{
	...
	result = HIY + sprintf("Chúc mừng %s ( %d ) sử dụng "HIR"Túi Qùa Top Phú Hộ (2)"HIY" nhận được"HIG" x1 Sơ Cấp Đoạn Thạch"HIY", "HIG" x100 Vô Song Điểm Phiếu"HIY", "HIG" 1x Túi Linh Thạch (1)"HIY".", who->get_name(), who->get_number());
