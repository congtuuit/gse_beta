...
string get_desc() 
{ 
        return "Mã thông báo ma thuật, quái vật đã bị loại bỏ trong vòng một giờ sau khi sử dụng. Phần thưởng kinh nghiệm gấp đôi. \ n (Ảnh hưởng của mã thông báo không thể được đặt chồng lên, chỉ có 25 có thể được sử dụng tới 25 mỗi tuần.）"; 
}
// 函数：获取描述(持续)加血
string get_loop_desc( object me )
{
	return "Phần thưởng kinh nghiệm gấp đôi có thể được lấy trong vòng một giờ.";
}
