...
void create()
{
    set_name("Rương và Chìa khóa (Trang Bị)");
    set_picid_1(12328);
    set_picid_2(12328);
    set_level(10);
    set_value(50);
...
string get_desc()
{
    return "Sau khi sử dụng sẽ nhận được 1 Chìa Khóa và 1 Rương Trang Bị";
}
...
int get_use_effect(object me)
{
	...
	move_item_to_user(me, 1, "item/common/box/trangbi/box");
	move_item_to_user(me, 1, "item/common/box/trangbi/key");
