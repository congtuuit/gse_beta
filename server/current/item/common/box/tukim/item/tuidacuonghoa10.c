...
string get_name_item() { return "Túi Đá Cường Hóa (10)"; }
...
string get_desc()
{
	return sprintf("%s, sau khi sử dụng nhận được 10 viên đá cường hóa", get_name_item());
}
...
int get_use_effect_callout(object who, object gift)
{
	...
	move_item_to_user(who, 10, "item/common/dacuonghoa");
