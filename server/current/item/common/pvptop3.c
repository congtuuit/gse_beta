...
string get_name_item() { return "Giải 3 PVP"; }
...
int get_use_effect_callout(object who, object gift)
{
	...
	move_item_to_user(who, 1, "/item/spitem/ve/ve5sao");
	move_item_to_user(who, 1, "/item/spitem/ve/ve5sao");
	YUANBAO->add_yuanbao(who, 1000);
	tell_user(who, ECHO"Bạn nhận được 100 KNB.");
