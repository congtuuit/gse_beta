...
string get_name_item() { return "Giải 1 PVP"; }
...
int get_use_effect_callout(object who, object gift)
{
	...
	move_item_to_user(who, 1, "/item/common/02su");
	move_item_to_user(who, 1, "/item/spitem/ve/ve7sao");
	YUANBAO->add_yuanbao(who, 10000);
	who->add_cash(20000000);
	"sys/sys/title"->add_title("A112");
	"sys/sys/title"->show_title(who, "A112");

	tell_user(who, ECHO"Bạn nhận được 1000 KNB.");
	tell_user(who, ECHO"Bạn nhận được 20.000.000 lượng.");
