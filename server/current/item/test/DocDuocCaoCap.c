...
void create()
{
        set_name("Âm Dương Ngũ Hành Tán");
        set_picid_1(5210);
        set_picid_2(5210);
        set_value(40);
        set_amount(1);
...
string get_desc() 
{ 
        return "Một loại độc dược quý hiếm, mỗi 0 giây sẽ làm cho khí huyết của đối thử giảm 15000 điểm.";
}
