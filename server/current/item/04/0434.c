...
int get_use_effect_callout( object who,object gift) 
{
	...
	if ( who->get_level()>=30)
	{
		...
		{
			who->add_cash(1000);
			write_user( who, ECHO "您获得1000Ngân lượng。" );	
		}	
		if (rate<2000)
		{
		...
		{
			who->add_cash(10000);
			write_user( who, ECHO "您获得10000Ngân lượng。" );	
		}	
		if (rate<100)
		{
		...
		if (rate<10)
		{
			who->add_cash(100000);
			result += "、";
			result = result + "100000Ngân lượng";
			i=i+1;
			write_user( who, ECHO "您获得100000Ngân lượng。" );	
		}	
	}
	else
	{
		...
		{
			who->add_cash(500);
			write_user( who, ECHO "您获得500Ngân lượng。" );	
		}	
		if (rate<2000)
		{
			item = new ("/item/04/baozhu");
