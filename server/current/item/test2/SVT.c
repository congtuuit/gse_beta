...
int get_use_effect_call(object me,object item)
{
	...
	{
		send_user(owner,"%c%s",'!',me->get_name()+" vẫn còn hiệu quả Tinh Thạch.");
		return 0;	
	}
	write_user(owner,me->get_name()+" đã nhận được hiệu quả Tinh Thạch trong 30 phút.");
