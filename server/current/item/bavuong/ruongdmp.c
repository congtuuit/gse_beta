...
int get_use_effect_callout( object who,object gift) 
{
	...
	{
	case "Đào Hoa Nguyên":
		phai1 = "item/domonphai/dhn";
		break;
	case "Thục Sơn":
		phai1 = "item/domonphai/ts";
		break;
	case "Cấm Vệ Quân":
		phai1 = "item/domonphai/cvq";
		break;
	case "Đường Môn":
		phai1 = "item/domonphai/dm";
		break;
	case "Mao Sơn":
		phai1 = "item/domonphai/ms";
		break;
	case "Côn Luân":
		phai1 = "item/domonphai/cl";
		break;
	case "Vân Mộng Cốc":
		phai1 = "item/domonphai/vmc";
		break;
	}
	gift->add_amount(-1);
	rate = random(5);
