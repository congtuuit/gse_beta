...
string get_name_item() { return "Quà TOP Xếp Hạng Hàng Ma Halloween"; }
...
int get_use_effect_callout(object who, object gift)
{
	...
	move_item_to_user(who, 1, "/item/TuiLinhThach/NgauNhien/3");
	move_item_to_user(who, 1, "/item/common/lientram/2");
