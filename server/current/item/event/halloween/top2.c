...
string get_name_item() { return "Quà TOP 2 Xếp Hạng Hàng Ma Halloween"; }
...
int get_use_effect_callout(object who, object gift)
{
	...
	move_item_to_user(who, 1, "/item/TuiLinhThach/NgauNhien/5");
	move_item_to_user(who, 1, "/item/common/lientram/4");
	move_item_to_user(who, 1, "/item/mocnap/tuidoanthach1");
