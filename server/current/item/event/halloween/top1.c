...
string get_name_item() { return "Quà TOP 1 Xếp Hạng Hàng Ma Halloween"; }
...
int get_use_effect_callout(object who, object gift)
{
	...
	{
		send_user(who, "%c%s", '!', "Hành trang trên người ngươi không đủ 4 chỗ trống, lần sau nhận thưởng phải chú ý");
		return 0;
	}
	...
	move_item_to_user(who, 1, "/item/TuiLinhThach/NgauNhien/6");
	move_item_to_user(who, 1, "/item/common/lientram/5");
