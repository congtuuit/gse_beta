...
string get_name_item() { return "Gói Quà Tết"; }
...
string get_desc()
{
	return sprintf("%s, túi quà Tết Nguyên Đán bên trong có nhiều vật phẩm giá trị", get_name_item());
}
