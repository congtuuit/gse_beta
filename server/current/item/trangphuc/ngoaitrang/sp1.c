...
string get_desc()
{
	...
	string desc;
	desc = "[Hiệp Khách] Áo của Nam, mang sức mạnh huyền bí \nNgoại Công +5%\nNội Công +5%\nKhí Huyết +15%\nPhòng Thủ +15% \n Nhấn chuột phải để sử dụng.";
...
int get_use_effect_callout(object me, object item)
{
	...
	me->set_save_2("marry_fashion.ap", 5);
	me->set_save_2("marry_fashion.cp", 5);
	me->set_save_2("marry_fashion.dp", 15);
	me->set_save_2("marry_fashion.pp", 15);
	me->set_save_2("marry_fashion.hp", 15);
