...
void create()
{
        set_name( "Ba linh hồn và sáu linh hồn" );
        set_picid_1(4101);
        set_picid_2(4101);
        set_value(1);
        set_no_give(1);
...
string get_desc() 
{ 
        return "Vật phẩm nhiệm vụ.若蝉姑娘的Ba linh hồn và sáu linh hồn。"; 
}
...
void say_hello(int i)
{
	...
	if ( i == 1 )
		...
		send_user(who, "%c%c%d%s", 0x43, 6,0,CHAT "唐追：这些人可以帮你还魂！只需带你Ba linh hồn và sáu linh hồn去对你身体念咒“Sự trở lại của linh hồn”……");
	else if ( i == 4 )
